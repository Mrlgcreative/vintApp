...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600 text-white px-6 py-6">
            ...
            <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
                <div class="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div class="col-span-2">
                        ...
                        <div id="status-label" class="font-semibold text-emerald-600 dark:text-emerald-400 mt-0.5 capitalize">{{ $transaction->status }}</div>
                    </div>
                </div>
            </div>
        </div>
...
(function() {
    ...
    const checkUrl = '{{ route("payments.kpay.check-status", ":id") }}'.replace(':id', transactionId);
        ...
        .then(data => {
            ...
            statusLabel.className = 'font-semibold capitalize mt-0.5 ' +
                (status === 'completed' ? 'text-green-600 dark:text-green-400' :
                 status === 'failed' ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400');
