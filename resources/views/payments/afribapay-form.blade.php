...
@section('title', 'Paiement AfribaPay - VintApp')
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium">{{ number_format($item['price'] * $item['quantity'], 0, ',', ' ') }} {{ $currency }}</span>
                </div>
                @endforeach
                <div class="flex justify-between text-sm pt-2 border-t">
                    <span class="text-gray-900 font-semibold">Total</span>
                    <span class="text-lg font-bold text-primary">{{ number_format($totalAmount, 0, ',', ' ') }} {{ $currency }}</span>
                </div>
            </div>
        </div>

        {{-- Formulaire de paiement --}}
        <form action="{{ route('payments.afribapay.initiate') }}" method="POST" id="afribapay-form">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <button type="submit" id="submit-btn"
                    ...
                    <span class="flex items-center justify-center">
                        ...
                        Payer {{ number_format($totalAmount, 0, ',', ' ') }} {{ $currency }}
                    </span>
                </button>
