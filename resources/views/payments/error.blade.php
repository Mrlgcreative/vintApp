            ...
            <div class="card shadow-lg border-0 border-danger error-card">
                <div class="card-body text-center p-5">
                    ...
                    <div class="error-details bg-light rounded-3 p-4 mb-4 text-start">
                        ...
                        @if(isset($provider) && $provider)
                            <div class="detail-row">
                                ...
                                <span class="detail-value">
                                    <i class="fas fa-mobile-alt me-1"></i>{{ $provider }}
                                </span>
                            </div>
                        @endif
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                <i class="far fa-calendar me-1"></i>{{ now()->format('d/m/Y à H:i') }}
                            </span>
                        </div>
                    ...
                    <div class="d-grid gap-3 mt-4">
                        <a href="{{ route('cart.pay') }}" class="btn btn-danger btn-lg">
                            <i class="fas fa-redo me-2"></i>Réessayer le Paiement
                        </a>
                        <a href="{{ route('support.index') }}" class="btn btn-outline-danger">
