...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto">
            ...
            <div class="p-6 space-y-6">
                ...
                @if(session('warning'))
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start space-x-3">
                        ...
                        <div>
                            <p class="font-semibold text-amber-800">Attention</p>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-5">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 font-medium">Solde disponible</p>
                ...
                @if($wallet->balance <= 0)
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-amber-800 mb-2">Solde insuffisant</h3>
                        <p class="text-amber-600 mb-4">Vous n'avez pas de fonds disponibles pour effectuer un retrait.</p>
                    ...
                    <form action="{{ route('wallet.store-withdraw-funds', $wallet) }}" method="POST" id="withdrawFundsForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="0.00"
                                       required
                                       class="w-full {{ $wallet->currency === 'USD' ? 'pl-8' : 'pl-4' }} pr-16 py-3.5 text-lg font-medium border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 @error('amount') border-red-500 ring-2 ring-red-200 @enderror">
                                @if($wallet->currency === 'CDF')
                                    <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                        <span class="text-gray-500 font-medium">FC</span>
                                    </div>
                                @endif
                            </div>
                            @error('amount')
                        ...
                        <div>
                            ...
                            <input type="tel" 
                                   ...
                                   pattern="^(\+?243|0)?[0-9]{9}$"
                                   required
                                   class="w-full px-4 py-3.5 text-lg border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 @error('phone_number') border-red-500 ring-2 ring-red-200 @enderror">
                            @error('phone_number')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-2 text-xs text-gray-500 flex items-center space-x-1">
                        ...
                        <div>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900">MaishaPay</p>
                                        <p class="text-xs text-gray-500">Orange, M-Pesa, Airtel, Africell</p>
                                    </div>
                                </div>
                        ...
                        <div id="preview" class="hidden bg-gray-50 rounded-xl p-5 space-y-3 border border-gray-200 transform transition-all duration-300">
                            <h4 class="text-sm font-semibold text-gray-600 flex items-center space-x-2">
                            ...
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-semibold text-gray-700" id="currentBalance">
                            ...
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-semibold text-red-600" id="withdrawAmount">-0.00</span>
                            </div>
                            <div class="border-t border-gray-200 pt-3">
                                <div class="flex justify-between items-center">
                                    <span class="font-semibold text-gray-700">Nouveau solde</span>
                                    <span class="text-xl font-bold text-blue-600" id="newBalance">
                                        {{ $wallet->currency === 'CDF' ? number_format($wallet->balance, 2, ',', ' ') . ' FC' : '$' . number_format($wallet->balance, 2, '.', ',') }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="bg-blue-50 border border-blue-100 rounded-xl p-4">
                            <div class="flex space-x-3">
                                ...
                                <div>
                                    <h4 class="text-sm font-semibold text-blue-800">⚡ Traitement MaishaPay</h4>
                                    <p class="text-xs text-blue-600 mt-1">Retrait automatique. Fonds envoyés vers votre mobile en 2-10 min selon l'opérateur.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                            <div class="flex space-x-3">
                                ...
                                <div>
                                    <h4 class="text-sm font-semibold text-amber-800">⚠️ Attention</h4>
                                    <p class="text-xs text-amber-700 mt-1"><strong>Wallet débité immédiatement.</strong> Remboursement automatique en cas d'échec du transfert.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3 pt-2">
                            ...
                            <a href="{{ route('wallet.index') }}" class="w-full py-3 px-6 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition-all duration-200 flex items-center justify-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-6 bg-white rounded-xl shadow-md p-5">
            <h3 class="text-sm font-bold text-red-600 mb-4 flex items-center space-x-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul class="space-y-3 text-sm">
                <li class="flex items-start space-x-3">
                    ...
                    <span class="text-gray-600"><strong class="text-gray-800">Délai :</strong> 2 à 10 minutes selon l'opérateur</span>
                </li>
                <li class="flex items-start space-x-3">
                    ...
                    <span class="text-gray-600"><strong class="text-gray-800">Numéro :</strong> Vérifiez qu'il correspond à l'opérateur</span>
                </li>
                <li class="flex items-start space-x-3">
                    ...
                    <span class="text-gray-600"><strong class="text-gray-800">Débit :</strong> Fonds bloqués pendant le traitement</span>
                </li>
                <li class="flex items-start space-x-3">
                    <span class="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center flex-shrink-0">
                        <svg class="w-3.5 h-3.5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                        </svg>
                    </span>
                    <span class="text-gray-600"><strong class="text-gray-800">Remboursement :</strong> Automatique en cas d'échec</span>
                </li>
            </ul>
        </div>
        ...
        <div class="mt-4 bg-white rounded-xl shadow-md p-5">
            <h3 class="text-sm font-bold text-green-600 mb-4 flex items-center space-x-2">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-3 text-center hover:scale-105 transition-transform duration-200 cursor-default">
                    <div class="text-2xl mb-1">🟠</div>
                    <p class="text-xs font-semibold text-gray-800">Orange Money</p>
                    <p class="text-xs text-gray-500">084/085/089</p>
                </div>
                <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3 text-center hover:scale-105 transition-transform duration-200 cursor-default">
                    <div class="text-2xl mb-1">🟢</div>
                    <p class="text-xs font-semibold text-gray-800">M-Pesa</p>
                    <p class="text-xs text-gray-500">081/082/083</p>
                </div>
                <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-3 text-center hover:scale-105 transition-transform duration-200 cursor-default">
                    <div class="text-2xl mb-1">🔴</div>
                    <p class="text-xs font-semibold text-gray-800">Airtel Money</p>
                    <p class="text-xs text-gray-500">097/098/099</p>
                </div>
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 text-center hover:scale-105 transition-transform duration-200 cursor-default">
                    <div class="text-2xl mb-1">🔵</div>
                    <p class="text-xs font-semibold text-gray-800">Africell</p>
                    <p class="text-xs text-gray-500">090/091/092</p>
                </div>
            </div>
        </div>
    </div>
