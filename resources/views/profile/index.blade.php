                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-4xl font-black text-gray-900 dark:text-white">{{ $stats['total_items'] }}</p>
                        </div>
                    </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-4xl font-black text-gray-900 dark:text-white">{{ $stats['total_orders'] }}</p>
                        </div>
                    </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-4xl font-black text-gray-900 dark:text-white">{{ number_format($stats['average_rating'], 1) }}</p>
                        </div>
                    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <!-- Mes Articles -->
                    <a href="{{ route('items.my-items') }}" class="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl border-2 border-blue-200 dark:border-blue-800 p-6 hover:shadow-2xl hover:scale-105 hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300">
                    ...
                    <!-- Mes Commandes -->
                    <a href="{{ route('orders.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl border-2 border-emerald-200 dark:border-emerald-800 p-6 hover:shadow-2xl hover:scale-105 hover:border-emerald-400 dark:hover:border-emerald-600 transition-all duration-300">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 text-sm mb-4">
                                {{ $stats['total_orders'] }} commande{{ $stats['total_orders'] > 1 ? 's' : '' }} passée{{ $stats['total_orders'] > 1 ? 's' : '' }}
                            </p>
                    ...
                    <!-- Statistiques -->
                    <a href="{{ route('profile.stats') }}" class="group relative overflow-hidden bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 rounded-2xl border-2 border-indigo-200 dark:border-indigo-800 p-6 hover:shadow-2xl hover:scale-105 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all duration-300">
