                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" 
                               ...
                               value="{{ old('email') }}"
                               autocomplete="email"
                               class="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 @error('email') border-red-400 focus:border-red-500 focus:ring-red-100 @enderror"
