                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-amber-600 focus:ring-4 focus:ring-amber-600/20 outline-none transition-all duration-300 @error('condition') border-red-500 ring-4 ring-red-500/20 @enderror" 
                                        ...
                                        <option value="new" {{ old('condition', $item->condition) == 'new' ? 'selected' : '' }}>Neuf</option>
                                        <option value="like_new" {{ old('condition', $item->condition) == 'like_new' ? 'selected' : '' }}>Comme neuf</option>
                                        <option value="good" {{ old('condition', $item->condition) == 'good' ? 'selected' : '' }}>Bon état</option>
