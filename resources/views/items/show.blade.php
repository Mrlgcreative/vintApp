                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center max-w-xs">
                                    ...
                                    <input type="number" name="quantity" id="quantityInput" value="1" min="1" max="{{ max($item->quantity, 1) }}" 
                                        class="flex-1 h-11 border-2 border-primary-200/50 dark:border-gray-600 dark:bg-gray-800 text-center font-bold text-gray-900 dark:text-white text-lg focus:border-primary focus:ring-4 focus:ring-primary/20 outline-none transition-all duration-300" {{ $item->quantity == 0 ? 'disabled' : '' }}>
