...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Finaliser le paiement</h1>
            <p class="text-gray-600">Confirmez votre paiement pour lancer la vérification d'authenticité</p>
        </div>

        <!-- Résumé de la commande -->
        <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Résumé de la vérification</h2>
            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex-1">
                    <h3 class="font-medium text-gray-900">{{ $check->item->name }}</h3>
                    <p class="text-sm text-gray-600">{{ $check->item->brand->name ?? 'Marque non spécifiée' }}</p>
                    <p class="text-sm text-gray-600">Catégorie: {{ $check->item->category->name ?? 'Non spécifiée' }}</p>
                </div>
                
                <div class="text-right">
                    <p class="text-lg font-bold text-gray-900">{{ $check->item->formatted_price }}</p>
                </div>
            </div>

            <div class="border-t pt-4">
                <div class="flex justify-between items-center">
                    <span class="text-gray-600">Frais de vérification d'authenticité</span>
        ...
        <div class="bg-blue-50 rounded-lg p-6 mb-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">✓ Ce qui est inclus</h3>
            <div class="space-y-3">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Analyse par Intelligence Artificielle</p>
                        <p class="text-sm text-gray-600">Vérification automatique en quelques minutes</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Expertise humaine si nécessaire</p>
                        <p class="text-sm text-gray-600">Vérification par un expert certifié de la catégorie</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Badge d'authenticité permanent</p>
                        <p class="text-sm text-gray-600">Visible sur votre annonce pour rassurer les acheteurs</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Protection anti-fraude renforcée</p>
                        <p class="text-sm text-gray-600">Réduction des litiges et remboursements frauduleux</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <label for="mobile_money" class="flex-1">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Orange Money, Airtel Money</p>
                                </div>
                            </div>
                        </label>
                    </div>
        ...
        <div class="mt-6 bg-gray-50 rounded-lg p-4">
            <h4 class="font-medium text-gray-900 mb-2">🚀 Après confirmation du paiement :</h4>
