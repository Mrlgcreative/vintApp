            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $localDelivery->created_at->format('d/m/Y à H:i') }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $localDelivery->accepted_at->format('d/m/Y à H:i') }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $localDelivery->pickup_time->format('d/m/Y à H:i') }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $localDelivery->updated_at->format('d/m/Y à H:i') }}</p>
