...
<div class="min-h-screen bg-white pb-20">
            ...
            <div class="carousel-indicators-custom">
                @foreach($heroSlides as $index => $slide)
                    <button type="button" data-bs-target="#heroCarousel" data-bs-slide-to="{{ $index }}" 
                        class="indicator-line {{ $index === 0 ? 'active' : '' }}" 
                        ...
                        <div class="container-fluid px-3 px-md-5 py-4 py-md-5">
                            <div class="row align-items-center g-3 g-md-4">
                                @if($imgPos === 'left')
                                    ...
                                    <div class="col-6 col-md-6 text-center text-md-{{ $textPos }} order-2">
                                ...
                                @else
                                    ...
                                    <div class="col-6 col-md-6 text-center text-md-{{ $textPos }} order-1">
                                        <h1 class="text-white fw-bold mb-2 mb-md-3 hero-title">
                                            {{ $slide->title }}
                                        </h1>
                                        @if($slide->subtitle)
                        ...
                        <a href="{{ route('items.index', ['category' => $category->id]) }}" 
                           ...
                           style="background: linear-gradient(135deg, #f3e8ff 0%, #e0f2fe 100%);">
                            <div class="card-body text-center p-3">
                                ...
                                <small class="text-muted category-count">{{ $category->items_count ?? 0 }} articles</small>
                            </div>
                        </a>
                    </div>
                @endforeach
    ...
    <section class="px-3 px-md-4 py-2 mb-4">
        <div class="d-flex gap-2 overflow-auto pb-2 flex-nowrap filter-section-wrapper" 
            ...
            <a href="{{ route('items.index') }}" 
               class="btn {{ !request('filter') ? 'btn-purple' : 'btn-outline-purple' }} btn-sm rounded-pill px-4 fw-medium flex-shrink-0 text-decoration-none">
                <i class="fas fa-star me-1"></i>Tous
            </a>
            <a href="{{ route('items.index', ['sort' => 'recent']) }}" 
               class="btn {{ request('sort') == 'recent' ? 'btn-purple' : 'btn-outline-purple' }} btn-sm rounded-pill px-4 fw-medium flex-shrink-0 text-decoration-none">
                <i class="fas fa-sparkles me-1"></i>Nouveautés
            </a>
            <a href="{{ route('items.index', ['sort' => 'popular']) }}" 
               class="btn {{ request('sort') == 'popular' ? 'btn-purple' : 'btn-outline-purple' }} btn-sm rounded-pill px-4 fw-medium flex-shrink-0 text-decoration-none">
                <i class="fas fa-fire me-1"></i>Populaires
            </a>
            <a href="{{ route('items.index', ['condition' => 'new']) }}" 
               class="btn {{ request('condition') == 'new' ? 'btn-purple' : 'btn-outline-purple' }} btn-sm rounded-pill px-4 fw-medium flex-shrink-0 text-decoration-none">
