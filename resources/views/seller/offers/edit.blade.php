                ...
                <div class="mb-8">
                    <div class="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 rounded-2xl shadow-xl p-6 sm:p-8 text-white relative overflow-hidden">
                        <div class="relative">
                            ...
                            <p class="text-white/80 mt-2 text-sm sm:text-base">{{ $offer->title }}</p>
                        </div>
                    </div>
                </div>

                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <form action="{{ route('seller.offers.update', $offer) }}" method="POST">
                        @csrf @method('PUT')
                        <div class="border-b border-gray-100 dark:border-gray-700 px-6 py-4">
                            <h3 class="text-base font-semibold text-gray-900 dark:text-white">Informations de l'offre</h3>
                        </div>
                        <div class="p-6 space-y-6">
                            @include('seller.offers._fields', ['offer' => $offer])
                        </div>
