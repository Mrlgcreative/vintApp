...
@section('title', 'Modifier l\'exposition')
                ...
                <div class="mb-8">
                    <div class="bg-gradient-to-r from-gray-900 via-gray-800 to-emerald-800 rounded-2xl shadow-xl p-6 sm:p-8 text-white relative overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-white/80 mt-2 text-sm sm:text-base">{{ $exposition->title }}</p>
                        </div>
                    </div>
                </div>

                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <form action="{{ route('seller.expositions.update', $exposition) }}" method="POST">
                        @csrf @method('PUT')
                        ...
                        <div class="p-6 space-y-6">
                            @include('seller.expositions._fields', ['exposition' => $exposition])
                        </div>
