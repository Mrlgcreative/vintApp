                                ...
                                <div class="card-body">
                                    ...
                                    @if($order->deliveryAddress)
                                        <div class="mb-3">
                                            ...
                                            <div class="fw-bold">{{ $order->deliveryAddress->city }}</div>
                                            <small class="text-muted">{{ Str::limit($order->deliveryAddress->address, 30) }}</small>
                                        </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        @if($order->scan_token)
                                            <a href="{{ route('orders.scan', $order->scan_token) }}" class="btn btn-outline-primary btn-sm">
                                                <i class="fas fa-qrcode me-2"></i>
