            ...
            <div class="container">
                <div class="row footer-row-custom">
                    ...
                    <div class="col-md-2 col-6 mb-4">
                        <h6>Support</h6>
                        <ul class="list-unstyled">
                            <li><a href="{{ route('help.index') }}" class="text-muted text-decoration-none">Centre d'aide</a></li>
                            <li><a href="{{ route('help.index') }}#contact" class="text-muted text-decoration-none">Contact</a></li>
                            <li><a href="{{ route('help.index') }}#getting-started" class="text-muted text-decoration-none">FAQ</a></li>
                            @auth
                            <li><a href="{{ route('affiliate.dashboard') }}" class="text-muted text-decoration-none">Affiliation</a></li>
                            @endauth
                        </ul>
                    </div>
                    <div class="col-md-2 col-6 mb-4">
