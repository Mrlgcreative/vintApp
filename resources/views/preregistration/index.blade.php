                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <div class="flex flex-wrap justify-center gap-3 sm:gap-4">
                            <div class="bg-white/20 backdrop-blur-lg rounded-full px-4 sm:px-6 py-2 sm:py-3">
                                ...
                                <span class="font-semibold">{{ \App\Models\UserWaiting::count() }}+</span>
                                <span class="hidden sm:inline ml-1">membres inscrits</span>
                                <span class="sm:hidden ml-1">inscrits</span>
                            </div>
                            <div class="bg-white/20 backdrop-blur-lg rounded-full px-4 sm:px-6 py-2 sm:py-3">
                                <i class="fas fa-check-circle mr-2"></i>
                                <span class="font-semibold">{{ \App\Models\UserWaiting::approved()->count() }}</span>
                ...
                <div class="px-6 sm:px-8 lg:px-12 py-8 sm:py-12">
                    ...
                    <form method="POST" action="{{ route('preregistration.store') }}" id="preregistrationForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full px-4 py-3 border-2 @error('name') border-red-300 @else border-gray-200 @enderror rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-300 text-gray-900 placeholder-gray-400" 
                                   id="name" 
                                   name="name" 
                                   value="{{ old('name') }}"
                                   required
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   class="w-full px-4 py-3 border-2 @error('email') border-red-300 @else border-gray-200 @enderror rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-300 text-gray-900 placeholder-gray-400" 
                                   id="email" 
                                   name="email" 
                                   value="{{ old('email') }}"
                                   required
                        ...
                        <div>
                            ...
                            <input type="tel" 
                                   class="w-full px-4 py-3 border-2 @error('phone') border-red-300 @else border-gray-200 @enderror rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-300 text-gray-900 placeholder-gray-400" 
                                   id="phone" 
                                   name="phone" 
                                   value="{{ old('phone') }}"
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-3 border-2 @error('country') border-red-300 @else border-gray-200 @enderror rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-300 text-gray-900" 
                                    id="country" 
                                    name="country" 
                                    required>
