            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-violet-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_items'] ?? 0 }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Actifs : {{ $stats['active_items'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-emerald-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_sales'] ?? 0 }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-cyan-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['unread_messages'] ?? 0 }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-amber-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['pending_support_chats'] ?? 0 }}</p>
                        ...
                        <div class="space-y-4">
                            @foreach($recentItems as $item)
                                <div class="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-xl hover:bg-violet-50 transition-colors duration-200">
                                    <div>
                                        <h6 class="font-semibold text-gray-900 dark:text-white mb-1">{{ $item->name }}</h6>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $item->category->name ?? 'N/A' }}</p>
                                    </div>
                        ...
                        <div class="space-y-4">
                            @foreach($recentOrders as $order)
                                <div class="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-xl hover:bg-emerald-50 transition-colors duration-200">
                                    <div>
                                        <h6 class="font-semibold text-gray-900 dark:text-white mb-1">Commande #{{ $order->id }}</h6>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $order->item->name ?? 'N/A' }}</p>
                                    </div>
                            ...
                            @foreach($recentMessages as $msg)
                                <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-xl hover:bg-cyan-50 transition-colors duration-200">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <h6 class="font-semibold text-gray-900 dark:text-white mb-1">{{ $msg->sender->name ?? 'N/A' }}</h6>
                                            <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{{ Str::limit($msg->content, 50) }}</p>
                                        </div>
                                        <p class="text-gray-500 dark:text-gray-400 text-xs ml-3 whitespace-nowrap">{{ $msg->created_at->diffForHumans() }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="space-y-4">
                            @foreach($notifications as $notif)
                                <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-xl hover:bg-amber-50 transition-colors duration-200">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <h6 class="font-semibold text-gray-900 dark:text-white mb-1">{{ $notif->title }}</h6>
                                            <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{{ Str::limit($notif->message, 50) }}</p>
                                        </div>
                                        <p class="text-gray-500 dark:text-gray-400 text-xs ml-3 whitespace-nowrap">{{ $notif->created_at->diffForHumans() }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
