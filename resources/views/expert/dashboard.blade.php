        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_verified'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($stats['approval_rate'], 1) }}%</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center mb-2">
                                        ...
                                        @endif
                                        <div>
                                            <h3 class="font-medium text-gray-900 dark:text-white">{{ $check->item->name ?? $check->item->title ?? 'Produit sans nom' }}</h3>
                                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $check->item->category->name ?? 'Sans catégorie' }}</p>
                                        </div>
                                    </div>
