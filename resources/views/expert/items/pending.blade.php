        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white capitalize">{{ auth()->user()->expertProfile?->certification_level ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm font-bold text-gray-900 dark:text-white">{{ count(auth()->user()->expertProfile?->specialties ?? []) }} domaines</p>
                </div>
            </div>
        </div>
    </div>
