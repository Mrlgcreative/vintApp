            ...
            <div class="p-6">
                <form method="POST" action="{{ route('admin.settings.newsletter.process') }}" id="newsletterForm">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               class="block w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 @error('subject') border-red-500 @enderror" 
                               id="subject" 
                               name="subject" 
                               required
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="block w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 @error('content') border-red-500 @enderror" 
                                  id="content" 
                                  name="content" 
                                  rows="12" 
                                  required
