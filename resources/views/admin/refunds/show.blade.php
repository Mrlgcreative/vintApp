        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.refunds.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6">
                        <div class="flex items-center justify-between">
                            ...
                            @endphp
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border {{ $statusClasses[$refund->status] ?? 'bg-gray-100 text-gray-800 border-gray-200' }}">
                                {{ $refund->status_text }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <p class="text-lg text-gray-900">{{ $refund->created_at->format('d/m/Y à H:i') }}</p>
                            </div>
                            <div>
                                <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">Type</h3>
                                <p class="text-lg text-gray-900">{{ $refund->refund_type === 'full' ? 'Remboursement complet' : 'Remboursement partiel' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <div class="text-xl font-bold text-gray-900">{{ $refund->currency === 'USD' ? '$' : 'FC' }} {{ number_format($refund->original_amount, 2) }}</div>
                                </div>
                                <div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4">
                                <p class="text-gray-700 leading-relaxed">{{ $refund->reason }}</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <h4 class="text-lg font-semibold text-gray-900 mb-2">{{ $refund->order->item->name }}</h4>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="text-center mb-4">
                            ...
                            <h4 class="font-semibold text-gray-900">{{ $refund->buyer->name }}</h4>
                            <p class="text-sm text-gray-600">{{ $refund->buyer->email }}</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $refund->created_at->format('d/m/Y à H:i') }}</p>
                                </div>
                            </div>
                            ...
                            @if($refund->updated_at != $refund->created_at)
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">{{ $refund->updated_at->format('d/m/Y à H:i') }}</p>
                                    </div>
                                </div>
                            @endif
                        </div>
        ...
        <div class="mt-3">
            ...
            <form id="negotiationForm">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Maximum: ${{ number_format($refund->original_amount, 2) }}</p>
                </div>
