...
<div class="max-w-7xl mx-auto py-4 px-3 sm:py-6 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200">
        <div class="px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-200">
            ...
            <p class="text-gray-600 mt-2">Palette active : <span class="font-semibold text-primary">{{ $activePaletteName ?? 'default' }}</span></p>
        </div>
        ...
        <div class="p-4 sm:p-6 space-y-8">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <p class="text-gray-600 mb-4">Testez les différentes palettes pour voir l'effet en temps réel :</p>
                <div class="flex flex-wrap gap-2">
