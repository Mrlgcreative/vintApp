            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-900">{{ old('description', $boostType->description) }}</textarea>
                    </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-5">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Ordre</label>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-5">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center gap-3">
                                ...
                                <span class="text-sm text-gray-700 dark:text-gray-200">Actif</span>
                            </label>
                            <label class="flex items-center gap-3">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-5">
                        ...
                        <textarea name="admin_notes" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-900 text-sm">{{ old('admin_notes', $boostType->admin_notes) }}</textarea>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/10 dark:to-emerald-900/10 rounded-xl p-5 border border-green-200 dark:border-green-800">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Un par ligne</p>
                        <textarea name="benefits" rows="5"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-900 text-sm">{{ old('benefits', $boostType->benefits) ? (is_array(old('benefits', $boostType->benefits)) ? implode("\n", old('benefits', $boostType->benefits)) : old('benefits', $boostType->benefits)) : '' }}</textarea>
                    </div>
                </div>
            </div>
