                        ...
                        <div class="carousel-inner rounded-lg overflow-hidden" style="max-height: 400px;">
                            @foreach($slides->where('is_active', true) as $index => $slide)
                                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                    <img src="{{ Storage::url($slide->image_path) }}" class="d-block w-100" style="object-fit: cover; height: 400px;" alt="{{ $slide->title }}">
                                    <div class="carousel-caption d-md-block bg-dark bg-opacity-50 rounded p-3">
                                        <h5 class="text-white fw-bold">{{ $slide->title }}</h5>
                                        @if($slide->subtitle)
                ...
                @if($slides->count() > 0)
                    <div id="slidesList" class="space-y-3">
                        @foreach($slides as $slide)
                            <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200 slide-item" data-slide-id="{{ $slide->id }}">
                                <div class="flex flex-col md:flex-row gap-4">
                                    <!-- Image -->
                                    <div class="flex-shrink-0">
                                        <img src="{{ Storage::url($slide->image_path) }}" alt="{{ $slide->title }}" class="w-full md:w-48 h-32 object-cover rounded-lg">
                                    </div>
                                    ...
                                    <div class="flex-grow">
                                        <div class="flex items-start justify-between mb-2">
                                            <div>
                                                ...
                                                @if($slide->subtitle)
                                                    <p class="text-sm text-gray-600 mt-1">{{ $slide->subtitle }}</p>
                                                @endif
                                            </div>
