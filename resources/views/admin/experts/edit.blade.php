...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Modifier les informations de {{ $expert->user->name }}</p>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.experts.update', $expert) }}">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-3 text-sm text-gray-700">Expert actif</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="bio" id="bio" rows="4" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('bio', $expert->bio) }}</textarea>
                        </div>

                        <!-- Tarif par vérification -->
                        <div class="mt-6">
                            <label for="rate_per_verification" class="block text-sm font-medium text-gray-700 mb-1">
                                Tarif par Vérification (€)
                            </label>
                            <input type="number" 
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        @endif
                        <h4 class="font-semibold text-gray-900 mt-3">{{ $expert->user->name }}</h4>
                        <p class="text-gray-600 text-sm">{{ $expert->user->email }}</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-600">Expert depuis</span>
                            <span class="text-sm font-medium text-gray-900">
                                {{ $expert->created_at->format('d/m/Y') }}
                            </span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-600">Vérifications</span>
                            <span class="text-sm font-medium text-gray-900">
