                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <a href="<?php echo e(route('wallet.add-funds', $usdWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <a href="<?php echo e(route('wallet.withdraw-funds', $usdWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <a href="<?php echo e(route('wallet.transactions', $usdWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <div class="text-center py-6">
                        <p class="text-4xl font-bold text-green-600 dark:text-green-400 mb-1 tabular-nums" id="usd-balance">
                            $<?php echo e(number_format($usdWallet->balance, 2, '.', ',')); ?>
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('wallet.add-funds', $usdWallet)); ?>" 
                        ...
                        <a href="<?php echo e(route('wallet.withdraw-funds', $usdWallet)); ?>" 
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false"
                                 ...
                                 x-transition:leave-end="opacity-0 scale-95"
                                 class="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl ring-1 ring-black/5 dark:ring-white/10 z-50 overflow-hidden">
                                <a href="<?php echo e(route('wallet.add-funds', $cdfWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/></svg>
                                    Ajouter des fonds
                                </a>
                                <a href="<?php echo e(route('wallet.withdraw-funds', $cdfWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15"/></svg>
                                    Retirer des fonds
                                </a>
                                <div class="border-t border-gray-100 dark:border-gray-700"></div>
                                <a href="<?php echo e(route('wallet.transactions', $cdfWallet)); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    Voir l'historique
                                </a>
                            </div>
                    ...
                    <div class="text-center py-6">
                        <p class="text-4xl font-bold text-amber-600 dark:text-amber-400 mb-1 tabular-nums" id="cdf-balance">
                            <?php echo e(number_format($cdfWallet->balance, 2, ',', ' ')); ?> FC
                        </p>
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Solde disponible</p>
                    </div>
                    
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('wallet.add-funds', $cdfWallet)); ?>" 
                        ...
                        <a href="<?php echo e(route('wallet.withdraw-funds', $cdfWallet)); ?>" 
                           class="flex-1 inline-flex items-center justify-center gap-2 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 py-3 px-4 rounded-xl font-medium hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 active:scale-[0.98]">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15"/></svg>
                            Retirer
                        </a>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            ...
                            <div class="lg:col-span-5">
                                ...
                                <select class="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 mb-3" 
                                    ...
                                    <option value="<?php echo e($usdWallet->id); ?>" data-currency="USD">
                                        USD - $<?php echo e(number_format($usdWallet->balance, 2)); ?>

                                    </option>
                                    <option value="<?php echo e($cdfWallet->id); ?>" data-currency="CDF">
                                        CDF - <?php echo e(number_format($cdfWallet->balance, 2)); ?> FC
                                    </option>
                                </select>
                                <div class="flex">
                                    <input type="number" 
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    Solde disponible: <span id="fromBalance">$<?php echo e(number_format($usdWallet->balance, 2)); ?></span>
                                </p>
                            </div>
                            ...
                            <div class="lg:col-span-5">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    Solde actuel: <span id="toBalance"><?php echo e(number_format($cdfWallet->balance, 2)); ?> FC</span>
                                </p>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 text-center hidden lg:table-cell">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($transaction->wallet->currency === 'USD' ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                                <?php echo e($transaction->wallet->currency); ?>
                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($badgeClass); ?>">
                                                    <?php echo e($transaction->wallet->currency); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/wallet/index.blade.php ENDPATH**/ ?>