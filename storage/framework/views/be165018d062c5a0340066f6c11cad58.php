                    ...
                    <div class="flex-1 text-center lg:text-left">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 sm:gap-4 text-white/90">
                            <div class="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-sm sm:text-base">
                                ...
                                <span class="font-medium truncate max-w-[200px] sm:max-w-none"><?php echo e($user->email); ?></span>
                            </div>
                            <div class="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-sm sm:text-base">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-2 sm:mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-2xl sm:text-4xl font-black text-gray-900 dark:text-white"><?php echo e($stats['total_items']); ?></p>
                        </div>
                    </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 sm:p-6 hover:shadow-2xl sm:hover:scale-105 transition-all duration-300 overflow-hidden">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-2 sm:mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-2xl sm:text-4xl font-black text-gray-900 dark:text-white"><?php echo e($stats['total_orders']); ?></p>
                        </div>
                    </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 sm:p-6 hover:shadow-2xl sm:hover:scale-105 transition-all duration-300 overflow-hidden">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-2 sm:mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-2xl sm:text-4xl font-black text-gray-900 dark:text-white"><?php echo e(number_format($stats['average_rating'], 1)); ?></p>
                        </div>
                    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6 sm:mb-8">
            ...
            <div class="p-3 sm:p-6">
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
                    <!-- Mes Articles -->
                    <a href="<?php echo e(route('items.my-items')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl sm:rounded-2xl border-2 border-blue-200 dark:border-blue-800 p-3 sm:p-6 hover:shadow-2xl active:scale-95 sm:hover:scale-105 hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-2 sm:mb-4">
                                ...
                                <span class="text-gray-500 dark:text-gray-400 hidden sm:inline"><?php echo e($stats['sold_items']); ?> vendus</span>
                            </p>
                    ...
                    <!-- Mes Commandes -->
                    <a href="<?php echo e(route('orders.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl sm:rounded-2xl border-2 border-emerald-200 dark:border-emerald-800 p-3 sm:p-6 hover:shadow-2xl active:scale-95 sm:hover:scale-105 hover:border-emerald-400 dark:hover:border-emerald-600 transition-all duration-300">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-2 sm:mb-4">
                                <?php echo e($stats['total_orders']); ?> commande<?php echo e($stats['total_orders'] > 1 ? 's' : ''); ?>
                    ...
                    <a href="<?php echo e(route('vintpass.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 rounded-xl sm:rounded-2xl border-2 border-indigo-200 dark:border-indigo-800 p-3 sm:p-6 hover:shadow-2xl active:scale-95 sm:hover:scale-105 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all duration-300">
                    ...
                    <!-- Messages -->
                    <a href="<?php echo e(route('messages.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl sm:rounded-2xl border-2 border-purple-200 dark:border-purple-800 p-3 sm:p-6 hover:shadow-2xl active:scale-95 sm:hover:scale-105 hover:border-purple-400 dark:hover:border-purple-600 transition-all duration-300">
                    ...
                    <!-- Statistiques -->
                    <a href="<?php echo e(route('profile.stats')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 rounded-xl sm:rounded-2xl border-2 border-indigo-200 dark:border-indigo-800 p-3 sm:p-6 hover:shadow-2xl active:scale-95 sm:hover:scale-105 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all duration-300">
                        <div class="absolute top-0 right-0 w-16 sm:w-24 h-16 sm:h-24 bg-indigo-500/10 rounded-bl-full transform translate-x-4 sm:translate-x-8 -translate-y-4 sm:-translate-y-8"></div>
                        <div class="relative">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/profile/index.blade.php ENDPATH**/ ?>