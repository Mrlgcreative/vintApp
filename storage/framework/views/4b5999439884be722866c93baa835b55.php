...
<?php $__env->startSection('title', 'Traçage Commande #' . $order->order_number); ?>
<?php $__env->startSection('page-title', 'Traçage de la Commande #' . $order->order_number); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-700 font-medium">
            <i class="fas fa-arrow-left mr-2"></i> Retour aux détails
        </a>
        
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.orders.invoice', $order->id)); ?>" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
        ...
        <div class="info-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($order->order_number); ?></p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php if($currentTracking): ?>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($currentTracking->status_badge_class); ?>">
                            <i class="fas <?php echo e($currentTracking->status_icon); ?> mr-1"></i>
        ...
        <div class="info-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php if($currentTracking && $currentTracking->distance_to_customer): ?>
                        <p class="text-lg font-bold text-primary-600"><?php echo e($currentTracking->distance_to_customer); ?> km</p>
                    <?php else: ?>
        ...
        <div class="info-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php if($currentTracking && $currentTracking->estimated_delivery): ?>
                        <p class="text-sm font-semibold <?php echo e($currentTracking->is_late ? 'text-red-600' : 'text-gray-900 dark:text-white'); ?>">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if($currentTracking && $currentTracking->distance_to_customer): ?>
                <div class="distance-badge">
                    ...
                    <?php echo e($currentTracking->distance_to_customer); ?> km restants
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-blue-50 rounded-lg p-4">
                ...
                <p class="text-sm text-blue-800">
                    <?php echo e($currentTracking->address ?? 'Adresse non renseignée'); ?>

                </p>
                <?php if($currentTracking->city): ?>
                    <p class="text-xs text-blue-600 mt-1"><?php echo e($currentTracking->city); ?>, <?php echo e($currentTracking->country); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-green-50 rounded-lg p-4">
                ...
                <?php if($order->deliveryAddress): ?>
                    ...
                    <p class="text-sm font-semibold text-green-900"><?php echo e($order->deliveryAddress->full_name); ?></p>
                    ...
                    <p class="text-xs text-green-600 mt-1">
                        ...
                        <?php echo e($order->deliveryAddress->commune); ?>, <?php echo e($order->deliveryAddress->city); ?>
                    ...
                    <?php endif; ?>
                <?php elseif(($order->shipping_address && $order->shipping_address !== 'À définir') || ($currentTracking && $currentTracking->customer_address)): ?>
                    
                    <p class="text-sm text-green-800">
                        <?php echo e($currentTracking->customer_address ?? $order->shipping_address); ?>

                    </p>
                    <?php if($currentTracking->customer_city || ($order->shipping_city && $order->shipping_city !== 'À définir')): ?>
                        <p class="text-xs text-green-600 mt-1">
                            <i class="fas fa-map-marker-alt mr-1"></i>
                            <?php echo e($currentTracking->customer_city ?? $order->shipping_city); ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <?php if($trackingHistory && $trackingHistory->count() > 0): ?>
            <div class="tracking-timeline">
                <?php $__currentLoopData = $trackingHistory->sortByDesc('tracked_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tracking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tracking-item <?php echo e($index === 0 ? 'current' : 'completed'); ?>">
                        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                            <div class="flex items-start justify-between mb-2">
                                <div class="flex items-center">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($tracking->status_badge_class); ?>">
                                        <i class="fas <?php echo e($tracking->status_icon); ?> mr-1"></i>
                                        <?php echo e($tracking->status_text); ?>

                                    </span>
                                    <?php if($tracking->carrier): ?>
                                        <span class="ml-2 text-xs text-gray-600 dark:text-gray-300">
                                            <i class="fas fa-shipping-fast mr-1"></i>
                                            <?php echo e($tracking->carrier); ?>
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <?php echo e($tracking->formatted_tracked_at); ?>

                                </span>
                            </div>
                            
                            <?php if($tracking->description): ?>
                                <p class="text-sm text-gray-700 dark:text-gray-200 mb-2"><?php echo e($tracking->description); ?></p>
                            <?php endif; ?>
                            
                            <?php if($tracking->address): ?>
                                <p class="text-xs text-gray-600 dark:text-gray-300">
                                    <i class="fas fa-map-marker-alt text-gray-400 mr-1"></i>
                                    <?php echo e($tracking->address); ?>

                                    <?php if($tracking->city): ?>
                                        , <?php echo e($tracking->city); ?>
                            ...
                            <?php if($tracking->tracking_code): ?>
                                <p class="text-xs text-primary-600 mt-2">
                                    ...
                                    Code de suivi: <strong><?php echo e($tracking->tracking_code); ?></strong>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800 w-full">
                        ...
                        <?php if($order->deliveryAddress): ?>
                            ...
                            <div class="text-xs space-y-1 mt-2">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <strong>Destinataire:</strong> <?php echo e($order->deliveryAddress->full_name); ?>
                                ...
                                <?php if($order->deliveryAddress->email): ?>
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <strong>Email:</strong> <?php echo e($order->deliveryAddress->email); ?>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <strong>Téléphone:</strong> <?php echo e($order->deliveryAddress->phone); ?>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <strong>Ville / Commune:</strong> <?php echo e($order->deliveryAddress->city); ?>, <?php echo e($order->deliveryAddress->commune); ?>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <strong>Adresse:</strong> <?php echo e($order->deliveryAddress->address); ?>
                        ...
                        <?php elseif($order->shipping_address && $order->shipping_address !== 'À définir'): ?>
                            
                            <div class="text-xs space-y-1 mt-2">
                                <div class="flex items-start">
                                    <i class="fas fa-home text-blue-500 mr-2 mt-0.5"></i>
                                    <div>
                                        <strong>Adresse:</strong> <?php echo e($order->shipping_address); ?>
                                ...
                                <?php if($order->shipping_city && $order->shipping_city !== 'À définir'): ?>
                                    <div class="flex items-start">
                                        <i class="fas fa-city text-blue-500 mr-2 mt-0.5"></i>
                                        <div>
                                            <strong>Ville:</strong> <?php echo e($order->shipping_city); ?>
                                ...
                                <?php if($order->shipping_phone): ?>
                                    <div class="flex items-start">
                                        <i class="fas fa-phone text-blue-500 mr-2 mt-0.5"></i>
                                        <div>
                                            <strong>Téléphone:</strong> <?php echo e($order->shipping_phone); ?>
...
function initMap() {
    <?php if($currentTracking && $currentTracking->customer_latitude && $currentTracking->customer_longitude): ?>
        const destinationLat = <?php echo e($currentTracking->customer_latitude); ?>;
        const destinationLng = <?php echo e($currentTracking->customer_longitude); ?>;
    <?php elseif($order->deliveryAddress): ?>
        ...
        const destinationLat = <?php echo e($order->deliveryAddress->effective_latitude); ?>;
        const destinationLng = <?php echo e($order->deliveryAddress->effective_longitude); ?>;
    <?php else: ?>
    ...
    <?php if($currentTracking && $currentTracking->latitude && $currentTracking->longitude): ?>
        const currentLat = <?php echo e($currentTracking->latitude); ?>;
        const currentLng = <?php echo e($currentTracking->longitude); ?>;
    ...
    destinationMarker = L.marker([destinationLat, destinationLng], {icon: destinationIcon})
        .addTo(map)
        .bindPopup('<div class="text-center"><strong>Destination (Client)</strong><br/><?php echo e($currentTracking->customer_address ?? $order->shipping_address); ?></div>');

    // Ajouter le marqueur de position actuelle si disponible
    if (currentLat && currentLng) {
        currentMarker = L.marker([currentLat, currentLng], {icon: currentIcon})
            .addTo(map)
            .bindPopup('<div class="text-center"><strong>Position Actuelle</strong><br/><?php echo e($currentTracking->address ?? "En cours..."); ?></div>');
...
function calculateModalDistance() {
    ...
    <?php if($order->deliveryAddress): ?>
        // Utiliser les coordonnées effectives de l'adresse de livraison (GPS ou par défaut selon la ville)
        const customerLat = <?php echo e($order->deliveryAddress->effective_latitude); ?>;
        const customerLng = <?php echo e($order->deliveryAddress->effective_longitude); ?>;
    <?php elseif($currentTracking && $currentTracking->customer_latitude && $currentTracking->customer_longitude): ?>
        // Utiliser les coordonnées du tracking
        const customerLat = <?php echo e($currentTracking->customer_latitude); ?>;
        const customerLng = <?php echo e($currentTracking->customer_longitude); ?>;
    <?php else: ?>
...
function updateTracking(event) {
    ...
    fetch('<?php echo e(route("admin.orders.tracking.update", $order->id)); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/orders/tracking.blade.php ENDPATH**/ ?>