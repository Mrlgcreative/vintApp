...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php if($currentTracking && $currentTracking->distance_to_customer): ?>
                        <p class="text-lg font-bold text-purple-600"><?php echo e($currentTracking->distance_to_customer); ?> km</p>
                    <?php else: ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php if($currentTracking && $currentTracking->estimated_delivery): ?>
                        <p class="text-sm font-semibold <?php echo e($currentTracking->is_late ? 'text-red-600' : 'text-gray-900'); ?>">
                    ...
                    <div class="tracking-item <?php echo e($index === 0 ? 'current' : 'completed'); ?>">
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <?php if($tracking->description): ?>
                                <p class="text-sm text-gray-700 mb-2"><?php echo e($tracking->description); ?></p>
                            <?php endif; ?>
