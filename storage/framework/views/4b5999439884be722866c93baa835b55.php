    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-green-50 rounded-lg p-4">
                ...
                <?php if($currentTracking->customer_city || $order->shipping_city): ?>
                    <p class="text-xs text-green-600 mt-1"><?php echo e($currentTracking->customer_city ?? $order->shipping_city); ?></p>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <p class="text-xs">
                            <strong>Adresse:</strong> <?php echo e($order->shipping_address); ?><br>
                            <strong>Ville:</strong> <?php echo e($order->shipping_city); ?><br>
