                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-indigo-600/10 border border-gray-100/50 overflow-hidden transform hover:scale-105 hover:shadow-2xl transition-all duration-300">
                        ...
                        <div class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                            <div class="flex justify-between items-center">
                                <h6 class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($order->order_number); ?></h6>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex space-x-4 mb-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h6 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 line-clamp-2"><?php echo e(Str::limit($order->item->name, 40)); ?></h6>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($order->item->user->name); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Date</p>
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($order->created_at->format('d/m/Y')); ?></p>
                                </div>
                            </div>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/orders/index.blade.php ENDPATH**/ ?>