...
<div class="flex flex-wrap gap-3">
    <div class="relative">
        ...
        <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden z-10" 
             id="filter-dropdown">
            <div class="py-1">
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Toutes</a>
                <a href="<?php echo e(route('admin.categories.index', ['parent' => 'null'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Principales</a>
                <a href="<?php echo e(route('admin.categories.index', ['has_children' => '1'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Avec sous-catégories</a>
                <a href="<?php echo e(route('admin.categories.index', ['status' => 'active'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Actives</a>
                <a href="<?php echo e(route('admin.categories.index', ['featured' => '1'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">En vedette</a>
            </div>
        </div>
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
            <div>
                ...
                <?php if(isset($categories)): ?>
                    <p class="text-xs md:text-sm text-gray-500 dark:text-gray-400"><?php echo e($categories->count()); ?> catégorie(s) trouvée(s)</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
    <div class="p-0">
        <?php if(isset($categories) && $categories->count() > 0): ?>
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 dark:bg-gray-900 transition-colors <?php echo e(!$category->is_active ? 'opacity-60' : ''); ?>">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <?php if($category->slug): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($category->slug); ?></div>
                                        <?php endif; ?>
                                        <?php if($category->description): ?>
                                            <div class="text-xs text-gray-400 mt-0.5"><?php echo e(Str::limit($category->description, 40)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <?php if($category->parent): ?>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-700 dark:text-gray-200"><?php echo e($category->parent->name); ?></span>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col items-center">
                                    <div class="flex items-center">
                                        <strong class="text-primary-600 text-lg"><?php echo e($category->items_count ?? 0); ?></strong>
                                        <span class="text-xs text-gray-500 dark:text-gray-400 ml-1">articles</span>
                                    </div>
                                    <?php if(($category->children_count ?? 0) > 0): ?>
                                        <div class="text-xs text-gray-400 mt-1">
                                            <i class="fas fa-sitemap mr-1"></i><?php echo e($category->children_count); ?> sous-catégorie(s)
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col gap-1.5">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 border border-gray-200 dark:border-gray-700'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full <?php echo e($category->is_active ? 'bg-green-500' : 'bg-gray-500'); ?> mr-1.5"></span>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1 justify-end items-center">
                                    <button onclick="editCategory(<?php echo e($category->id); ?>)" 
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden z-10" 
                                             id="actions-<?php echo e($category->id); ?>">
                                            <div class="py-1">
                                                <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="toggleCategoryStatus('<?php echo e($category->id); ?>')">
                                                    <i class="fas fa-<?php echo e($category->is_active ? 'pause' : 'play'); ?> mr-2 text-<?php echo e($category->is_active ? 'warning' : 'success'); ?>"></i>
                                                    <?php echo e($category->is_active ? 'Désactiver' : 'Activer'); ?>

                                                </button>
                                                <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="toggleCategoryFeatured(<?php echo e($category->id); ?>)">
                                                    <i class="fas fa-star mr-2 text-yellow-500"></i>
                                                    <?php echo e($category->is_featured ? 'Retirer vedette' : 'Mettre en vedette'); ?>

                                                </button>
                                                <hr class="my-1">
                                                <button class="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50" onclick="deleteCategory(<?php echo e($category->id); ?>, '<?php echo e(addslashes($category->name)); ?>')">
            ...
            <div class="lg:hidden">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border-b border-gray-200 p-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors <?php echo e(!$category->is_active ? 'opacity-60' : ''); ?>">
                    <div class="flex gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex justify-between items-start mb-2">
                                <div class="flex-1 min-w-0">
                                    <h6 class="font-semibold text-gray-900 dark:text-white truncate"><?php echo e($category->name); ?></h6>
                                    <?php if($category->parent): ?>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><i class="fas fa-level-up-alt mr-1"></i><?php echo e($category->parent->name); ?></p>
                                    <?php endif; ?>
                                </div>
                                
                                <!-- Menu dropdown actions mobile -->
                                <div class="relative">
                                    <button class="text-gray-400 hover:text-gray-600 dark:text-gray-300 p-1" onclick="toggleMobileDropdown(<?php echo e($category->id); ?>)">
                                        <i class="fas fa-ellipsis-v"></i>
                                    </button>
                                    <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden z-10" 
                                         id="mobile-dropdown-<?php echo e($category->id); ?>">
                                        <div class="py-1">
                                            <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="editCategory(<?php echo e($category->id); ?>)">
                                                <i class="fas fa-edit w-4"></i> Modifier
                                            </button>
                                            <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="toggleCategoryStatus(<?php echo e($category->id); ?>)">
                                                <i class="fas <?php echo e($category->is_active ? 'fa-pause' : 'fa-play'); ?> w-4"></i>
                                                <?php echo e($category->is_active ? 'Désactiver' : 'Activer'); ?>
                            ...
                            <!-- Description -->
                            <?php if($category->description): ?>
                                <p class="text-xs text-gray-400 mb-2 line-clamp-2"><?php echo e($category->description); ?></p>
                            <?php endif; ?>
                            
                            <!-- Badges et infos -->
                            <div class="flex flex-wrap gap-2 mb-2">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100'); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($category->is_active ? 'bg-green-500' : 'bg-gray-500'); ?> mr-1"></span>
                                    <?php echo e($category->is_active ? 'Active' : 'Inactive'); ?>
                            ...
                            <div class="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <?php if(($category->children_count ?? 0) > 0): ?>
                                    <span>
                                        ...
                                        <?php echo e($category->children_count); ?> sous-cat.
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <a href="<?php echo e(route('admin.categories.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="parent_id" name="parent_id" 
                            ...
                            <?php if(isset($categories)): ?>
                                <?php $__currentLoopData = $categories->whereNull('parent_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>