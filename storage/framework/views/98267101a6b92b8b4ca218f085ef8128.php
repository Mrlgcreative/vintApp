...
<?php $__env->startSection('title', 'Statut de vérification'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-start justify-between">
                <div class="flex items-start space-x-4">
                    <?php if(count($item->images) > 0): ?>
                        <img src="<?php echo e(asset('storage/' . $item->images[0])); ?>" 
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-1"><?php echo e($item->name); ?></h1>
                        <p class="text-gray-600 dark:text-gray-300 mb-2"><?php echo e($item->brand->name ?? 'Marque non spécifiée'); ?> • <?php echo e($item->category->name ?? 'Catégorie'); ?></p>
                        <p class="text-lg font-semibold text-indigo-600"><?php echo e($item->formatted_price); ?></p>
                        
                        <?php if($item->isVerified()): ?>
                            <div class="mt-2">
                                <?php echo $item->getAuthenticityBadgeHtml(); ?>
                ...
                <div class="text-right">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($check->getStatusBadgeClass()); ?>">
                        <?php echo e($check->getStatusLabel()); ?>

                    </span>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Demande #<?php echo e($check->id); ?></p>
                </div>
            </div>
        </div>

        <!-- Statut principal -->
        <?php if($check->isApproved()): ?>
            <!-- Statut Approuvé -->
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200 p-6 mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <?php if($check->final_decision_at): ?>
                            <p class="text-sm text-green-600 mt-2">Vérifié le <?php echo e($check->final_decision_at->format('d/m/Y à H:i')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            
        <?php elseif($check->isRejected()): ?>
            <!-- Statut Rejeté -->
            <div class="bg-gradient-to-r from-red-50 to-rose-50 rounded-lg border border-red-200 p-6 mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <?php if($check->final_decision_at): ?>
                            <p class="text-sm text-red-600 mt-2">Décision prise le <?php echo e($check->final_decision_at->format('d/m/Y à H:i')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <?php if($check->expert_notes): ?>
                    <div class="mt-4 bg-white dark:bg-gray-800 rounded-lg p-4">
                        ...
                        <p class="text-gray-700 dark:text-gray-200 text-sm"><?php echo e($check->expert_notes); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-6 mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <?php elseif($check->status === 'expert_review'): ?>
                            <p class="text-blue-700 mt-1">Un expert examine actuellement votre produit.</p>
                            <?php if($check->expert): ?>
                                <p class="text-sm text-blue-600 mt-2">Expert assigné : <?php echo e($check->expert->name); ?></p>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($check->submitted_at ? $check->submitted_at->format('d/m/Y à H:i') : 'En attente'); ?></p>
                            <?php if($check->payment_completed): ?>
                    ...
                    <!-- Analyse IA -->
                    <div class="relative flex items-start">
                        <?php if($check->ai_completed_at): ?>
                            <div class="relative z-10 w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        <?php elseif($check->payment_completed): ?>
                        ...
                        <div class="ml-4">
                            ...
                            <?php if($check->ai_completed_at): ?>
                                <p class="text-sm text-gray-600 dark:text-gray-300">Terminée le <?php echo e($check->ai_completed_at->format('d/m/Y à H:i')); ?></p>
                                <?php if($check->ai_confidence_score): ?>
                                    <p class="text-sm text-blue-600">Score de confiance: <?php echo e($check->ai_confidence_score); ?>%</p>
                                <?php endif; ?>
                            <?php elseif($check->payment_completed): ?>
                    ...
                    <?php if($check->needsExpertReview() || $check->expert_completed_at): ?>
                        <div class="relative flex items-start">
                            <?php if($check->expert_completed_at): ?>
                                <div class="relative z-10 w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                    <svg class="w-6 h-6 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                </div>
                            <?php elseif($check->expert_assigned_at): ?>
                                <div class="relative z-10 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                            ...
                            <div class="ml-4">
                                ...
                                <?php if($check->expert_completed_at): ?>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Terminé le <?php echo e($check->expert_completed_at->format('d/m/Y à H:i')); ?></p>
                                    <?php if($check->expert): ?>
                                        <p class="text-sm text-primary-600">Expert: <?php echo e($check->expert->name); ?></p>
                                    <?php endif; ?>
                                <?php elseif($check->expert_assigned_at): ?>
                                    <p class="text-sm text-blue-600">En cours d'examen par un expert</p>
                                    <?php if($check->expert): ?>
                                        <p class="text-sm text-gray-600 dark:text-gray-300">Expert assigné: <?php echo e($check->expert->name); ?></p>
                                    <?php endif; ?>
                                <?php else: ?>
                    ...
                    <div class="relative flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <?php if($check->final_decision_at): ?>
                                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($check->final_decision_at->format('d/m/Y à H:i')); ?></p>
                                <?php if($check->isApproved()): ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $check->verificationImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group">
                            <img src="<?php echo e($image->getImageUrl()); ?>" 
                                 alt="<?php echo e($image->getTypeLabel()); ?>"
                            ...
                            <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-75 text-white text-xs p-2 rounded-b-lg">
                                <?php echo e($image->getTypeLabel()); ?>

                                <?php if($image->image_quality_score): ?>
                                    <span class="float-right"><?php echo e($image->image_quality_score); ?>%</span>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="space-x-3">
                <?php if(!$check->payment_completed): ?>
                    <a href="<?php echo e(route('authenticity.payment', $check)); ?>" 
                       class="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700">
                        Finaliser le paiement
                    </a>
                <?php endif; ?>
                
                <a href="<?php echo e(route('authenticity.dashboard')); ?>" 
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/authenticity/status.blade.php ENDPATH**/ ?>