...
<div class="container py-4">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center mb-2">
            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-sm btn-light me-3">
    ...
    <div class="settings-section mb-4">
        ...
        <div class="card shadow-sm border-0">
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('profile.edit')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                ...
                <a href="<?php echo e(route('items.personalization')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
    ...
    <div class="settings-section mb-4">
        ...
        <div class="card shadow-sm border-0">
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('dashboard')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                ...
                <a href="<?php echo e(route('orders.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                ...
                <a href="<?php echo e(route('orders.my-sales')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-success bg-opacity-10 text-success me-3">
                ...
                <a href="<?php echo e(route('items.my-items')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-primary bg-opacity-10 text-primary me-3">
                ...
                <a href="<?php echo e(route('wallet.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-warning bg-opacity-10 text-warning me-3">
                ...
                <a href="<?php echo e(route('messages.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-info bg-opacity-10 text-info me-3">
    ...
    <div class="settings-section mb-4">
        ...
        <div class="card shadow-sm border-0">
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('brands.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-danger bg-opacity-10 text-danger me-3">
                ...
                <a href="<?php echo e(route('categories.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-primary bg-opacity-10 text-primary me-3">
                ...
                <a href="<?php echo e(route('items.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3">
                    <div class="settings-icon bg-success bg-opacity-10 text-success me-3">
    ...
    <div class="text-center text-muted mb-5">
        <small>
            <?php echo e(config('app.name')); ?> v1.0.0<br>
