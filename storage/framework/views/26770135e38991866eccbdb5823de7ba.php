    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('brands.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-amber-600 transition-colors duration-200">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-amber-600">Modifier <?php echo e($brand->name); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Modifier la marque</h1>
                    <p class="text-gray-600 text-sm mt-1">Modifiez les informations de "<?php echo e($brand->name); ?>"</p>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="3" 
                                      maxlength="255"
                                      class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 resize-none"
                                      placeholder="Décrivez brièvement la marque..."><?php echo e(old('description', $brand->description)); ?></textarea>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" 
                                       name="website" 
                                       id="website" 
                                       class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200" 
                        ...
                        <div>
                            ...
                            <?php if($brand->logo): ?>
                                <div class="mb-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <div class="w-16 h-16 bg-white rounded-xl shadow-sm border border-gray-200 flex items-center justify-center overflow-hidden">
                                                <img src="<?php echo e(asset('storage/' . $brand->logo)); ?>" 
                                                     alt="Logo actuel de <?php echo e($brand->name); ?>" 
                                                     class="w-full h-full object-contain">
                                            </div>
                                        </div>
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900">Logo actuel</p>
                                            <p class="text-xs text-gray-500">Sélectionnez un nouveau fichier pour le remplacer</p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="relative">
                                <input type="file" 
                                       ...
                                       id="logo" 
                                       accept="image/*"
                                       class="block w-full text-sm text-gray-500 file:mr-4 file:py-3 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-amber-50 file:text-amber-700 hover:file:bg-amber-100 transition-colors duration-200 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        ...
                        <div>
                            ...
                            <select name="country" 
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($country); ?>" <?php echo e(old('country', $brand->country ?? '') == $country ? 'selected' : ''); ?>>
                                        <?php echo e($country); ?>
                        ...
                        <div>
                            ...
                            <select name="type" 
                                ...
                                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type); ?>" <?php echo e(old('type', $brand->type ?? '') == $type ? 'selected' : ''); ?>>
                                        <?php echo e($type); ?>
