                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-indigo-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-semibold text-gray-900"><?php echo e($brand->name); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-gray-600 text-sm max-w-xs"><?php echo e(Str::limit($brand->description, 40)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($brand->name); ?></h3>
                                        <?php if($brand->description): ?>
                                            <p class="text-gray-600 text-sm mb-2"><?php echo e(Str::limit($brand->description, 80)); ?></p>
                                        <?php endif; ?>
                                        <?php if($brand->website): ?>
                                            <a href="<?php echo e($brand->website); ?>" 
                                               target="_blank" 
