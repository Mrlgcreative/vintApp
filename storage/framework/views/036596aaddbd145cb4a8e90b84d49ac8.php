        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mt-1">
                    ...
                    <span id="map-country-count" class="font-semibold text-purple-600"><?php echo e($stats['countries_count']); ?></span> pays
                </p>
            </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 border border-purple-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div class="flex-1">
                    ...
                    <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-900 mt-0.5 sm:mt-1"><?php echo e($stats['total_regions']); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 border border-pink-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-pink-900 mt-1"><?php echo e($stats['active_regions']); ?></p>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 lg:px-6 py-4 whitespace-nowrap">
                                    <div class="font-semibold text-gray-900"><?php echo e($city->name); ?></div>
                                    <?php if($city->description): ?>
                                        <div class="text-sm text-gray-500"><?php echo e(Str::limit($city->description, 40)); ?></div>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button onclick="toggleCityStatus(<?php echo e($city->id); ?>)" 
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($city->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                ...
                <div class="lg:hidden space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900"><?php echo e($city->name); ?></h4>
                                <p class="text-sm text-gray-600 mt-1"><?php echo e($city->region ?? 'Région non spécifiée'); ?></p>
                            </div>
                            <button onclick="toggleCityStatus(<?php echo e($city->id); ?>)" 
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($city->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($city->is_active ? 'Active' : 'Inactive'); ?>
                        ...
                        <div class="grid grid-cols-2 gap-2 text-sm mb-3">
                            <div>
                                ...
                                <span class="text-gray-900 ml-1"><?php echo e($city->country); ?></span>
                            </div>
                            <?php if($city->city_code): ?>
                            <div>
                                <span class="text-gray-500">Code:</span>
                                <span class="text-gray-900 ml-1"><?php echo e($city->city_code); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
            ...
            <?php if($regions->count() > 0): ?>
                ...
                <div class="hidden lg:block overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-semibold text-gray-900"><?php echo e($region->name); ?></div>
                                    <?php if($region->description): ?>
                                        <div class="text-sm text-gray-500"><?php echo e(Str::limit($region->description, 40)); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button onclick="toggleRegionStatus(<?php echo e($region->id); ?>)" 
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($region->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <i class="fas fa-circle text-xs mr-1"></i>
                ...
                <div class="lg:hidden space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900"><?php echo e($region->name); ?></h4>
                                <p class="text-sm text-gray-600 mt-1"><?php echo e($region->country); ?></p>
                            </div>
                            <button onclick="toggleRegionStatus(<?php echo e($region->id); ?>)" 
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($region->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($region->is_active ? 'Active' : 'Inactive'); ?>
                        ...
                        <div class="text-sm mb-3">
                            <span class="text-gray-500">Code:</span>
                            <span class="text-gray-900 ml-1"><?php echo e($region->region_code); ?></span>
                        </div>
                        <?php endif; ?>
