    ...
    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <?php if(session('success')): ?>
                    <div class="alert alert-success d-flex align-items-start mb-4" role="alert">
                        <i class="fas fa-check-circle fs-4 me-3 mt-1"></i>
                        <div>
                            <p class="mb-0 fw-semibold"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('warning')): ?>
                    <div class="alert alert-warning d-flex align-items-start mb-4" role="alert">
                        ...
                        <div>
                            <p class="mb-0 fw-semibold"><?php echo e(session('warning')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="bg-light rounded-3 p-3 mb-4">
                    <div class="d-flex align-items-center justify-content-center gap-2">
                        ...
                        <span class="fw-semibold text-dark"><?php echo e(Auth::user()->email); ?></span>
                    </div>
                </div>
        ...
        <div class="text-center mt-4">
            <p class="small text-muted">
                ...
                <a href="mailto:<?php echo e(config('mail.from.address')); ?>" class="text-primary text-decoration-none fw-medium">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>