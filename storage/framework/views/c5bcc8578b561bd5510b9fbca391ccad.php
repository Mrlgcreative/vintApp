...
<?php $__env->startSection('title', 'Gestion des Wallets'); ?>
<?php $__env->startSection('page-title', 'Gestion des Wallets Entreprise'); ?>
    ...
    <div class="content-wrapper mx-8 my-8 p-12 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12 animate-fade-in">
            <div class="stats-card wallets group">
                <div class="p-8 h-full flex flex-col justify-center items-center text-center">
                    ...
                    <h3 class="text-4xl font-bold mb-2"><?php echo e($totalWallets ?? 0); ?></h3>
            ...
            <div class="stats-card usd group">
                <div class="p-8 h-full flex flex-col justify-center items-center text-center">
                    ...
                    <h3 class="text-4xl font-bold mb-2">$<?php echo e(number_format($totalUsdBalance ?? 0, 2)); ?></h3>
            ...
            <div class="stats-card cdf group">
                <div class="p-8 h-full flex flex-col justify-center items-center text-center">
                    ...
                    <h3 class="text-4xl font-bold mb-2"><?php echo e(number_format($totalCdfBalance ?? 0, 0, ',', ' ')); ?></h3>
            ...
            <div class="stats-card commissions group">
                <div class="p-8 h-full flex flex-col justify-center items-center text-center">
                    ...
                    <h3 class="text-4xl font-bold mb-2"><?php echo e($commissionsToday ?? 0); ?></h3>
        ...
        <div class="mb-12 animate-fade-in">
            <div class="main-card">
                ...
                <div class="p-6">
                    <?php if(!empty($enterpriseWallets) && count($enterpriseWallets) > 0): ?>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <?php $__currentLoopData = $enterpriseWallets ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="p-8 relative z-10">
                                        <div class="flex justify-between items-start mb-6">
                                            <div>
                                                <h6 class="text-white text-lg font-semibold mb-2 flex items-center">
                                                    <i class="fas fa-building mr-3"></i>
                                                    Portefeuille Entreprise <?php echo e($wallet->currency ?? 'N/A'); ?>

                                                </h6>
                                                <small class="text-white opacity-80">
                                                    Commission: <?php echo e($wallet->commission_rate ?? 5); ?>%
                                                </small>
                                            </div>
                                            <span class="currency-badge">
                                                <?php echo e($wallet->currency ?? 'N/A'); ?>
                                        ...
                                        <div class="text-center mb-6">
                                            <div class="balance-display text-white">
                                                <?php if(($wallet->currency ?? 'USD') === 'USD'): ?>
                                                    $<?php echo e(number_format($wallet->balance ?? 0, 2)); ?>

                                                <?php else: ?>
                                                    <?php echo e(number_format($wallet->balance ?? 0, 0, ',', ' ')); ?> FC
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="bg-white bg-opacity-10 rounded-xl p-4 mb-6 backdrop-blur-sm">
                                            <div class="grid grid-cols-2 gap-4 text-center text-white">
                                                <div>
                                                    <div class="text-xl font-semibold mb-1"><?php echo e($wallet->total_transactions ?? 0); ?></div>
                                                    <div class="text-xs uppercase tracking-wider opacity-80">Transactions</div>
                                                </div>
                                                <div>
                                                    <div class="text-xl font-semibold mb-1">
                                                        <?php if(($wallet->currency ?? 'USD') === 'USD'): ?>
                                                            $<?php echo e(number_format($wallet->total_commissions ?? 0, 2)); ?>

                                                        <?php else: ?>
                                                            <?php echo e(number_format($wallet->total_commissions ?? 0, 0, ',', ' ')); ?> FC
                                                        <?php endif; ?>
                                                    </div>
                                        ...
                                        <div class="flex gap-3">
                                            <button class="flex-1 px-4 py-3 bg-white bg-opacity-10 text-white border-2 border-white border-opacity-30 rounded-lg font-semibold uppercase tracking-wide text-sm transition-all duration-300 hover:bg-opacity-20 hover:border-opacity-50 hover:-translate-y-1 hover:shadow-lg flex items-center justify-center" 
                                                    onclick="openCommissionModal('<?php echo e($wallet->id ?? ''); ?>')">
                                            ...
                                            <button class="flex-1 px-4 py-3 bg-white text-gray-800 border-2 border-white rounded-lg font-semibold uppercase tracking-wide text-sm transition-all duration-300 hover:bg-gray-50 hover:-translate-y-1 hover:shadow-lg flex items-center justify-center" 
                                                    onclick="openWithdrawModal('<?php echo e($wallet->id ?? ''); ?>')">
        ...
        <div class="animate-fade-in">
            <div class="main-card">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b-2 border-gray-200 flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('admin.transactions.index')); ?>" class="btn-modern btn-primary-modern text-sm flex items-center">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recentTransactions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="transaction-row">
                                            ...
                                            <td>
                                                <span class="fw-bold <?php echo e($transaction->type === 'credit' ? 'text-success' : 'text-warning'); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        <?php echo e(number_format($transaction->amount, 0, ',', ' ')); ?> FC
                                                    <?php endif; ?>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge currency-badge <?php echo e($transaction->currency === 'USD' ? 'bg-success' : 'bg-info'); ?>">
                                            ...
                                            <td>
                                                <?php switch($transaction->status ?? 'pending'):
                                                    case ('completed'): ?>
                                                    ...
                                                    <?php case ('failed'): ?>
                                                        ...
                                                        <?php break; ?>
                                                    <?php default: ?>
                                                        <span class="status-badge bg-secondary text-white"><?php echo e($transaction->status ?? 'N/A'); ?></span>
                                                <?php endswitch; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        new Chart(commissionsCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: <?php echo json_encode($chartData['usd'] ?? []); ?>,
                    borderColor: '#28a745',
                    backgroundColor: 'rgba(40, 167, 69, 0.1)',
                    tension: 0.4
                }, {
                    label: 'Commissions CDF',
                    data: <?php echo json_encode($chartData['cdf'] ?? []); ?>,
                    borderColor: '#007bff',
    ...
    if (currencyCtx) {
        new Chart(currencyCtx, {
            ...
            data: {
                labels: ['USD', 'CDF'],
                datasets: [{
                    data: [<?php echo $totalUsdBalance ?? 0; ?>, <?php echo $totalCdfBalance ?? 0; ?>],
...
<script src="<?php echo e(asset('js/wallet-modal-test.js')); ?>"></script>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/wallets/index.blade.php ENDPATH**/ ?>