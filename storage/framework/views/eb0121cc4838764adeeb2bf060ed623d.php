    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 p-6 mb-8">
            <div class="flex items-center space-x-4">
                ...
                <?php endif; ?>
                <div>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white"><?php echo e(Auth::user()->name); ?></h2>
                    <p class="text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->email); ?></p>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700/50">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-700/50">
                    <div class="divide-y divide-gray-100 dark:divide-gray-700/50">
                        <a href="<?php echo e(route('dashboard')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('orders.my-sales')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-700/50">
                        <a href="<?php echo e(route('items.my-items')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('wallet.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('messages.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            <div class="flex items-center space-x-4">
                ...
                <div class="border-t border-gray-100 dark:border-gray-700/50 bg-gradient-to-r from-primary-50 to-cyan-50 dark:from-primary-900/20 dark:to-cyan-900/20">
                    <a href="<?php echo e(route('affiliate.dashboard')); ?>" class="block px-6 py-4 hover:from-primary-100 hover:to-cyan-100 dark:hover:from-primary-900/30 dark:hover:to-cyan-900/30 transition-all group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-700/50">
                    <a href="<?php echo e(route('brands.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('categories.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('items.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700/50">
                    <a href="<?php echo e(route('help.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('support.create')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('terms')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div class="text-center py-8 text-gray-400 dark:text-gray-500">
                ...
                <p class="text-sm">&copy; <?php echo e(date('Y')); ?> Tous droits reserves</p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/settings/index.blade.php ENDPATH**/ ?>