                    ...
                    <div class="mb-6">
                            ...
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <?php endif; ?>
                                        <span class="text-gray-900"><?php echo e($item['name']); ?> x <?php echo e($item['quantity']); ?></span>
                                    </div>
                                    <span class="font-semibold text-gray-900"><?php echo e(number_format($item['price'] * $item['quantity'], 2)); ?> <?php echo e($item['currency']); ?></span>
                                </div>
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <span class="font-semibold text-gray-900"><?php echo e(number_format($subtotalInPriority, 2)); ?> <?php echo e($priorityCurrency); ?></span>
                            </div>
                            <div class="flex justify-between items-center mb-3">
                                <span class="text-gray-700">
                                    Frais de livraison :
                                    <span class="text-sm text-gray-500">(<?php echo e($transportFeePercentage); ?>%)</span>
                                </span>
                                <span class="font-semibold text-blue-600">+<?php echo e(number_format($transportFeeInPriority, 2)); ?> <?php echo e($priorityCurrency); ?></span>
                            </div>
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between items-center">
                                    <span class="text-xl font-semibold text-gray-900">Total à payer :</span>
                                    <span class="text-xl font-bold text-green-600"><?php echo e(number_format($totalInPriority, 2)); ?> <?php echo e($priorityCurrency); ?></span>
                                </div>
                                <?php if(count($currencyCounts) > 1): ?>
                                    <p class="text-sm text-gray-500 mt-2">
                                        <i class="fas fa-info-circle mr-1"></i> Devises mixtes converties en <?php echo e($priorityCurrency); ?>
                ...
                <form id="payment-form">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex">
                            ...
                            <span class="inline-flex items-center px-3 py-2 bg-gray-50 border border-gray-300 rounded-r-lg text-sm font-medium text-gray-700"><?php echo e(isset($priorityCurrency) ? $priorityCurrency : (isset($cart) && !empty($cart) ? ($cart[0]['currency'] ?? 'USD') : 'USD')); ?></span>
                        </div>
                        <?php
