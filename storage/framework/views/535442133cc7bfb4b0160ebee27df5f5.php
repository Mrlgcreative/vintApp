                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="text-lg font-semibold text-gray-900 truncate">
                                            <?php echo e($refund->order->item->name); ?>

                                        </h3>
                                        <p class="text-sm text-gray-500">
                                            Commande #<?php echo e($refund->order->order_number); ?>

                                        </p>
                                        <p class="text-sm text-gray-600 mt-1">
                                            Acheteur: <?php echo e($refund->buyer->name); ?> (<?php echo e($refund->buyer->email); ?>)
                                        </p>
                                        <p class="text-sm text-gray-600">
                                            Demandé le: <?php echo e($refund->created_at->format('d/m/Y à H:i')); ?>
                            ...
                            <div class="lg:text-right">
                                <div class="space-y-2">
                                    <div>
                                        ...
                                        <div class="text-lg font-semibold text-gray-900"><?php echo e($refund->currency === 'USD' ? '$' : 'FC'); ?> <?php echo e(number_format($refund->original_amount, 2)); ?></div>
                                    </div>
                                    <div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border <?php echo e($statusClasses[$refund->status] ?? 'bg-gray-100 text-gray-800 border-gray-200'); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/refunds/index.blade.php ENDPATH**/ ?>