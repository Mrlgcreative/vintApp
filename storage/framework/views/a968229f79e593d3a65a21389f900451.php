        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_experts']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['active_experts']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_verifications']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['pending_verifications']); ?></p>
                </div>
            ...
            <?php if($experts->count() > 0): ?>
                                    ...
                                    <td class="py-4 px-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button" 
                                                    ...
                                                    onclick="revokeExpert(<?php echo e($expert->id); ?>, '<?php echo e($expert->user->name); ?>')">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
                    <div class="text-sm text-gray-600 dark:text-gray-300">
                        Affichage de <?php echo e($experts->firstItem() ?? 0); ?> à <?php echo e($experts->lastItem() ?? 0); ?> 
                        sur <?php echo e($experts->total()); ?> experts
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/experts/index.blade.php ENDPATH**/ ?>