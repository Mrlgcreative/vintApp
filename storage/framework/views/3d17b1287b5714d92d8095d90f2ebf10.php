                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-indigo-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-gray-600 dark:text-gray-300 text-sm max-w-xs"><?php echo e(Str::limit($brand->description, 40)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($brand->website): ?>
                                        <a href="<?php echo e($brand->website); ?>" 
                                           ...
                                           class="text-indigo-600 hover:text-indigo-800 font-medium text-sm">
                                            <?php echo e(Str::limit($brand->website, 30)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <form action="<?php echo e(route('brands.destroy', $brand)); ?>" 
                                              method="POST" 
                                              class="inline-block" 
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1"><?php echo e($brand->name); ?></h3>
                                        <?php if($brand->description): ?>
                                            <p class="text-gray-600 dark:text-gray-300 text-sm mb-2"><?php echo e(Str::limit($brand->description, 80)); ?></p>
                                        <?php endif; ?>
                                        <?php if($brand->website): ?>
                                            <a href="<?php echo e($brand->website); ?>" 
                                               target="_blank" 
                                               class="text-indigo-600 hover:text-indigo-800 font-medium text-sm mb-2 block">
                                                <?php echo e(Str::limit($brand->website, 40)); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/brands/index.blade.php ENDPATH**/ ?>