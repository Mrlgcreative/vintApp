...
<?php $__env->startSection('title', 'Gestion des pré-inscriptions'); ?>
...
<div class="container-fluid py-4">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?php echo e(route('admin.waiting-users.export')); ?>" class="btn btn-success">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($stats['converted']); ?></h3>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0"><?php echo e($stats['this_week']); ?></h4>
        ...
        <div class="col-md-4">
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0"><?php echo e($stats['this_month']); ?></h4>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.waiting-users.index')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="converted" <?php echo e(request('status') == 'converted' ? 'selected' : ''); ?>>Converti</option>
                    </select>
                </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white dark:bg-gray-800">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-list me-2"></i>Liste des pré-inscriptions (<?php echo e($waitingUsers->total()); ?>)
                </h5>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $waitingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($user->waiting_days > 7 ? 'danger' : ($user->waiting_days > 3 ? 'warning' : 'info')); ?>">
                                        <?php echo e($user->waiting_days); ?>

                                    </span>
                                </td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="<?php echo e(route('admin.waiting-users.show', $user)); ?>" class="btn btn-sm btn-info" title="Voir détails">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        
                                        <?php if($user->status === 'confirmed' || $user->status === 'pending'): ?>
                                            <form action="<?php echo e(route('admin.waiting-users.approve', $user)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <button type="button" class="btn btn-sm btn-warning" onclick="showRejectModal(<?php echo e($user->id); ?>)" title="Rejeter">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        <?php endif; ?>
                                        
                                        <form action="<?php echo e(route('admin.waiting-users.destroy', $user)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cette pré-inscription ?')">
                                            <?php echo csrf_field(); ?>
        ...
        <?php if($waitingUsers->hasPages()): ?>
            <div class="card-footer bg-white dark:bg-gray-800">
                <?php echo e($waitingUsers->links()); ?>
...
<script>
    ...
    function bulkAction(action) {
        ...
        form.method = 'POST';
        form.action = '<?php echo e(route("admin.waiting-users.bulk-action")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/waiting-users/index.blade.php ENDPATH**/ ?>