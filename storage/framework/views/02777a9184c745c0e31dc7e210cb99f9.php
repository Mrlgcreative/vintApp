            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($reports['revenue']['count'])); ?></div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($reports['revenue']['average'], 2)); ?></div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($reports['users']['active_users'])); ?></div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($reports['users']['total_users'])); ?></div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 dark:bg-gray-900 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center justify-center w-8 h-8 rounded-full <?php echo e($index === 0 ? 'bg-yellow-100 text-yellow-600' : ($index === 1 ? 'bg-gray-100 dark:bg-gray-800 text-gray-600' : ($index === 2 ? 'bg-orange-100 text-orange-600' : 'bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400'))); ?> font-bold text-sm">
                                <?php echo e($index + 1); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <?php endif; ?>
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-white"><?php echo e($item->name); ?></div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($item->category->name ?? 'N/A'); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <span class="font-semibold text-gray-900 dark:text-white">$<?php echo e(number_format($item->price, 2)); ?></span>
                        </td>
                    </tr>
