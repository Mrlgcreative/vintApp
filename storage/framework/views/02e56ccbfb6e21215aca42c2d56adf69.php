            ...
            <?php if($localDelivery->status === 'in_transit'): ?>
                ...
                <?php if(auth()->id() === $localDelivery->buyer_id): ?>
                    ...
                    <form action="<?php echo e(route('local-delivery.delivered', $localDelivery)); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label for="delivery_code" class="block text-sm font-medium text-gray-700">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($localDelivery->created_at->format('d/m/Y à H:i')); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($localDelivery->accepted_at->format('d/m/Y à H:i')); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($localDelivery->pickup_time->format('d/m/Y à H:i')); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($localDelivery->actual_delivery_time->format('d/m/Y à H:i')); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($localDelivery->updated_at->format('d/m/Y à H:i')); ?></p>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/local-delivery/show.blade.php ENDPATH**/ ?>