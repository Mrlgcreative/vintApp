    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-purple-600 mt-2"><?php echo e(number_format(($fileSize ?? 0) / 1024, 0)); ?> KB</p>
            </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($log['datetime'])->format('d/m/Y H:i:s')); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($log['datetime'])->diffForHumans()); ?></div>
                        </td>
                    </tr>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="<?php echo e($bgClass); ?> px-4 py-3 border-b">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-600"><?php echo e(\Carbon\Carbon::parse($log['datetime'])->diffForHumans()); ?></span>
                </div>
            </div>
            <div class="p-4 space-y-3">
                <div>
                    <p class="text-sm font-medium text-gray-700 mb-1">Message:</p>
                    <p class="text-sm text-gray-900"><?php echo e($log['message']); ?></p>
                </div>
                <div>
                ...
                <div class="pt-2 border-t border-gray-100">
                    <p class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($log['datetime'])->format('d/m/Y H:i:s')); ?></p>
                </div>
            </div>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
