                    ...
                    <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-3 z-20">
                        <?php $__currentLoopData = $heroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button onclick="goToSlide(<?php echo e($index); ?>)" 
                                    class="carousel-dot w-3 h-3 rounded-full transition-all <?php echo e($index === 0 ? 'bg-white dark:bg-gray-800' : 'bg-white dark:bg-gray-800/40 hover:bg-white dark:bg-gray-800/60'); ?>">
                            </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
        ...
        <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $latestItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <article class="group relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden card-hover border-2 <?php echo e($isBoosted ? 'border-primary-300 ring-2 ring-primary-100 shadow-lg shadow-primary-500/20' : 'border-gray-100 hover:border-primary-200'); ?> transition-all duration-300">
                        <!-- Image Container -->
                        ...
                        <div class="p-5 lg:p-6 <?php echo e($isBoosted ? 'bg-gradient-to-b from-white to-primary-50/30' : ''); ?>">
                            <div class="space-y-3">
                                <h3 class="font-bold text-base lg:text-lg <?php echo e($isBoosted ? 'text-primary-900' : 'text-gray-900 dark:text-white'); ?> line-clamp-2 min-h-[3rem] leading-tight">
                                    <?php echo e($item->name); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/home.blade.php ENDPATH**/ ?>