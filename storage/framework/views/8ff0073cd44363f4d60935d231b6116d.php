...
<?php $__env->startSection('page-title', 'Gestion des marques'); ?>
...
<div class="flex flex-wrap gap-3">
    <div class="relative">
        ...
        <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden z-10" 
             id="filter-dropdown">
            <div class="py-1">
                <a href="<?php echo e(route('admin.brands.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Toutes</a>
                <a href="<?php echo e(route('admin.brands.index', ['status' => 'active'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Actives</a>
                <a href="<?php echo e(route('admin.brands.index', ['status' => 'inactive'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">Inactives</a>
                <a href="<?php echo e(route('admin.brands.index', ['featured' => '1'])); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">En vedette</a>
            </div>
        </div>
    </div>
    <div class="relative">
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
    <div class="p-6">
        <form method="GET" action="<?php echo e(route('admin.brands.index')); ?>" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                <select name="country" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <option value="IT" <?php echo e(request('country') === 'IT' ? 'selected' : ''); ?>>Italie</option>
            ...
            <div>
                <select name="sort" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <option value="created_at" <?php echo e(request('sort') === 'created_at' ? 'selected' : ''); ?>>Plus ancien</option>
                    <option value="-created_at" <?php echo e(request('sort', '-created_at') === '-created_at' ? 'selected' : ''); ?>>Plus récent</option>
                </select>
            </div>
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('admin.brands.index')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
                    <i class="fas fa-times"></i>
                </a>
            </div>
        </form>
        ...
        <div class="p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($brands->total() ?? 0); ?></div>
                </div>
        ...
        <div class="p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($brands->where('is_active', 1)->count() ?? 0); ?></div>
                </div>
                <div class="flex-shrink-0">
        ...
        <div class="p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($brands->where('is_featured', 1)->count() ?? 0); ?></div>
                </div>
                <div class="flex-shrink-0">
        ...
        <div class="p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($brands->sum('items_count') ?? 0); ?></div>
                </div>
                <div class="flex-shrink-0">
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
    <div class="p-4 md:p-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
            <div>
                ...
                <?php if(isset($brands)): ?>
                    <p class="text-xs md:text-sm text-gray-500 dark:text-gray-400"><?php echo e($brands->total()); ?> marque(s) trouvée(s)</p>
                <?php endif; ?>
            </div>
    ...
    <div class="p-0">
        <?php if(isset($brands) && $brands->count() > 0): ?>
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr data-brand-id="<?php echo e($brand->id); ?>" class="hover:bg-gray-50 dark:bg-gray-900 transition-colors <?php echo e(!$brand->is_active ? 'opacity-60' : ''); ?>">
                            <td class="px-6 py-4">
                                <div class="form-check">
                                    <input class="form-check-input brand-checkbox" type="checkbox" value="<?php echo e($brand->id); ?>">
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <?php else: ?>
                                        <div class="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-lg flex items-center justify-center border border-primary-300 shadow-sm">
                                            <span class="font-bold text-sm"><?php echo e(strtoupper(substr($brand->name, 0, 2))); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <div>
                                        <div class="font-semibold text-gray-900 dark:text-white"><?php echo e($brand->name); ?></div>
                                        <?php if($brand->slug): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($brand->slug); ?></div>
                                        <?php endif; ?>
                                        <?php if($brand->description): ?>
                                            <div class="text-xs text-gray-400 mt-0.5"><?php echo e(Str::limit($brand->description, 40)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col gap-1.5">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($brand->is_active ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 border border-gray-200 dark:border-gray-700'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full <?php echo e($brand->is_active ? 'bg-green-500' : 'bg-gray-500'); ?> mr-1.5"></span>
                            ...
                            <td class="px-6 py-4">
                                <?php if($brand->country): ?>
                                    <div class="flex items-center gap-2">
                                        <span class="fi fi-<?php echo e(strtolower($brand->country)); ?>"></span>
                                        <span class="text-sm text-gray-700 dark:text-gray-200"><?php echo e($brand->country); ?></span>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <strong class="text-primary-600 text-lg"><?php echo e($brand->items_count ?? 0); ?></strong>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 ml-1">articles</span>
                                </div>
                                <?php if($brand->items_count > 0): ?>
                                    <div class="text-xs text-gray-400 mt-1">
                                        Dernier: <?php echo e($brand->latest_item_date ? $brand->latest_item_date->format('d/m/Y') : 'N/A'); ?>

                                    </div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 dark:text-white"><?php echo e($brand->created_at->format('d/m/Y')); ?></div>
                                <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($brand->created_at->format('H:i')); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex gap-1 justify-end items-center">
                                    ...
                                    <div class="relative">
                                        <button class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-600 hover:bg-gray-50 dark:bg-gray-900 transition-colors" 
                                                type="button" 
                                                onclick="toggleActionDropdown(<?php echo e($brand->id); ?>)">
                                            <i class="fas fa-ellipsis-v"></i>
                                        </button>
                                        <div id="action-dropdown-<?php echo e($brand->id); ?>" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-20">
                                            <div class="py-1">
                                                <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" onclick="toggleBrandStatus(<?php echo e($brand->id); ?>)">
                                                    <i class="fas fa-<?php echo e($brand->is_active ? 'pause' : 'play'); ?> mr-2 text-<?php echo e($brand->is_active ? 'yellow' : 'green'); ?>-500"></i>
                                                    <?php echo e($brand->is_active ? 'Désactiver' : 'Activer'); ?>

                                                </button>
                                                <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" onclick="toggleBrandFeatured(<?php echo e($brand->id); ?>)">
                                                    <i class="fas fa-star mr-2 text-yellow-500"></i>
                                                    <?php echo e($brand->is_featured ? 'Retirer de la vedette' : 'Mettre en vedette'); ?>

                                                </button>
                                                <hr class="my-1 border-gray-200 dark:border-gray-600">
                                                <button class="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20" onclick="deleteBrand(<?php echo e($brand->id); ?>, '<?php echo e($brand->name); ?>')">
            ...
            <div class="lg:hidden">
                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-brand-id="<?php echo e($brand->id); ?>" class="border-b border-gray-200 p-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors <?php echo e(!$brand->is_active ? 'opacity-60' : ''); ?>">
                    <div class="flex gap-3">
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <?php else: ?>
                                <div class="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-lg flex items-center justify-center border border-primary-300 shadow-sm">
                                    <span class="font-bold"><?php echo e(strtoupper(substr($brand->name, 0, 2))); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex justify-between items-start mb-2">
                                <div class="flex-1 min-w-0">
                                    <h6 class="font-semibold text-gray-900 dark:text-white truncate"><?php echo e($brand->name); ?></h6>
                                    <?php if($brand->slug): ?>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($brand->slug); ?></p>
                                    <?php endif; ?>
                                </div>
                                
                                <!-- Menu dropdown actions mobile -->
                                <div class="relative">
                                    <button class="text-gray-400 hover:text-gray-600 dark:text-gray-300 p-1" onclick="toggleMobileDropdown(<?php echo e($brand->id); ?>)">
                                        <i class="fas fa-ellipsis-v"></i>
                                    </button>
                                    <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 hidden z-10" 
                                         id="mobile-dropdown-<?php echo e($brand->id); ?>">
                                        <div class="py-1">
                                            <a href="<?php echo e(route('admin.brands.show', $brand)); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                                                <i class="fas fa-eye w-4"></i> Voir
                                            </a>
                                            <a href="<?php echo e(route('admin.brands.edit', $brand)); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                                                <i class="fas fa-edit w-4"></i> Modifier
                                            </a>
                                            <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="toggleBrandStatus(<?php echo e($brand->id); ?>)">
                                                <i class="fas <?php echo e($brand->is_active ? 'fa-pause' : 'fa-play'); ?> w-4"></i>
                                                <?php echo e($brand->is_active ? 'Désactiver' : 'Activer'); ?>

                                            </button>
                                            <button class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800" onclick="toggleBrandFeatured(<?php echo e($brand->id); ?>)">
                                                <i class="fas fa-star w-4"></i>
                                                <?php echo e($brand->is_featured ? 'Retirer vedette' : 'Mettre en vedette'); ?>

                                            </button>
                                            <hr class="my-1">
                                            <button class="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50" onclick="deleteBrand(<?php echo e($brand->id); ?>, '<?php echo e($brand->name); ?>')">
                            ...
                            <!-- Description -->
                            <?php if($brand->description): ?>
                                <p class="text-xs text-gray-400 mb-2 line-clamp-2"><?php echo e($brand->description); ?></p>
                            <?php endif; ?>
                            
                            <!-- Badges et infos -->
                            <div class="flex flex-wrap gap-2 mb-2">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($brand->is_active ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 border border-gray-200 dark:border-gray-700'); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($brand->is_active ? 'bg-green-500' : 'bg-gray-500'); ?> mr-1"></span>
                                    <?php echo e($brand->is_active ? 'Active' : 'Inactive'); ?>
                                ...
                                <?php if($brand->country): ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">
                                        <span class="fi fi-<?php echo e(strtolower($brand->country)); ?> mr-1"></span>
                            ...
                            <div class="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                                <span>
                                    ...
                                    <?php echo e($brand->items_count ?? 0); ?> articles
                                </span>
                                <span>
                ...
                <div class="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-300 text-center sm:text-left">
                            Affichage de <span class="font-medium text-gray-900 dark:text-white"><?php echo e($brands->firstItem()); ?></span> à <span class="font-medium text-gray-900 dark:text-white"><?php echo e($brands->lastItem()); ?></span> 
                            sur <span class="font-medium text-gray-900 dark:text-white"><?php echo e($brands->total()); ?></span> résultats
                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-12">
                <?php if(request()->has('search') || request()->has('status') || request()->has('country')): ?>
                    ...
                    <a href="<?php echo e(route('admin.brands.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 dark:bg-gray-900 transition-colors">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('admin.brands.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/brands/index.blade.php ENDPATH**/ ?>