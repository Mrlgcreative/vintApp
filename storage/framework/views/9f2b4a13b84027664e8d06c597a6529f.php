...
<body class="bg-gray-100">
    ...
    <script>
        document.getElementById('payment-form').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo e(route("payments.simulate")); ?>', {
                    method: 'POST',
                    headers: {
...
</html><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/payments/test.blade.php ENDPATH**/ ?>