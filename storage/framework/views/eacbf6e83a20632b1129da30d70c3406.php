            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 sticky top-5">
                ...
                <div class="p-6">
                    ...
                    <div id="paymentButtonContainer" class="hidden mt-6">
                        ...
                        <form action="<?php echo e(route('payments.maishapay.checkout')); ?>" method="POST" id="maishapayForm" class="payment-gateway-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <button type="submit" 
                                ...
                                Payer <?php echo e(number_format($total, 2)); ?> <?php echo e($item['currency'] ?? 'CDF'); ?> avec MaishaPay
                            </button>
                        </form>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/checkout.blade.php ENDPATH**/ ?>