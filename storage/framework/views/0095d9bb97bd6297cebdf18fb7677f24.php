...
<article class="group relative bg-white rounded-3xl overflow-hidden border-2 <?php echo e($isBoosted ? 'border-purple-300 ring-2 ring-purple-100 shadow-lg shadow-purple-500/20' : 'border-gray-100 hover:border-purple-200'); ?> transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
    ...
    <div class="aspect-[3/4] relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
        ...
        <div class="absolute top-4 right-4">
            <span class="px-4 py-2 <?php echo e($isBoosted ? 'bg-gradient-to-r from-purple-600 to-purple-700 shadow-lg shadow-purple-500/50 animate-pulse' : 'bg-gray-900'); ?> text-white rounded-full text-sm font-bold shadow-lg">
    ...
    <!-- Contenu -->
    <div class="p-5 lg:p-6 <?php echo e($isBoosted ? 'bg-gradient-to-b from-white to-purple-50/30' : ''); ?>">
        <div class="space-y-3">
            <h3 class="font-bold text-base lg:text-lg <?php echo e($isBoosted ? 'text-purple-900' : 'text-gray-900'); ?> line-clamp-2 min-h-[3rem] leading-tight">
                <?php echo e($item->name); ?>

            </h3>
            
            <div class="flex items-center justify-between">
                <span class="px-3 py-1 bg-gradient-to-r <?php echo e($isBoosted ? 'from-purple-100 to-purple-200 text-purple-800' : 'from-purple-100 to-pink-100 text-purple-700'); ?> rounded-full text-xs font-semibold">
                    <?php echo e($item->category->name ?? 'Vintage'); ?>
...
<?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/components/home/product-card.blade.php ENDPATH**/ ?>