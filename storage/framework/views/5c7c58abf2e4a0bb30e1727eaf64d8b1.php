...
<?php $__env->startSection('title', 'Candidats Experts'); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($candidates->total()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($candidates->where('email_verified_at', '!=', null)->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($candidates->where('last_activity', '>', now()->subDays(30))->count()); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('admin.experts.candidates')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="min_orders" name="min_orders" 
                               value="<?php echo e(request('min_orders', 0)); ?>" 
                               min="0"
                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        ...
                        <select id="verified_only" name="verified_only" 
                            ...
                            <option value="1" <?php echo e(request('verified_only') == '1' ? 'selected' : ''); ?>>Vérifiés seulement</option>
                        </select>
                    </div>
                    <div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                Candidats Éligibles (<?php echo e($candidates->total()); ?>)
            </h3>
        </div>
        <div class="p-6">
            <?php if($candidates->count() > 0): ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-gray-100 hover:bg-gray-50 dark:bg-gray-900">
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 flex-shrink-0">
                                                <?php if($candidate->avatar): ?>
                                                    <?php if(str_starts_with($candidate->avatar, 'http://') || str_starts_with($candidate->avatar, 'https://')): ?>
                                                        <img src="<?php echo e($candidate->avatar); ?>" 
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e($candidate->avatar_url); ?>" 
                                                             class="w-10 h-10 rounded-full object-cover" 
                                                             alt="<?php echo e($candidate->name); ?>"
                                                             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                                        <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center" style="display: none;">
                                            ...
                                            <div>
                                                <div class="font-semibold text-gray-900 dark:text-white"><?php echo e($candidate->name); ?></div>
                                                <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($candidate->email); ?></div>
                                                <?php if($candidate->phone): ?>
                                                    <div class="text-xs text-gray-400"><?php echo e($candidate->phone); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-4 px-4 text-center">
                                        <div class="font-bold text-gray-900 dark:text-white"><?php echo e($candidate->orders_count ?? 0); ?></div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">commandes</div>
                                    </td>
                                    <td class="py-4 px-4 text-center">
                                        <?php if(isset($candidate->satisfaction_rate) && $candidate->satisfaction_rate > 0): ?>
                                            <div class="font-bold text-green-600"><?php echo e(number_format($candidate->satisfaction_rate, 1)); ?>%</div>
                                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1 mt-1">
                                                <div class="bg-green-600 h-1 rounded-full" 
                                                     style="width: <?php echo e($candidate->satisfaction_rate); ?>%"></div>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="py-4 px-4 text-center">
                                        <?php if($candidate->last_activity): ?>
                                            <div class="text-sm text-gray-900 dark:text-white">
                                                <?php echo e($candidate->last_activity->diffForHumans()); ?>
                                    ...
                                    <td class="py-4 px-4 text-center">
                                        <div class="flex flex-col items-center gap-1">
                                            ...
                                            <?php if($candidate->created_at > now()->subDays(30)): ?>
                                    ...
                                    <td class="py-4 px-4 text-center">
                                        <button type="button" 
                                                ...
                                                onclick="designateExpert(<?php echo e($candidate->id); ?>, '<?php echo e($candidate->name); ?>')">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
                    <div class="text-sm text-gray-600 dark:text-gray-300">
                        Affichage de <?php echo e($candidates->firstItem() ?? 0); ?> à <?php echo e($candidates->lastItem() ?? 0); ?> 
                        sur <?php echo e($candidates->total()); ?> candidats
                    </div>
                    <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <label class="flex items-center category-checkbox">
                            <input type="checkbox" name="specialties[]" value="<?php echo e($category->slug); ?>" class="mr-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/experts/candidates.blade.php ENDPATH**/ ?>