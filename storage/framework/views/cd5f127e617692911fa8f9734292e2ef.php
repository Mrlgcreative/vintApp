...
<div class="flex flex-wrap gap-2">
    <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 text-center">
                ...
                <h4 class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($user->name); ?></h4>
                <p class="text-gray-500 mb-4"><?php echo e($user->email); ?></p>
