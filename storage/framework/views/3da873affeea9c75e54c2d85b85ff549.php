            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-violet-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500">Actifs : <?php echo e($stats['active_items'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-emerald-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['total_sales'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-cyan-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['unread_messages'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-amber-600/10 border border-gray-100/50 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['pending_support_chats'] ?? 0); ?></p>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_support_chats'] ?? 0); ?></div>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $recentItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center p-4 bg-gray-50 rounded-xl hover:bg-violet-50 transition-colors duration-200">
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1"><?php echo e($item->name); ?></h6>
                                        <p class="text-sm text-gray-500"><?php echo e($item->category->name ?? 'N/A'); ?></p>
                                    </div>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center p-4 bg-gray-50 rounded-xl hover:bg-emerald-50 transition-colors duration-200">
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1">Commande #<?php echo e($order->id); ?></h6>
                                        <p class="text-sm text-gray-500"><?php echo e($order->item->name ?? 'N/A'); ?></p>
                                    </div>
                            ...
                            <?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-4 bg-gray-50 rounded-xl hover:bg-cyan-50 transition-colors duration-200">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <h6 class="font-semibold text-gray-900 mb-1"><?php echo e($msg->sender->name ?? 'N/A'); ?></h6>
                                            <p class="text-gray-600 text-sm leading-relaxed"><?php echo e(Str::limit($msg->content, 50)); ?></p>
                                        </div>
                                        <p class="text-gray-500 text-xs ml-3 whitespace-nowrap"><?php echo e($msg->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-4 bg-gray-50 rounded-xl hover:bg-amber-50 transition-colors duration-200">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <h6 class="font-semibold text-gray-900 mb-1"><?php echo e($notif->title); ?></h6>
                                            <p class="text-gray-600 text-sm leading-relaxed"><?php echo e(Str::limit($notif->message, 50)); ?></p>
                                        </div>
                                        <p class="text-gray-500 text-xs ml-3 whitespace-nowrap"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
