    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-8 py-12 text-center">
                        ...
                        <?php if(isset($transaction->currency)): ?>
                            <?php if($transaction->currency === 'USD'): ?>
                                <div class="text-gray-500 text-sm">
                                    Environ <?php echo e(number_format($transaction->amount * 2650, 0)); ?> CDF
                                </div>
                            <?php elseif($transaction->currency === 'CDF'): ?>
                                <div class="text-gray-500 text-sm">
                                    Environ <?php echo e(number_format($transaction->amount / 2650, 2)); ?> USD
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="text-gray-500 text-sm">
                                <?php echo e(number_format($transaction->amount * 2650, 0)); ?> CDF
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 mb-8 text-left">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                ...
                                <span class="font-medium text-purple-600"><?php echo e($transaction->transaction_id); ?></span>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                ...
                                <span class="font-medium flex items-center">
                                    ...
                                    <?php echo e(ucfirst(str_replace('_', ' ', $transaction->provider))); ?>
                            ...
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                ...
                                <span class="font-medium"><?php echo e($transaction->phone); ?></span>
                            </div>
                            <?php endif; ?>
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                <span class="text-gray-600">Date</span>
                                <span class="font-medium"><?php echo e($transaction->created_at->format('d/m/Y à H:i')); ?></span>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                <span class="text-gray-600">Objet</span>
                                <span class="font-medium"><?php echo e($transaction->purpose); ?></span>
                            </div>
                ...
                <!-- Boutons d'action -->
                <div class="space-y-3">
                    <a href="<?php echo e(route('dashboard')); ?>" class="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-purple-600 hover:bg-purple-700 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(isset($unratedOrders) && $unratedOrders->count() > 0): ?>
                        <button id="openRatingModal" class="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 transition-all duration-200 transform hover:scale-105">
                            ...
                            Notez vos vendeurs (<?php echo e($unratedOrders->count()); ?>)
                        </button>
                    <?php endif; ?>
                </div>
...
<div id="ratingModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-screen overflow-y-auto transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
        ...
        <div class="p-6 space-y-6" id="ratingsContainer">
            <?php $__currentLoopData = $unratedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200" data-order-id="<?php echo e($order->id); ?>">
                    <div class="flex items-start space-x-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($order->item ? $order->item->name : 'Article'); ?></h4>
                            <p class="text-gray-600 text-sm mb-2">Vendeur: <?php echo e($order->seller ? $order->seller->name : 'Vendeur'); ?></p>
                            <p class="text-purple-600 font-medium"><?php echo e(number_format($order->total_amount, 2)); ?> <?php echo e($order->currency); ?></p>
                        </div>
                    </div>

                    <form class="rating-form" data-order-id="<?php echo e($order->id); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-1" data-rating="0">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" class="star text-3xl text-gray-300 hover:text-yellow-400 transition-colors duration-150" data-value="<?php echo e($i); ?>">
                                        ★
                                    </button>
                                <?php endfor; ?>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.rating-form').forEach(form => {
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo e(route("reviews.post-payment")); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/payments/success.blade.php ENDPATH**/ ?>