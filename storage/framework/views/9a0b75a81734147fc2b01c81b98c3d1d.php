                    ...
                    <?php if(isset($transaction)): ?>
                        ...
                        <div class="transaction-details bg-light rounded-3 p-4 mb-4 text-start">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value text-primary"><?php echo e($transaction->transaction_id); ?></span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Opérateur</span>
                                <span class="detail-value">
                                    <i class="fas fa-mobile-alt me-1"></i><?php echo e($transaction->provider); ?>
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value">
                                    <i class="far fa-calendar me-1"></i><?php echo e($transaction->created_at->format('d/m/Y à H:i')); ?>

                                </span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Objet</span>
                                <span class="detail-value"><?php echo e($transaction->purpose); ?></span>
                            </div>
