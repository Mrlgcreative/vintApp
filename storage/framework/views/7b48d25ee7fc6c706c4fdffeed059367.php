            ...
            <div class="bg-gradient-to-r from-primary-600 to-primary-700 px-5 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-white/80 hover:text-white p-1.5 rounded-full hover:bg-white/10 transition-colors">
                            <i class="fas fa-arrow-left text-lg"></i>
                        </a>
                        <h1 class="text-lg font-bold text-white">Conversations</h1>
                    </div>
                    <div class="flex items-center gap-1">
                        <a href="<?php echo e(route('items.index')); ?>" class="flex items-center gap-2 px-3 py-1.5 bg-white/15 text-white text-sm rounded-xl hover:bg-white/25 transition-colors">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700/50 max-h-[600px] overflow-y-auto" id="conversationsList">
                    <?php $__currentLoopData = $vendorContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('messages.show', ['user' => $contact->vendor_id, 'item_id' => $contact->item_id])); ?>"
                           class="flex items-center gap-3 px-5 py-3.5 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group <?php if($contact->unread_count > 0): ?> bg-primary-50/50 dark:bg-primary-900/10 <?php endif; ?>"
                           data-name="<?php echo e(strtolower($contact->vendor->name)); ?> <?php echo e($contact->item ? strtolower($contact->item->name) : ''); ?>">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-0.5">
                                    <h3 class="font-semibold <?php echo e($contact->unread_count > 0 ? 'text-gray-900 dark:text-white' : 'text-gray-800 dark:text-gray-200'); ?> truncate">
                                        <?php echo e($contact->vendor->name); ?>

                                    </h3>
                                    <span class="text-xs <?php echo e($contact->unread_count > 0 ? 'text-gray-600 dark:text-gray-400 font-medium' : 'text-gray-400 dark:text-gray-500'); ?> flex-shrink-0 ml-2">
                                ...
                                <div class="flex items-center justify-between gap-2">
                                    <p class="text-sm <?php echo e($contact->unread_count > 0 ? 'text-gray-700 dark:text-gray-300 font-medium' : 'text-gray-500 dark:text-gray-400'); ?> truncate flex-1">
                                ...
                                <?php if($contact->item): ?>
                                    <div class="flex items-center gap-1.5 mt-1">
                                        <span class="text-xs text-blue-600 dark:text-blue-400 font-medium truncate"><?php echo e($contact->item->name); ?></span>
                                        <span class="text-xs text-blue-600 dark:text-blue-400 font-bold"><?php echo e($contact->item->formatted_price); ?></span>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/messages/index.blade.php ENDPATH**/ ?>