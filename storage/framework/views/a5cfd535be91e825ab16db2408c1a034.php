    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="max-w-4xl w-full">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden card-hover">
                ...
                <div class="px-6 py-8 sm:px-12 sm:py-12 space-y-8">
                    ...
                    <div class="bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-6 sm:p-8">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6 flex items-center justify-center sm:justify-start">
                            <i class="fas fa-info-circle text-primary-600 mr-3"></i>
                            Pourquoi cette restriction ?
                        </h2>
                        
                        <div class="space-y-5">
                            <div class="flex items-start space-x-4 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1 text-base sm:text-lg">Qualité de service garantie</h3>
                            ...
                            <div class="flex items-start space-x-4 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1 text-base sm:text-lg">Logistique de livraison</h3>
                                    <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                            ...
                            <div class="flex items-start space-x-4 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1 text-base sm:text-lg">Tests et optimisations</h3>
                                    <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                    ...
                    <?php if($allowedCities->isNotEmpty()): ?>
                    <!-- Villes disponibles -->
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 sm:p-8">
                        ...
                        <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                            <?php $__currentLoopData = $allowedCities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="city-pill bg-white dark:bg-gray-800 rounded-xl px-4 py-3 shadow-sm hover:shadow-md flex items-center space-x-2 cursor-pointer">
                                <i class="fas fa-map-pin text-indigo-500 text-sm"></i>
                                <span class="text-gray-800 dark:text-gray-100 font-medium text-sm truncate"><?php echo e($city); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>

                        <?php if($allowedCities->count() >= 12): ?>
                    ...
                    <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 sm:p-8">
                        <div class="text-center mb-6">
                            ...
                            <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-3">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center items-stretch sm:items-center max-w-2xl mx-auto">
                            ...
                            <a href="mailto:support@vintapp.com" 
                               class="bg-white dark:bg-gray-800 border-2 border-gray-300 text-gray-700 dark:text-gray-200 hover:border-primary-500 hover:text-primary-600 px-6 sm:px-8 py-4 rounded-xl font-semibold text-base sm:text-lg inline-flex items-center justify-center space-x-2 transition-all flex-1 sm:flex-initial">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
                        <div class="text-center space-y-5">
                            <p class="text-gray-700 dark:text-gray-200 font-semibold text-base sm:text-lg">
            ...
            <div class="text-center mt-6">
                <div class="inline-flex items-center space-x-2 bg-white dark:bg-gray-800/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                    <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span class="text-sm font-semibold text-gray-700 dark:text-gray-200">Expansion en cours dans toute la RDC</span>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/errors/city_restricted.blade.php ENDPATH**/ ?>