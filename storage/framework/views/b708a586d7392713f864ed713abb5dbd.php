<?php $__env->startSection('title', 'Conversation avec ' . $otherUser->name); ?>
...
<div class="fixed inset-0 bg-gray-50 dark:bg-gray-900 flex flex-col overflow-hidden z-50 pb-16 md:pb-0" style="background-image: repeating-linear-gradient(45deg, transparent, transparent 1px, rgba(0,0,0,0.02) 1px, rgba(0,0,0,0.02) 10px);">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg">
        <div class="flex items-center px-4 py-3 gap-3">
            <a href="<?php echo e(route('messages.index')); ?>" class="text-white hover:bg-white/10 p-2 rounded-full transition-all duration-200">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div class="flex items-center flex-1 gap-3 cursor-pointer">
                <div class="relative">
                    <?php if($otherUser->avatar_url): ?>
                        <img src="<?php echo e($otherUser->avatar_url); ?>" 
                ...
                <div class="flex-1">
                    <h6 class="font-semibold text-white"><?php echo e($otherUser->name); ?></h6>
        ...
        <div class="bg-yellow-50 dark:bg-yellow-900/20 border-b border-yellow-200 dark:border-yellow-800/50 px-4 py-3">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <span class="font-semibold text-gray-900 dark:text-white block truncate"><?php echo e($item->name); ?></span>
                    <span class="text-primary-600 dark:text-primary-400 font-bold text-lg"><?php echo e($item->formatted_price); ?></span>
                </div>
                <a href="<?php echo e(route('items.show', $item)); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 p-2.5 rounded-full hover:bg-yellow-100 dark:hover:bg-yellow-800/30 transition-colors">
                ...
                <div class="px-4 pb-4 hidden" id="discountContent">
                    <div class="border-t border-green-200 dark:border-green-800/50 pt-4">
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-3 mb-4 border border-gray-200 dark:border-gray-700 flex justify-between items-center">
                            ...
                            <span class="text-primary-600 font-bold text-lg"><?php echo e($item->formatted_price); ?></span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4">
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="5">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.95, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.05, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="10">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.90, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.10, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="15">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.85, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.15, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="20">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.80, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.20, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="25">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.75, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.25, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center cursor-pointer hover:border-primary-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="30">
                                ...
                                <div class="text-green-600 font-semibold"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.70, 2)); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.30, 2)); ?></div>
                            </div>
                        </div>
        ...
        <div class="max-w-4xl mx-auto space-y-1">
            <?php if($messages->count() > 0): ?>
                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-1.5 flex <?php echo e($message->sender_id === Auth::id() ? 'justify-end' : 'justify-start'); ?>">
                        <div class="max-w-xs lg:max-w-md xl:max-w-lg min-w-0 relative <?php echo e($message->sender_id === Auth::id() ? 'bg-primary-500/10 dark:bg-primary-500/20' : 'bg-white dark:bg-gray-800'); ?> rounded-2xl <?php echo e($message->sender_id === Auth::id() ? 'rounded-br-sm' : 'rounded-bl-sm'); ?> px-3.5 py-2.5 shadow-sm hover:shadow-md transition-shadow animate-fade-in">
                            ...
                            <?php if($message->type === 'audio' && $message->attachment): ?>
                                <div class="my-1 voice-msg" data-src="<?php echo e(Storage::url($message->attachment)); ?>" data-duration="<?php echo e($message->duration ?? 0); ?>">
                                    <div class="flex items-center gap-2 min-w-48">
                                        ...
                                        <span class="voice-time text-xs text-gray-500 dark:text-gray-400 tabular-nums flex-shrink-0"><?php echo e(gmdate('i:s', intval($message->duration ?? 0))); ?></span>
                            ...
                            <?php elseif($message->attachment): ?>
                                <div class="my-2">
                                    <?php if(Str::startsWith($message->attachment, 'items/') || in_array(pathinfo($message->attachment, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                        <img src="<?php echo e(Storage::url($message->attachment)); ?>" 
                                             alt="Image jointe" 
                                             class="max-w-48 max-h-48 rounded-xl cursor-pointer hover:scale-[1.02] transition-transform shadow-sm"
                                             onclick="showImageModal('<?php echo e(Storage::url($message->attachment)); ?>')">
                                    <?php else: ?>
            ...
            <?php else: ?>
                <div class="text-center py-20 text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-sm mt-1 text-gray-400">Envoyez un message à <?php echo e($otherUser->name); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-700 p-3 pb-20 md:pb-3 fixed md:relative bottom-0 left-0 right-0 z-40">
        <form id="messageForm" method="POST" action="<?php echo e(route('messages.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyDiscountBtn) {
        applyDiscountBtn.addEventListener('click', function() {
            ...
            formData.append('item_id', '<?php echo e($item ? $item->id : ''); ?>');
            formData.append('buyer_id', '<?php echo e($otherUser->id); ?>');
            formData.append('discount_percentage', selectedRate);
            formData.append('expires_hours', 24);
            formData.append('_token', document.querySelector('meta[name="csrf-token"]').getAttribute('content'));
            
            fetch('<?php echo e(route('discounts.apply-message')); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
    ...
    const otherUserId = <?php echo e($otherUser->id); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/messages/show.blade.php ENDPATH**/ ?>