    ...
    <?php if($vendorContacts->count() > 0): ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="bg-gray-50 rounded-t-xl p-4 flex items-center">
                        ...
                        <div class="flex-1 min-w-0">
                            <h6 class="font-semibold text-gray-900 truncate"><?php echo e($contact->vendor->name); ?></h6>
                    ...
                    <div class="p-4">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <?php if($contact->item): ?>
                                    <h6 class="font-semibold text-gray-900 mb-1 truncate"><?php echo e($contact->item->name); ?></h6>
                                    ...
                                    <p class="text-sm text-gray-500"><?php echo e($contact->item->category->name); ?></p>
                                <?php else: ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div class="bg-gray-50 rounded-xl p-6 text-center hover:bg-gray-100 transition-all duration-300 hover:-translate-y-1">
                ...
                <h5 class="text-2xl font-bold text-gray-900"><?php echo e($vendorContacts->count()); ?></h5>
                <p class="text-sm text-gray-600">Vendeurs contactés</p>
            </div>
            <div class="bg-gray-50 rounded-xl p-6 text-center hover:bg-gray-100 transition-all duration-300 hover:-translate-y-1">
                <i class="fas fa-tag text-4xl text-green-600 mb-3"></i>
                <h5 class="text-2xl font-bold text-gray-900"><?php echo e($vendorContacts->where('has_discount', true)->count()); ?></h5>
                <p class="text-sm text-gray-600">Réductions obtenues</p>
            </div>
            <div class="bg-gray-50 rounded-xl p-6 text-center hover:bg-gray-100 transition-all duration-300 hover:-translate-y-1">
                <i class="fas fa-envelope text-4xl text-yellow-600 mb-3"></i>
                <h5 class="text-2xl font-bold text-gray-900"><?php echo e($vendorContacts->sum('unread_count')); ?></h5>
