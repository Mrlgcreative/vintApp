                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden">
                                        ...
                                        <?php elseif($category->icon): ?>
                                            <i class="<?php echo e($category->icon); ?> text-purple-500 text-xl"></i>
                                        <?php else: ?>
                        ...
                        <div class="flex items-start space-x-4">
                                ...
                                <div class="w-16 h-16 bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden">
                                    <?php if($category->image && Storage::disk('public')->exists($category->image)): ?>
                                        <img src="<?php echo e(Storage::url($category->image)); ?>" 
                                             ...
                                             class="w-full h-full object-cover">
                                    <?php elseif($category->icon): ?>
                                        <i class="<?php echo e($category->icon); ?> text-purple-500 text-2xl"></i>
                                    <?php else: ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($category->name); ?></h3>
                                        <?php if($category->description): ?>
                                            <p class="text-gray-600 text-sm mb-2"><?php echo e(Str::limit($category->description, 80)); ?></p>
                                        <?php endif; ?>
