...
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if($isSeller): ?>
                                    <a href="<?php echo e(route('seller.dashboard')); ?>" class="relative flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('seller.*') ? 'text-white bg-white/15' : 'text-white/75 hover:text-white hover:bg-white/10'); ?>">
                                        ...
                                        Espace vendeur
                                        <?php if(request()->routeIs('seller.*')): ?><span class="absolute bottom-0 left-3 right-3 h-0.5 bg-white rounded-full"></span><?php endif; ?>
                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <?php if(auth()->user()->isSeller()): ?>
                                            <a href="<?php echo e(route('seller.dashboard')); ?>" class="flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
        ...
        <div class="relative grid grid-cols-5 h-16 max-w-lg mx-auto px-2 safe-area-bottom">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php
                    ...
                    if ($isSeller) {
                        array_splice($authMobileNav, 0, 0, [[
                            ...
                            'iconSimple' => 'M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z',
                        ]]);
                    }
                ?>
...
<?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/app.blade.php ENDPATH**/ ?>