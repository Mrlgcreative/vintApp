            ...
            <div class="card shadow-sm border-0 sticky-top" style="top: 20px;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span class="fw-semibold"><?php echo e(number_format($subtotal, 2)); ?> <?php echo e($item['currency'] ?? ''); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>
                            Frais de livraison :
                        ...
                        <span class="text-primary fw-semibold">+<?php echo e(number_format($transportFee, 2)); ?> <?php echo e($item['currency'] ?? ''); ?></span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between mb-3">
                        <span class="h5 mb-0">Total :</span>
                        <span class="h5 mb-0 text-primary fw-bold"><?php echo e(number_format($total, 2)); ?> <?php echo e($item['currency'] ?? ''); ?></span>
                    </div>
                    ...
                    <div id="paymentButtonContainer" style="display: none;">
                        ...
                        <a href="<?php echo e(route('cart.pay')); ?>" class="btn btn-success btn-lg w-100" id="paymentButton">
