                ...
                <div class="p-6">
                        ...
                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="font-semibold text-gray-900 truncate"><?php echo e($item['name']); ?></div>
                                    <div class="text-sm text-gray-500">Qté: <?php echo e($item['quantity']); ?></div>
                                </div>
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <span class="font-semibold text-gray-900"><?php echo e(number_format($subtotal, 2)); ?> <?php echo e($item['currency'] ?? ''); ?></span>
                        </div>
                        <div class="flex justify-between items-center mb-3">
                    ...
                    <div id="paymentButtonContainer" class="hidden mt-6">
                        ...
                        <a href="<?php echo e(route('cart.pay')); ?>" 
