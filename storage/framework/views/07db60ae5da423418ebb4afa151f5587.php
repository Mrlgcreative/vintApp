                                ...
                                <div class="flex gap-1 justify-end items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0">
                                            <li>
                                                <button class="dropdown-item" onclick="toggleBrandStatus(<?php echo e($brand->id); ?>)">
                                                    <i class="fas fa-<?php echo e($brand->is_active ? 'pause' : 'play'); ?> me-2 text-<?php echo e($brand->is_active ? 'warning' : 'success'); ?>"></i>
                                                    <?php echo e($brand->is_active ? 'Désactiver' : 'Activer'); ?>

                                                </button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item" onclick="toggleBrandFeatured(<?php echo e($brand->id); ?>)">
                                            ...
                                            <li>
                                                <button class="dropdown-item text-danger" onclick="deleteBrand(<?php echo e($brand->id); ?>, '<?php echo e($brand->name); ?>')">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/brands/index.blade.php ENDPATH**/ ?>