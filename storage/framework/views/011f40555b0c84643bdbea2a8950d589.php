...
<?php $__env->startSection('title', 'Conditions d\'Utilisation - VintApp'); ?>
<?php $__env->startSection('meta_description', 'Conditions générales d\'utilisation de VintApp - Règles et conditions pour utiliser notre marketplace de vente d\'articles d\'occasion'); ?>
<?php $__env->startSection('meta_keywords', 'CGU, conditions, utilisation, règles, VintApp, marketplace, légal'); ?>
...
<div class="container-fluid">
    ...
    <div class="terms-header bg-gradient-primary text-white py-5 mb-4">
        <div class="container text-center">
            ...
            <p class="lead mb-3">Dernière mise à jour : <?php echo e(date('d/m/Y')); ?></p>
                ...
                <div class="card border-success mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-0 text-center">
                            ...
                            <small class="text-muted">Dernière mise à jour : <?php echo e(date('d/m/Y')); ?></small>
                        </p>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/legal/terms.blade.php ENDPATH**/ ?>