    ...
    <div class="row g-4">
            ...
            <?php if($item->images && count($item->images) > 0): ?>
                <div class="d-flex flex-column align-items-center gap-2">
                    <?php $__currentLoopData = $item->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img src="<?php echo e(Storage::url($image)); ?>" class="img-thumbnail alibaba-thumb <?php echo e($index === 0 ? 'active' : ''); ?>" alt="Miniature <?php echo e($index + 1); ?>" data-index="<?php echo e($index); ?>" style="width: 60px; height: 60px; object-fit: cover; cursor:pointer;">
        ...
        <div class="col-lg-5">
            <div class="card p-2 alibaba-main-img-card">
                <?php if($item->images && count($item->images) > 0): ?>
                    <img id="mainProductImg" src="<?php echo e(Storage::url($item->images[0])); ?>" class="w-100 alibaba-main-img" alt="<?php echo e($item->name); ?>" style="height: 420px; object-fit: contain; border-radius: 18px;">
                <?php else: ?>
        ...
        <div class="col-lg-6">
            <div class="card p-4 shadow-lg alibaba-product-card">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div>
                        <h1 class="h3 mb-1 fw-bold"><?php echo e($item->name); ?></h1>
                        <div class="mb-2">
                            <span class="badge bg-primary me-2"><?php echo e($item->category->name); ?></span>
                            <?php if($item->brand): ?>
                                <span class="badge bg-secondary me-2"><?php echo e($item->brand->name); ?></span>
                            <?php endif; ?>
                            <span class="badge condition-badge condition-<?php echo e($item->condition); ?> ms-2">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <button class="btn btn-outline-danger favorite-btn" data-item-id="<?php echo e($item->id); ?>">
                            <i class="fas fa-heart"></i>
                        </button>
                    <?php endif; ?>
                </div>
                <div class="mb-3">
                    <span class="alibaba-price"><?php echo e($item->formatted_price); ?></span>
                    <span class="text-muted ms-2"><?php if($item->quantity > 0): ?> En stock <?php else: ?> <span class="text-danger">Rupture</span> <?php endif; ?></span>
                </div>
                <div class="mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div>
                            <small class="text-muted">Vues</small>
                            <div class="fw-bold"><?php echo e($item->views); ?></div>
                        </div>
                        <div>
                            <small class="text-muted">Quantité</small>
                            <div class="fw-bold"><?php echo e($item->quantity); ?></div>
                        </div>
                        <div>
                            <small class="text-muted">Publié</small>
                            <div class="fw-bold"><?php echo e($item->created_at->format('d/m/Y')); ?></div>
                        </div>
                    </div>
                </div>
                <div class="mb-4">
                    <form method="POST" action="<?php echo e(route('cart.add', $item->id)); ?>" class="d-inline-block me-2" id="addToCartForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <ul class="list-group list-group-flush">
                            <?php $__currentLoopData = $item->specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item bg-transparent px-0 py-1 border-0">
                                    <strong><?php echo e(is_string($key) ? ucfirst($key) : ''); ?>:</strong> 
                                    <?php echo e(is_string($value) ? $value : (is_array($value) ? json_encode($value) : '')); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Membre depuis <?php echo e($item->user->created_at->format('M Y')); ?></small>
                        </div>
                    </div>
                </div>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php else: ?>
                            <div class="btn-group w-100">
                                <a href="<?php echo e(route('items.edit', $item)); ?>" class="btn btn-warning">
                    ...
                    <?php $__currentLoopData = $similarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similarItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 item-card similar-item-card">
                                ...
                                <?php endif; ?>
                                <div class="card-body">
                                    <h6 class="card-title"><?php echo e(Str::limit($similarItem->name, 40)); ?></h6>
                                    <p class="text-primary fw-bold"><?php echo e($similarItem->formatted_price); ?></p>
                                    <a href="<?php echo e(route('items.show', $similarItem)); ?>" class="btn btn-sm btn-outline-primary">
                                        Voir détails
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="text-muted small"><?php echo e(Str::limit($item->description, 100)); ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-primary fw-bold fs-5"><?php echo e($item->formatted_price); ?></span>
                                    <span class="badge bg-info"><?php echo e($item->category->name); ?></span>
                                </div>
                            </div>
                        </div>
                ...
                if (data.success) {
                    ...
                    if (priceElement) {
                        ...
                        priceElement.innerHTML = `
                            <span class="text-decoration-line-through text-muted me-2"><?php echo e($item->formatted_price); ?></span>
...
function submitDiscountRequest() {
    ...
    form.method = 'POST';
    form.action = '<?php echo e(route("contact.seller", $item)); ?>';
...
function contactSeller() {
    const sellerId = <?php echo e($item->user_id); ?>;
    window.location.href = `/messages/${sellerId}?item_id=<?php echo e($item->id); ?>`;
}
