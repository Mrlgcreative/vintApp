                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($stats['total_revenue']); ?>€</div>
                            ...
                            <div class="text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl">
                                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400"><?php echo e(number_format($stats['average_rating'], 1)); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div x-show="activeTab === 'preferences'" x-cloak>
                            ...
                            <form method="POST" action="<?php echo e(route('profile.theme')); ?>" class="space-y-6">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <label class="relative cursor-pointer">
                                            <input type="radio" 
                                                   ...
                                                   value="auto" 
                                                   <?php echo e($user->theme_preference === 'auto' ? 'checked' : ''); ?>
                                        ...
                                        <label class="relative cursor-pointer">
                                            <input type="radio" 
                                                   name="theme_preference" 
                                                   value="light" 
                                                   <?php echo e($user->theme_preference === 'light' ? 'checked' : ''); ?>
                                        ...
                                        <label class="relative cursor-pointer">
                                            <input type="radio" 
                                                   name="theme_preference" 
                                                   value="dark" 
                                                   <?php echo e($user->theme_preference === 'dark' ? 'checked' : ''); ?>
                        ...
                        <div x-show="activeTab === 'notifications'" x-cloak>
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $user->notifications()->latest()->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="bg-white dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 hover:border-primary-300 dark:hover:border-primary-600 transition-all <?php echo e(!$notification->read_at ? 'ring-2 ring-primary-100 dark:ring-primary-900' : ''); ?>">
                                        <div class="flex items-start justify-between gap-4">
                                            <div class="flex-1">
                                                <div class="flex items-center gap-2 mb-1">
                                                    <h4 class="font-semibold text-gray-900 dark:text-white"><?php echo e($notification->title); ?></h4>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/profile/edit.blade.php ENDPATH**/ ?>