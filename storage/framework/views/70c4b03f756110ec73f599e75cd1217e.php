    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('admin.refunds.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-blue-600">Demande #<?php echo e($refund->id); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6">
                        <div class="flex items-center justify-between">
                            <h1 class="text-2xl font-bold">Demande de remboursement #<?php echo e($refund->id); ?></h1>
                            <?php
                                $statusClasses = [
                            ...
                            ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border <?php echo e($statusClasses[$refund->status] ?? 'bg-gray-100 text-gray-800 border-gray-200'); ?>">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">Demandé le</h3>
                                <p class="text-lg text-gray-900"><?php echo e($refund->created_at->format('d/m/Y à H:i')); ?></p>
                            </div>
                            <div>
                                <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">Type</h3>
                                <p class="text-lg text-gray-900"><?php echo e($refund->refund_type === 'full' ? 'Remboursement complet' : 'Remboursement partiel'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <div class="text-xl font-bold text-gray-900"><?php echo e($refund->currency === 'USD' ? '$' : 'FC'); ?> <?php echo e(number_format($refund->original_amount, 2)); ?></div>
                                </div>
                                <div>
                                    <span class="text-sm text-gray-500">Remboursement demandé</span>
                                    <div class="text-xl font-bold text-blue-600"><?php echo e($refund->formatted_refund_amount); ?></div>
                                </div>
                                <?php if($refund->status === 'negotiation' && $refund->counter_offer_amount): ?>
                                    <div>
                                        <span class="text-sm text-gray-500">Contre-offre</span>
                                        <div class="text-xl font-bold text-orange-600"><?php echo e($refund->currency === 'USD' ? '$' : 'FC'); ?> <?php echo e(number_format($refund->counter_offer_amount, 2)); ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <!-- Raison -->
                        <div class="mb-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">Raison de la demande</h3>
                            <div class="bg-gray-50 rounded-xl p-4">
                                <p class="text-gray-700 leading-relaxed"><?php echo e($refund->reason); ?></p>
                            </div>
                        </div>

                        <!-- Photos de preuves -->
                        <?php if($refund->evidence_photos && is_array($refund->evidence_photos) && count($refund->evidence_photos) > 0): ?>
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Photos de preuves</h3>
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <?php $__currentLoopData = $refund->evidence_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($refund->admin_notes): ?>
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Notes administratives</h3>
                                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                    <p class="text-blue-900"><?php echo e($refund->admin_notes); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                        <h3 class="text-lg font-semibold text-gray-900">Commande associée</h3>
                    </div>
                    <div class="p-6">
                        <div class="flex items-start space-x-4">
                            <?php if(!empty($refund->order->item->images) && is_array($refund->order->item->images) && count($refund->order->item->images) > 0): ?>
                                <img src="<?php echo e(asset('storage/' . $refund->order->item->images[0])); ?>" 
                                     alt="<?php echo e($refund->order->item->name); ?>" 
                            ...
                            <div class="flex-1">
                                <h4 class="text-lg font-semibold text-gray-900 mb-2"><?php echo e($refund->order->item->name); ?></h4>
                                <div class="text-sm text-gray-600 space-y-1">
                                    <p><strong>Numéro de commande:</strong> #<?php echo e($refund->order->order_number); ?></p>
                                    <p><strong>Date de commande:</strong> <?php echo e($refund->order->created_at->format('d/m/Y à H:i')); ?></p>
                                    <p><strong>Quantité:</strong> <?php echo e($refund->order->quantity); ?></p>
                                    <p><strong>Prix unitaire:</strong> $<?php echo e(number_format($refund->order->item->price, 2)); ?></p>
                                </div>
                                
                                <div class="mt-3">
                                    <a href="<?php echo e(route('orders.show', $refund->order)); ?>" 
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                        <h3 class="text-lg font-semibold text-gray-900">Acheteur</h3>
                    </div>
                    <div class="p-6">
                        <div class="text-center mb-4">
                            ...
                            <h4 class="font-semibold text-gray-900"><?php echo e($refund->buyer->name); ?></h4>
                            <p class="text-sm text-gray-600"><?php echo e($refund->buyer->email); ?></p>
                        </div>
                        
                        <div class="space-y-2 text-sm">
                            <p><strong>Membre depuis:</strong> <?php echo e($refund->buyer->created_at->format('M Y')); ?></p>
                            <p><strong>Commandes totales:</strong> <?php echo e($refund->buyer->orders()->count()); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <?php if($refund->status === 'pending'): ?>
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            <!-- Approuver -->
                            <form method="POST" action="<?php echo e(route('refund.process', $refund)); ?>">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($refund->created_at->format('d/m/Y à H:i')); ?></p>
                                </div>
                            </div>
                            ...
                            <?php if($refund->updated_at != $refund->created_at): ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500"><?php echo e($refund->updated_at->format('d/m/Y à H:i')); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
        ...
        <div class="mt-3">
            ...
            <form id="negotiationForm">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="number" id="counterOffer" name="counter_offer" step="0.01" min="0" max="<?php echo e($refund->original_amount); ?>" required
                    ...
                    <p class="text-xs text-gray-500 mt-1">Maximum: $<?php echo e(number_format($refund->original_amount, 2)); ?></p>
                </div>

                <div class="mb-6">
                    <label for="adminNotes" class="block text-sm font-medium text-gray-700 mb-2">Notes explicatives</label>
...
document.getElementById('negotiationForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route('refund.process', $refund)); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/refunds/show.blade.php ENDPATH**/ ?>