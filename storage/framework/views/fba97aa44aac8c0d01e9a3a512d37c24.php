...
<div class="space-y-5">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-5 transition-all duration-200 hover:shadow-md">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white" id="stat-total"><?php echo e($stats['total_online']); ?></p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-5 transition-all duration-200 hover:shadow-md">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white" id="stat-mobile"><?php echo e($stats['by_device']['mobile']); ?></p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-5 transition-all duration-200 hover:shadow-md">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white" id="stat-tablet"><?php echo e($stats['by_device']['tablet']); ?></p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-5 transition-all duration-200 hover:shadow-md">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white" id="stat-desktop"><?php echo e($stats['by_device']['desktop']); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700/50">
            <div class="flex items-center gap-2.5">
                ...
                <span class="text-[11px] text-gray-400 font-normal" id="userCount">(<?php echo e($onlineUsers->count()); ?> en ligne)</span>
            </div>
        </div>
        ...
        <div class="p-5">
            <div id="usersGrid" class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $onlineUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $user = $userData['user']; $session = $userData['session']; ?>
                    <div class="rounded-xl border border-gray-100 dark:border-gray-700/50 p-4 hover:shadow-md transition-all duration-200 user-card"
                         data-device="<?php echo e($session->device_type); ?>"
                         data-user-name="<?php echo e(strtolower($user->name)); ?>"
                         data-user-email="<?php echo e(strtolower($user->email)); ?>">
                        <div class="flex items-start gap-3">
                            
                            <div class="relative flex-shrink-0">
                                <img src="<?php echo e($user->avatar ?? asset('images/default-avatar.png')); ?>" alt="<?php echo e($user->name); ?>"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-1.5 mt-2">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-medium <?php echo e($deviceColors[$session->device_type] ?? $deviceColors['desktop']); ?>">
                                        <?php if($session->device_type === 'mobile'): ?>
                                        ...
                                        <?php elseif($session->device_type === 'tablet'): ?>
                                    ...
                                    <?php if($session->browser): ?>
                                        <span class="text-[11px] text-gray-500 dark:text-gray-400"><?php echo e($session->browser); ?></span>
                                    <?php endif; ?>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ?>
    const initialMapData = <?php echo json_encode($mapData, 15, 512) ?>;
    ...
    window.refreshData = async function() {
        ...
        try {
            const res = await fetch('<?php echo e(route("admin.users.online.data")); ?>', {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/users/online.blade.php ENDPATH**/ ?>