        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white" id="stat-total"><?php echo e($stats['total_online']); ?></p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-primary-600" id="stat-tablet"><?php echo e($stats['by_device']['tablet']); ?></p>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white">
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400 ml-2" id="userCount">(<?php echo e($onlineUsers->count()); ?> en ligne)</span>
            </h3>
        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between mb-1">
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-900 dark:text-white truncate"><?php echo e($user->name); ?></h4>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/admin/users/online.blade.php ENDPATH**/ ?>