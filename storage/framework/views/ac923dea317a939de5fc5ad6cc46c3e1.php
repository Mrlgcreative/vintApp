            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a href="<?php echo e(route('local-delivery.create')); ?>" 
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($orders->where('status', 'pending')->count()); ?></p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($orders->where('status', 'confirmed')->count()); ?></p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($orders->where('status', 'shipped')->count()); ?></p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($orders->whereIn('status', ['delivered', 'completed'])->count()); ?></p>
            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-3">
                    <a href="<?php echo e(route('orders.my-sales')); ?>" 
                       class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 <?php echo e(!request('status') ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        <i class="fas fa-list"></i>
                        Toutes (<?php echo e($orders->total()); ?>)
                    </a>
                    <a href="<?php echo e(route('orders.my-sales', ['status' => 'pending'])); ?>" 
                       class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 <?php echo e(request('status') === 'pending' ? 'bg-yellow-500 text-white shadow-lg' : 'bg-yellow-50 text-yellow-700 hover:bg-yellow-100'); ?>">
                        <i class="fas fa-clock"></i>
                        En attente
                    </a>
                    <a href="<?php echo e(route('orders.my-sales', ['status' => 'confirmed'])); ?>" 
                       class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 <?php echo e(request('status') === 'confirmed' ? 'bg-blue-500 text-white shadow-lg' : 'bg-blue-50 text-blue-700 hover:bg-blue-100'); ?>">
                        <i class="fas fa-box"></i>
                        À expédier
                    </a>
                    <a href="<?php echo e(route('orders.my-sales', ['status' => 'shipped'])); ?>" 
                       class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 <?php echo e(request('status') === 'shipped' ? 'bg-indigo-500 text-white shadow-lg' : 'bg-indigo-50 text-indigo-700 hover:bg-indigo-100'); ?>">
                        <i class="fas fa-shipping-fast"></i>
                        Expédiées
                    </a>
                    <a href="<?php echo e(route('orders.my-sales', ['status' => 'delivered,completed'])); ?>" 
                       class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 <?php echo e(in_array(request('status'), ['delivered', 'completed']) ? 'bg-green-500 text-white shadow-lg' : 'bg-green-50 text-green-700 hover:bg-green-100'); ?>">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-sm text-gray-500"><?php echo e($order->order_number); ?></div>
                                        <div class="text-sm text-gray-500">Qté: <?php echo e($order->quantity); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <div class="font-semibold text-gray-900"><?php echo e(Str::limit($order->item->name ?? 'Article supprimé', 30)); ?></div>
                                                <div class="text-sm text-gray-500"><?php echo e($order->item->category->name ?? 'Catégorie inconnue'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <div class="font-semibold text-gray-900"><?php echo e($order->buyer->name ?? 'Utilisateur inconnu'); ?></div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-gray-900"><?php echo e(number_format($order->total_amount, 2)); ?> <?php echo e($order->currency); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e(number_format($order->unit_price, 2)); ?> × <?php echo e($order->quantity); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php
                                            $statusConfig = [
                                        ...
                                        ?>
                                        <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium <?php echo e($config['class']); ?>">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-gray-900"><?php echo e($order->created_at->format('d/m/Y')); ?></div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <?php if(in_array($order->status, ['confirmed', 'shipped']) && !$order->localDelivery): ?>
                                                <a href="<?php echo e(route('local-delivery.create', ['order_id' => $order->id])); ?>" 
                                            ...
                                            <?php if($order->status === 'confirmed'): ?>
                                                <form method="POST" action="<?php echo e(route('orders.mark-shipped', $order)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" 
                                            ...
                                            <?php if($order->status === 'shipped'): ?>
                                                <form method="POST" action="<?php echo e(route('orders.mark-delivered', $order)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" 
