        ...
        <div class="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8 transition-colors duration-200">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300"><?php echo e(Auth::user()->email); ?></p>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-200">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-600">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-700 transition-colors group">
            ...
            <div class="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                    ...
                    <div class="divide-y divide-gray-200">
                        <a href="<?php echo e(route('dashboard')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('orders.my-sales')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                    ...
                    <!-- Colonne 2 -->
                    <div class="divide-y divide-gray-200">
                        <a href="<?php echo e(route('items.my-items')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('wallet.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('messages.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                            <div class="flex items-center space-x-4">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 bg-gradient-to-r from-primary-50 to-cyan-50">
                    <a href="<?php echo e(route('affiliate.dashboard')); ?>" class="block px-6 py-4 hover:from-primary-100 hover:to-cyan-100 transition-all group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                    <a href="<?php echo e(route('brands.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                    ...
                    <a href="<?php echo e(route('categories.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('items.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-green-100 text-green-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="divide-y divide-gray-200">
                    <a href="<?php echo e(route('help.index')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('help.index')); ?>#contact" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-primary-100 text-primary-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <a href="<?php echo e(route('terms')); ?>" class="block px-6 py-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-yellow-100 text-yellow-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/settings/index.blade.php ENDPATH**/ ?>