    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-8 py-12 text-center">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 mb-8 text-left">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <span class="font-medium text-primary-600"><?php echo e($transaction->transaction_id); ?></span>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <!-- Boutons d'action -->
                <div class="space-y-3">
                    <a href="<?php echo e(route('dashboard')); ?>" class="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-primary-600 hover:bg-primary-700 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-screen overflow-y-auto transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
        ...
        <div class="p-6 space-y-6" id="ratingsContainer">
            <?php $__currentLoopData = $unratedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200 dark:border-gray-700" data-order-id="<?php echo e($order->id); ?>">
                    <div class="flex items-start space-x-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1"><?php echo e($order->item ? $order->item->name : 'Article'); ?></h4>
                            <p class="text-gray-600 dark:text-gray-300 text-sm mb-2">Vendeur: <?php echo e($order->seller ? $order->seller->name : 'Vendeur'); ?></p>
                            <p class="text-primary-600 font-medium"><?php echo e(number_format($order->total_amount, 2)); ?> <?php echo e($order->currency); ?></p>
                        </div>
                    </div>
