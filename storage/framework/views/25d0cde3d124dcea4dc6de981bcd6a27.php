...
<?php $__env->startSection('page-title', 'Envoyer Newsletter'); ?>
...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="<?php echo e(route('admin.settings.newsletter.subscribers')); ?>" 
       class="inline-flex items-center rounded-lg bg-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-300">
...
<div class="grid gap-6 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2">
        <div class="overflow-hidden rounded-xl bg-white shadow-md">
            ...
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('admin.settings.newsletter.process')); ?>" id="newsletterForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
                            <label class="relative flex cursor-pointer items-center rounded-lg border-2 border-gray-200 p-4 transition-all hover:border-primary-300 has-[:checked]:border-primary-600 has-[:checked]:bg-primary-50">
                                ...
                                <div class="flex w-full items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-semibold text-gray-900">Tous</p>
                                        <p class="text-xs text-gray-500">Tous les abonnés</p>
                                    </div>
                                </div>
                            </label>

                            <label class="relative flex cursor-pointer items-center rounded-lg border-2 border-gray-200 p-4 transition-all hover:border-green-300 has-[:checked]:border-green-600 has-[:checked]:bg-green-50">
                                ...
                                <div class="flex w-full items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-semibold text-gray-900">Actifs</p>
                                        <p class="text-xs text-gray-500">Actifs uniquement</p>
                                    </div>
                                </div>
                            </label>

                            <label class="relative flex cursor-pointer items-center rounded-lg border-2 border-gray-200 p-4 transition-all hover:border-cyan-300 has-[:checked]:border-cyan-600 has-[:checked]:bg-cyan-50">
                                ...
                                <div class="flex w-full items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-semibold text-gray-900">Vérifiés</p>
                                        <p class="text-xs text-gray-500">Vérifiés uniquement</p>
                                    </div>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               class="block w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 <?php $__errorArgs = ['subject'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="block w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  rows="12" 
                                  required
                                  placeholder="Écrivez votre message ici... Vous pouvez utiliser du HTML."><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button type="button" 
                                class="inline-flex items-center rounded-lg border-2 border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 transition-all hover:border-gray-400 hover:bg-gray-50" 
                                id="previewBtn">
                        ...
                        <a href="<?php echo e(route('admin.settings.newsletter.subscribers')); ?>" 
                           class="inline-flex items-center rounded-lg border-2 border-red-300 bg-white px-5 py-2.5 text-sm font-medium text-red-600 transition-all hover:border-red-400 hover:bg-red-50">
    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-md">
            ...
            <div class="p-6">
                <div class="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 p-6 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600">abonné(s) recevront cette newsletter</p>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-md">
            ...
            <div class="p-6">
                <div class="mb-4">
                    <h4 class="mb-3 flex items-center text-sm font-bold text-gray-900">
                ...
                <div class="mb-4 border-t border-gray-200 pt-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-gray-700">
                        <li><code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-primary-600">&lt;strong&gt;</code> pour du texte en gras</li>
                        <li><code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-primary-600">&lt;em&gt;</code> pour du texte en italique</li>
                        <li><code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-primary-600">&lt;a href=""&gt;</code> pour des liens</li>
                        <li><code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-primary-600">&lt;br&gt;</code> pour un saut de ligne</li>
                        <li><code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-primary-600">&lt;p&gt;</code> pour des paragraphes</li>
                    </ul>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="rounded-lg border-l-4 border-primary-600 bg-gray-50 p-3 text-xs text-gray-700">
    ...
    <div class="w-full max-w-4xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div class="max-h-[70vh] overflow-y-auto p-6">
            <div class="mx-auto max-w-2xl">
                <div class="overflow-hidden rounded-xl bg-gray-100 p-6">
                    ...
                    <div class="rounded-b-xl bg-white p-8 shadow-lg">
        ...
        <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
            <button type="button" class="rounded-lg bg-gray-200 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-300" id="closeModalBtn2">
                <i class="fas fa-times mr-2"></i>
                Fermer
            </button>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateRecipientCount() {
        ...
        const counts = { all: '<?php echo e($stats['total'] ?? 0); ?>', active: '<?php echo e($stats['active'] ?? 0); ?>', verified: '<?php echo e($stats['verified'] ?? 0); ?>' };
    ...
    previewBtn.addEventListener('click', function() {
        ...
        document.getElementById('preview-content').innerHTML = content || '<p class="text-gray-500">Aucun contenu</p>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/newsletter/send.blade.php ENDPATH**/ ?>