...
<?php $__env->startSection('title', 'Paramètres de pré-inscription'); ?>
...
<div class="container-fluid py-4">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?php echo e(route('preregistration.index')); ?>" class="btn btn-outline-primary" target="_blank">
                                <i class="fas fa-external-link-alt me-2"></i>Voir la page
                            </a>
                            <a href="<?php echo e(route('admin.waiting-users.index')); ?>" class="btn btn-primary">
    ...
    <form action="<?php echo e(route('admin.settings.preregistration.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted small mb-0">
                                    Les utilisateurs <?php echo e($isEnabled ? 'peuvent' : 'ne peuvent pas'); ?> actuellement s'inscrire
                                </p>
                            </div>
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="preregistration_enabled">
                                    <span class="badge <?php echo e($isEnabled ? 'badge-enabled' : 'badge-disabled'); ?>" id="status-badge">
                                        <?php echo e($isEnabled ? 'Activée' : 'Désactivée'); ?>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(Setting::get('preregistration_title', 'Rejoignez-nous en avant-première !')); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(Setting::get('preregistration_subtitle', 'Inscrivez-vous maintenant...')); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      rows="4"
                                      placeholder="Nous préparons quelque chose de spécial..."><?php echo e(Setting::get('preregistration_message', 'Nous préparons quelque chose de spécial...')); ?></textarea>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      rows="3"
                                      placeholder="Les pré-inscriptions sont fermées..."><?php echo e(Setting::get('preregistration_closed_message', 'Les pré-inscriptions sont fermées...')); ?></textarea>
                                ...
                                <div class="benefit-item mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="<?php echo e($benefit); ?>"
                                               placeholder="Avantage <?php echo e($index + 1); ?>">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('preregistration_require_phone', false) ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('preregistration_require_confirmation', true) ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-0">
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e(Setting::get('preregistration_limit', 0)); ?>"
                                   min="0"
                    ...
                    <div class="card-body">
                        <div class="mb-0">
                            ...
                            <input type="email" 
                                   ...
                                   value="<?php echo e(Setting::get('preregistration_notification_email', 'admin@vintapp.com')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/settings/preregistration.blade.php ENDPATH**/ ?>