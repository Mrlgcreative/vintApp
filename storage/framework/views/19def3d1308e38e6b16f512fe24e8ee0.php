...
<div class="fixed inset-0 bg-gray-50 flex flex-col overflow-hidden z-50 pb-16 md:pb-0" style="background-image: repeating-linear-gradient(45deg, transparent, transparent 1px, rgba(0,0,0,0.02) 1px, rgba(0,0,0,0.02) 10px);">
    ...
    <div class="bg-purple-600 text-white shadow-lg">
        <div class="flex items-center px-4 py-3 gap-3">
            <a href="<?php echo e(route('messages.index')); ?>" class="text-white hover:bg-white hover:bg-opacity-10 p-2 rounded-full transition-colors">
            ...
            <div class="flex items-center flex-1 gap-3 cursor-pointer">
                ...
                <div class="flex-1">
                    <h6 class="font-medium text-white"><?php echo e($otherUser->name); ?></h6>
    ...
    <?php if($item): ?>
        <div class="bg-yellow-100 border-b border-yellow-200 px-4 py-3">
            <div class="flex items-center gap-3">
                ...
                <?php endif; ?>
                <div class="flex-1">
                    <span class="font-semibold text-gray-900 block"><?php echo e($item->name); ?></span>
                    <span class="text-purple-600 font-bold"><?php echo e($item->formatted_price); ?></span>
                </div>
                <a href="<?php echo e(route('items.show', $item)); ?>" class="text-purple-600 hover:text-purple-700 p-2">
                ...
                <div class="px-4 pb-4 hidden" id="discountContent">
                    <div class="border-t border-green-200 pt-4">
                        <div class="bg-white rounded-lg p-3 mb-4 border border-gray-200 flex justify-between items-center">
                            ...
                            <span class="text-purple-600 font-bold text-lg"><?php echo e($item->formatted_price); ?></span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4">
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="5">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.05, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="10">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.10, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="15">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.15, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="20">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.20, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="25">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.25, 2)); ?></div>
                            </div>
                            <div class="rate-option bg-white border-2 border-gray-200 rounded-lg p-3 text-center cursor-pointer hover:border-purple-600 hover:-translate-y-1 hover:shadow-md transition-all" data-rate="30">
                                ...
                                <div class="text-sm text-gray-500">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.30, 2)); ?></div>
                            </div>
                        </div>
        ...
        <div class="max-w-4xl mx-auto">
            <?php if($messages->count() > 0): ?>
                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-2 flex <?php echo e($message->sender_id === Auth::id() ? 'justify-end' : 'justify-start'); ?>">
                        <div class="max-w-xs lg:max-w-md xl:max-w-lg min-w-0 relative <?php echo e($message->sender_id === Auth::id() ? 'bg-purple-100' : 'bg-white'); ?> rounded-2xl <?php echo e($message->sender_id === Auth::id() ? 'rounded-br' : 'rounded-bl'); ?> px-3 py-2 shadow-sm animate-fade-in">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/messages/show.blade.php ENDPATH**/ ?>