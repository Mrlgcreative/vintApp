...
<div class="whatsapp-container">
    ...
    <div class="whatsapp-header">
        <div class="header-content">
            <a href="<?php echo e(route('messages.index')); ?>" class="back-btn">
            ...
            <div class="user-info">
                ...
                <div class="user-details">
                    <h6 class="user-name"><?php echo e($otherUser->name); ?></h6>
    ...
    <?php if($item): ?>
        <div class="product-badge">
            <div class="product-info">
                ...
                <a href="<?php echo e(route('items.show', $item)); ?>" class="product-link">
            ...
            <div class="discount-panel" id="discountPanel">
                ...
                <div class="discount-content" id="discountContent" style="display: none;">
                    <div class="current-price-info">
                        ...
                        <span class="current-price-value"><?php echo e($item->formatted_price); ?></span>
                    </div>
                    
                    <div class="discount-rates-grid">
                        <div class="rate-option" data-rate="5">
                            <div class="rate-percentage">5%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.95, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.05, 2)); ?></div>
                        </div>
                        <div class="rate-option" data-rate="10">
                            <div class="rate-percentage">10%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.90, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.10, 2)); ?></div>
                        </div>
                        <div class="rate-option" data-rate="15">
                            <div class="rate-percentage">15%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.85, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.15, 2)); ?></div>
                        </div>
                        <div class="rate-option" data-rate="20">
                            <div class="rate-percentage">20%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.80, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.20, 2)); ?></div>
                        </div>
                        <div class="rate-option" data-rate="25">
                            <div class="rate-percentage">25%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.75, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.25, 2)); ?></div>
                        </div>
                        <div class="rate-option" data-rate="30">
                            <div class="rate-percentage">30%</div>
                            <div class="rate-price"><?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.70, 2)); ?></div>
                            <div class="rate-savings">-<?php echo e($item->currency_symbol); ?> <?php echo e(number_format($item->price * 0.30, 2)); ?></div>
                        </div>
                    </div>
        ...
        <div class="messages-wrapper">
            <?php if($messages->count() > 0): ?>
                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="message-group <?php echo e($message->sender_id === Auth::id() ? 'sent' : 'received'); ?>">
