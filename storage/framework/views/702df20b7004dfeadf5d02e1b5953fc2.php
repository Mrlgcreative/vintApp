...
<?php $__env->startSection('title', 'Paiement de la vérification'); ?>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6 mb-6">
            ...
            <div class="flex items-center space-x-4 mb-4">
                <?php if(count($check->item->images) > 0): ?>
                    <img src="<?php echo e(asset('storage/' . $check->item->images[0])); ?>" 
                         alt="<?php echo e($check->item->name); ?>" 
                ...
                <div class="flex-1">
                    <h3 class="font-medium text-gray-900 dark:text-white"><?php echo e($check->item->name); ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($check->item->brand->name ?? 'Marque non spécifiée'); ?></p>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Catégorie: <?php echo e($check->item->category->name ?? 'Non spécifiée'); ?></p>
                </div>
                
                <div class="text-right">
                    <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($check->item->formatted_price); ?></p>
                </div>
            </div>
            ...
            <div class="border-t pt-4">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-bold text-blue-600">$<?php echo e(number_format($check->verification_fee, 2)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6">
            ...
            <form action="<?php echo e(route('authenticity.payment.confirm', $check)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('authenticity.request', $check->item)); ?>" 
                    ...
                    <button type="submit" 
                        ...
                        Confirmer le paiement - $<?php echo e(number_format($check->verification_fee, 2)); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/authenticity/payment.blade.php ENDPATH**/ ?>