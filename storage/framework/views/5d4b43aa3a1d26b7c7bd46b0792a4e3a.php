                ...
                <div>
                    <div class="grid grid-cols-1 gap-4">
                        <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                            ...
                            <div class="text-lg text-gray-900 dark:text-white"><?php echo e($check->item->name ?? 'Produit sans nom'); ?></div>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Prix</div>
                                <div class="text-lg text-gray-900 dark:text-white"><?php echo e(number_format($check->item->price, 0, ',', ' ')); ?> <?php echo e($check->item->currency); ?></div>
                            </div>

                            <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Catégorie</div>
                                <div class="text-lg text-gray-900 dark:text-white"><?php echo e($check->item->category->name ?? 'Non spécifiée'); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                                ...
                                <div class="text-lg text-gray-900 dark:text-white"><?php echo e($check->item->brand->name ?? 'Non spécifiée'); ?></div>
                            </div>

                            <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">État</div>
                                <div class="text-lg text-gray-900 dark:text-white"><?php echo e(ucfirst($check->item->condition ?? 'Non spécifié')); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                            ...
                            <div class="text-lg text-gray-900 dark:text-white">
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($check->vendor->email); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($check->item->description): ?>
                        <div class="mt-4">
                            ...
                            <div class="text-gray-900 dark:text-white"><?php echo e($check->item->description); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <ul class="space-y-1">
                                <?php $__currentLoopData = $aiData['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="text-gray-700 dark:text-gray-200">• <?php echo e($detail); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="relative mb-6 last:mb-0">
                        ...
                        <div class="ml-10 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="flex justify-content-between items-start mb-2">
                                <strong class="text-gray-900 dark:text-white"><?php echo e($log->getActionLabel()); ?></strong>
                                <small class="text-gray-500 dark:text-gray-400"><?php echo e($log->created_at->format('d/m/Y à H:i')); ?></small>
                            </div>
                            <?php if($log->performer): ?>
                                <p class="text-sm text-gray-600 dark:text-gray-300 mb-1">Par: <?php echo e($log->performer->name); ?></p>
                            <?php endif; ?>
                            <?php if($log->details): ?>
                                <?php
        ...
        <?php if($check->expert_notes): ?>
            <div class="p-8 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 border-l-4 border-primary p-4 rounded-lg">
                    <p class="text-gray-700 dark:text-gray-200"><?php echo e($check->expert_notes); ?></p>
                </div>
            </div>
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/expert/verifications/show.blade.php ENDPATH**/ ?>