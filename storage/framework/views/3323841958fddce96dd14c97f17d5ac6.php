    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 mb-8 shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-2xl font-bold text-primary mb-1"><?php echo e($verifications->total()); ?></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/expert/verifications/index.blade.php ENDPATH**/ ?>