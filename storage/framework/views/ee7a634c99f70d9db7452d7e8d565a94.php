            ...
            <div class="p-8">
                ...
                <div class="bg-gray-50 rounded-xl p-4 mb-6 text-center">
                    <div class="flex items-center justify-center">
                        ...
                        <span class="font-semibold text-gray-800"><?php echo e(Auth::user()->email); ?></span>
                    </div>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('verification.code.verify')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            maxlength="6"
                            pattern="[0-9]{6}"
                            class="w-full text-center text-2xl font-bold tracking-widest bg-white border-2 border-gray-200 rounded-xl py-4 px-6 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-300 <?php $__errorArgs = ['verification_code'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
                ...
                <a href="mailto:<?php echo e(config('mail.from.address')); ?>" class="text-purple-600 hover:text-purple-800 font-medium">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/auth/verify-code.blade.php ENDPATH**/ ?>