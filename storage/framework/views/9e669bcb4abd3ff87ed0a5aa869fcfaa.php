        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-blue-600 transition-colors duration-200">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-blue-600/10 border border-gray-100/50 overflow-hidden">
                    ...
                    <div class="p-6 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($order->item->name); ?></h2>
                                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed"><?php echo e($order->item->description); ?></p>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="p-4 bg-primary-50 rounded-xl border border-primary-100">
                                        ...
                                        <p class="font-bold text-primary-900"><?php echo e($order->item->user->name); ?></p>
                                    </div>
                                        ...
                                        <div class="space-y-4">
                                            <div class="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-700 dark:text-gray-200"><?php echo e($order->deliveryAddress->full_name); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-700 dark:text-gray-200"><?php echo e($order->deliveryAddress->city); ?>, <?php echo e($order->deliveryAddress->commune); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-300"><?php echo e($order->deliveryAddress->address); ?></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="space-y-4">
                                            <?php if($order->shipping_city && $order->shipping_city !== 'À définir'): ?>
                                                <div class="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-gray-700 dark:text-gray-200"><?php echo e($order->shipping_city); ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if($order->shipping_address && $order->shipping_address !== 'À définir'): ?>
                                                <div class="flex items-start">
                                                    ...
                                                    <div>
                                                        <p class="font-semibold text-gray-900 dark:text-white">Adresse complète</p>
                                                        <p class="text-gray-600 dark:text-gray-300"><?php echo e($order->shipping_address); ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                ...
                                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                                    <div class="space-y-3">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->formatted_unit_price); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <span class="text-gray-600 dark:text-gray-300">Quantité:</span>
                                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->quantity); ?></span>
                                        </div>
                        ...
                        <?php if($order->notes): ?>
                            <div>
                                ...
                                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                                    <p class="text-gray-800 dark:text-gray-100"><?php echo e($order->notes); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="relative flex items-start">
                                        ...
                                        <div class="ml-12">
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($order->created_at->format('d/m/Y H:i')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($order->paid_at): ?>
                                        <div class="relative flex items-start">
                                            ...
                                            <div class="ml-12">
                                                ...
                                                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($order->paid_at->format('d/m/Y H:i')); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($order->shipped_at): ?>
                                        <div class="relative flex items-start">
                                            ...
                                            <div class="ml-12">
                                                ...
                                                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($order->shipped_at->format('d/m/Y H:i')); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($order->delivered_at): ?>
                                        <div class="relative flex items-start">
                                            ...
                                            <div class="ml-12">
                                                ...
                                                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($order->delivered_at->format('d/m/Y H:i')); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-600/10 border border-gray-100/50 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($order->order_number); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600 dark:text-gray-300">Créée le:</span>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($order->created_at->format('d/m/Y')); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600 dark:text-gray-300">Devise:</span>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($order->currency); ?></span>
                        </div>
                        <?php if($order->updated_at !== $order->created_at): ?>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-300">Modifiée le:</span>
                                <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($order->updated_at->format('d/m/Y')); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/orders/show.blade.php ENDPATH**/ ?>