...
<?php $__env->startSection('title', 'Retirer des fonds - ' . $wallet->currency); ?>
                ...
                <div class="card-body p-4">
                    ...
                    <?php if($wallet->balance <= 0): ?>
                        <div class="alert alert-warning text-center">
                            ...
                            <a href="<?php echo e(route('wallet.add-funds', $wallet)); ?>" class="btn btn-success">
                                <i class="fas fa-plus me-1"></i>Ajouter des fonds
                            </a>
                        </div>
                    <?php else: ?>
                        <form action="<?php echo e(route('wallet.store-withdraw-funds', $wallet)); ?>" method="POST" id="withdrawFundsForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="tel" 
                                       class="form-control form-control-lg <?php $__errorArgs = ['phone_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="orange_money" <?php echo e(old('payment_method') === 'orange_money' ? 'selected' : ''); ?>>
                                        🟠 Orange Money
                                    </option>
                                    <option value="airtel_money" <?php echo e(old('payment_method') === 'airtel_money' ? 'selected' : ''); ?>>
                                        🔴 Airtel Money
                                    </option>
                                    <option value="mpesa" <?php echo e(old('payment_method') === 'mpesa' ? 'selected' : ''); ?>>
                                        🟢 M-Pesa (Vodacom)
                                    </option>
                                    <option value="africell" <?php echo e(old('payment_method') === 'africell' ? 'selected' : ''); ?>>
                                        🔵 Africell Money
                                    </option>
                                    <option value="illicocash" <?php echo e(old('payment_method') === 'illicocash' ? 'selected' : ''); ?>>
                                        💳 Illicocash
                                    </option>
                                </select>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/wallet/withdraw-funds.blade.php ENDPATH**/ ?>