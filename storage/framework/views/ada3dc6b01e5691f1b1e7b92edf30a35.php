            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($expertProfile ? ucfirst($expertProfile->certification_level) : 'Junior'); ?> Expert</p>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md">
                ...
                <div class="p-6">
                    <?php $__empty_1 = true; $__currentLoopData = $recentChecks->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between py-2 <?php if(!$loop->last): ?> border-b border-gray-100 dark:border-gray-700 <?php endif; ?>">
                            <div class="flex-1">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/expert/dashboard.blade.php ENDPATH**/ ?>