                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="h4 text-primary mb-1"><?php echo e($stats['total_items']); ?></div>
                            <small class="text-muted">Articles</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h4 text-success mb-1"><?php echo e($stats['completed_orders']); ?></div>
                            <small class="text-muted">Ventes</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h4 text-info mb-1"><?php echo e($stats['total_revenue']); ?>€</div>
                            <small class="text-muted">Revenus</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h4 text-warning mb-1"><?php echo e(number_format($stats['average_rating'], 1)); ?></div>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="location" name="location" value="<?php echo e(old('location', $user->location)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="alert alert-danger">
                                ...
                                <form method="POST" action="<?php echo e(route('profile.destroy')); ?>" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer votre compte ?')">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tab-pane fade" id="preferences" role="tabpanel">
                            <form method="POST" action="<?php echo e(route('profile.theme')); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="theme_preference" 
                                                               id="theme_auto" value="auto" <?php echo e($user->theme_preference === 'auto' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card theme-option">
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="theme_preference" 
                                                               id="theme_light" value="light" <?php echo e($user->theme_preference === 'light' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card theme-option">
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="theme_preference" 
                                                               id="theme_dark" value="dark" <?php echo e($user->theme_preference === 'dark' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/profile/edit.blade.php ENDPATH**/ ?>