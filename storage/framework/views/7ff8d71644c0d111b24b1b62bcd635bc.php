        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 hover:shadow-lg hover:shadow-violet-500/5 hover:-translate-y-0.5 transition-all duration-300">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_items'] ?? 0); ?></p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Articles <span class="hidden sm:inline">· <?php echo e($stats['active_items'] ?? 0); ?> actifs</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 hover:shadow-lg hover:shadow-emerald-500/5 hover:-translate-y-0.5 transition-all duration-300">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_sales'] ?? 0); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 hover:shadow-lg hover:shadow-cyan-500/5 hover:-translate-y-0.5 transition-all duration-300">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['unread_messages'] ?? 0); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 hover:shadow-lg hover:shadow-amber-500/5 hover:-translate-y-0.5 transition-all duration-300">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['pending_support_chats'] ?? 0); ?></p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden mb-8">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                ...
                <?php if(Route::has('admin.support.index')): ?>
                    <a href="<?php echo e(route('admin.support.index')); ?>" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors">
                        Voir tout <i class="fas fa-arrow-right text-xs ml-1"></i>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('support.index')); ?>" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center p-3 bg-red-50 dark:bg-red-900/10 rounded-xl">
                        <div class="text-2xl font-bold text-red-600 dark:text-red-400"><?php echo e($stats['open_support_chats'] ?? 0); ?></div>
                    ...
                    <div class="text-center p-3 bg-yellow-50 dark:bg-yellow-900/10 rounded-xl">
                        <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($stats['pending_support_chats'] ?? 0); ?></div>
                    ...
                    <div class="text-center p-3 bg-orange-50 dark:bg-orange-900/10 rounded-xl">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400"><?php echo e($stats['unassigned_support_chats'] ?? 0); ?></div>
                ...
                <?php if(($stats['unassigned_support_chats'] ?? 0) > 0): ?>
                    <div class="mt-4 p-3 bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-800/50 rounded-xl flex items-center gap-3">
                        ...
                        <?php if(Route::has('admin.support.index')): ?>
                            <a href="<?php echo e(route('admin.support.index', ['assigned_to' => 'unassigned'])); ?>" class="text-sm text-orange-600 dark:text-orange-400 hover:text-orange-700 font-semibold flex-shrink-0">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-900/10 transition-colors">
                                    <div class="min-w-0 flex-1">
                                        <h6 class="font-semibold text-gray-900 dark:text-white text-sm">Commande #<?php echo e($order->id); ?></h6>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($order->item->name ?? 'N/A'); ?></p>
                                    </div>
                                    <span class="ml-3 px-2.5 py-1 text-xs font-semibold rounded-lg flex-shrink-0 <?php echo e($order->status === 'completed' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300' : 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300'); ?>">
                            ...
                            <?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl hover:bg-cyan-50 dark:hover:bg-cyan-900/10 transition-colors">
                                    <div class="flex items-start justify-between gap-3">
                                        <div class="min-w-0 flex-1">
                                            <h6 class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($msg->sender->name ?? 'N/A'); ?></h6>
                                            <p class="text-gray-500 dark:text-gray-400 text-xs mt-0.5 truncate"><?php echo e(Str::limit($msg->content, 60)); ?></p>
                                        </div>
                                        <span class="text-[11px] text-gray-400 dark:text-gray-500 flex-shrink-0 mt-0.5"><?php echo e($msg->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl hover:bg-amber-50 dark:hover:bg-amber-900/10 transition-colors">
                                    <div class="flex items-start justify-between gap-3">
                                        <div class="min-w-0 flex-1">
                                            <h6 class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($notif->title); ?></h6>
                                            <p class="text-gray-500 dark:text-gray-400 text-xs mt-0.5 truncate"><?php echo e(Str::limit($notif->message, 60)); ?></p>
                                        </div>
                                        <span class="text-[11px] text-gray-400 dark:text-gray-500 flex-shrink-0 mt-0.5"><?php echo e($notif->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <div class="p-6">
                ...
                <div class="flex gap-3 md:gap-4 justify-between" id="sales-chart-container">
                    <?php $__currentLoopData = $chartData['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex-1 flex flex-col items-center gap-1.5 min-w-[48px]">
                            <div class="text-sm md:text-lg font-bold text-gray-800 dark:text-gray-100"><?php echo e($value); ?></div>
                            <div class="w-full bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden flex items-end h-28 md:h-36">
                                <div class="chart-bar w-full rounded-t-lg transition-all duration-700 ease-out"
                                     style="background: linear-gradient(180deg, <?php echo e($c['from']); ?>, <?php echo e($c['to']); ?>); height: 0%;"
                                     data-height="<?php echo e($percentage); ?>">
                                </div>
                            </div>
                            <div class="text-xs font-medium text-gray-500 dark:text-gray-400 mt-1"><?php echo e($chartData['labels'][$index]); ?></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="grid grid-cols-3 gap-3 md:gap-4 mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                    <div class="text-center p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl">
                        ...
                        <div class="text-xl md:text-2xl font-bold text-primary-600 dark:text-primary-400"><?php echo e(array_sum($chartData['data'])); ?></div>
                    ...
                    <div class="text-center p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl">
                        ...
                        <div class="text-xl md:text-2xl font-bold text-emerald-600 dark:text-emerald-400"><?php echo e(round(array_sum($chartData['data']) / count($chartData['data']), 1)); ?></div>
                    ...
                    <div class="text-center p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl">
                        ...
                        <div class="text-xl md:text-2xl font-bold text-amber-600 dark:text-amber-400"><?php echo e(max($chartData['data'])); ?></div>
                        <div class="text-[11px] text-gray-400 dark:text-gray-500"><?php echo e($chartData['labels'][array_search(max($chartData['data']), $chartData['data'])]); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/dashboard/index.blade.php ENDPATH**/ ?>