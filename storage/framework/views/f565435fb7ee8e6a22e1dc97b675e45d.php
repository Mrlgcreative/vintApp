...
<div id="supportWidget" style="position: fixed; bottom: 20px; right: 20px; z-index: 1040;">
    ...
    <button id="supportToggle" 
        ...
        <?php if(Auth::check() && isset($openChats) && $openChats->count() > 0): ?>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                <?php echo e($openChats->count()); ?>
    ...
    <div id="supportPopup" class="card shadow-lg border-0 d-none" 
        ...
        <div class="card-body p-3" style="max-height: 400px; overflow-y: auto;">
            <?php if(auth()->guard()->check()): ?>
                <?php if(isset($openChats) && $openChats->count() > 0): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 mb-3" style="max-height: 150px; overflow-y: auto;">
                            <?php $__currentLoopData = $openChats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   ...
                                   style="transition: all 0.2s;">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            <p class="mb-0 fw-medium text-dark small"><?php echo e($chat->reference); ?></p>
                                            <p class="mb-0 text-muted" style="font-size: 0.75rem;"><?php echo e($chat->subject ?: 'Assistance'); ?></p>
                                        </div>
                                        <span class="badge 
                                    ...
                                    <?php if($chat->unread_count_for_user > 0): ?>
                                        <div class="mt-1">
                                            <span class="badge bg-primary" style="font-size: 0.7rem;">
                                                <?php echo e($chat->unread_count_for_user); ?> nouveau(x) message(s)
                                            </span>
                                        </div>
                                    <?php endif; ?>
                                </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (quickForm) {
        quickForm.addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("support.quick-chat")); ?>', {
                method: 'POST',
                headers: {
    ...
    function refreshWidget() {
        fetch('<?php echo e(route("support.widget")); ?>')
...
</script><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/support/widget.blade.php ENDPATH**/ ?>