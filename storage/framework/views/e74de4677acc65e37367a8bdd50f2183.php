                    ...
                    <?php if(isset($settings) && (is_array($settings) ? count($settings) : $settings->count()) > 0): ?>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(isset($settings[$category])): ?>
                                ...
                                ?>
                                <div class="group bg-gradient-to-br <?php echo e($catColor); ?> dark:from-gray-900 dark:to-gray-800 dark:border-gray-700 rounded-xl border p-4 sm:p-6 hover:shadow-lg transition-all duration-300">
                                    <div class="mb-4 sm:mb-6">
                                        <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-white dark:bg-gray-700 shadow-sm mr-3 group-hover:scale-110 transition-transform duration-300">
                                                <i class="fas <?php echo e($catIcon); ?> text-gray-600 dark:text-gray-300 text-sm"></i>
                                            </span>
                                            <?php echo e(ucfirst($category)); ?>

                                            <span class="ml-auto text-xs text-gray-400 font-normal"><?php echo e(count($settings[$category])); ?> param.</span>
                                        </h3>
                                    </div>
                                                ...
                                                <?php elseif($setting->type === 'boolean'): ?>
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        <label class="inline-flex items-center cursor-pointer">
                                                            ...
                                                            <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-200" id="<?php echo e($setting->key); ?>_label">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-all duration-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($preregCount); ?></p>
                                        </div>
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-all duration-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($preregLimit > 0 ? $preregLimit : '∞'); ?></p>
                                        </div>
                                ...
                                <?php if($enterpriseWallets['usd']): ?>
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex justify-between items-center pt-3 border-t border-gray-200 dark:border-gray-700">
                                            ...
                                            <span class="text-xs font-mono text-gray-700 dark:text-gray-200">#<?php echo e($enterpriseWallets['usd']->id); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-indigo-200 p-6">
                                ...
                                <?php if($enterpriseWallets['cdf']): ?>
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex justify-between items-center pt-3 border-t border-gray-200 dark:border-gray-700">
                                            <span class="text-xs text-gray-500 dark:text-gray-400">ID Wallet</span>
                                            <span class="text-xs font-mono text-gray-700 dark:text-gray-200">#<?php echo e($enterpriseWallets['cdf']->id); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Statut</span>
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>