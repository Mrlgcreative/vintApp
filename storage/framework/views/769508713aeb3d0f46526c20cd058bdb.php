                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="relative">
                            ...
                            <div id="usd-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50">
                                ...
                                <a href="<?php echo e(route('wallet.transactions', $usdWallet)); ?>" 
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="relative">
                            ...
                            <div id="cdf-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50">
                                ...
                                <hr class="border-gray-200 dark:border-gray-700">
                                <a href="<?php echo e(route('wallet.transactions', $cdfWallet)); ?>" 
                                   class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 dark:bg-gray-900 last:rounded-b-lg">
                                    <i class="fas fa-history text-blue-500"></i>
                                    Voir l'historique
                                </a>
                                ...
                                <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium <?php echo e($config['class']); ?>">
                            ...
                            <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-200 transaction-card">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-full <?php echo e($transaction->type === 'credit' ? 'bg-green-100' : 'bg-red-100'); ?> flex items-center justify-center">
                                                <i class="<?php echo e($icon); ?> <?php echo e($transaction->type === 'credit' ? 'text-green-600' : 'text-red-600'); ?>"></i>
                                            </div>
                                            <div>
                                                <h6 class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($source); ?></h6>
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium <?php echo e($badgeClass); ?>">
                                                    <?php echo e($transaction->wallet->currency); ?>
                                        ...
                                        <div class="text-right">
                                            <div class="text-lg font-bold <?php echo e($transaction->type === 'credit' ? 'text-green-600' : 'text-red-600'); ?>">
                                                <?php echo e($transaction->type === 'credit' ? '+' : '-'); ?><?php echo e(number_format($transaction->amount, 2)); ?>
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-700 dark:text-gray-200 mb-2"><?php echo e($transaction->description); ?></p>
                                        <?php if($transaction->reference): ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/wallet/index.blade.php ENDPATH**/ ?>