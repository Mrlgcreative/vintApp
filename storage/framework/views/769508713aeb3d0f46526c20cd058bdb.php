            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.add-funds', $usdWallet)); ?>">
                                    <i class="fas fa-plus text-success me-2"></i>Ajouter des fonds
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.withdraw-funds', $usdWallet)); ?>">
                                    <i class="fas fa-minus text-danger me-2"></i>Retirer des fonds
                                </a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.transactions', $usdWallet)); ?>">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <a href="<?php echo e(route('wallet.add-funds', $usdWallet)); ?>" class="btn btn-success flex-fill">
                            <i class="fas fa-plus me-1"></i>Ajouter
                        </a>
                        <a href="<?php echo e(route('wallet.withdraw-funds', $usdWallet)); ?>" class="btn btn-outline-danger flex-fill">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.add-funds', $cdfWallet)); ?>">
                                    <i class="fas fa-plus text-success me-2"></i>Ajouter des fonds
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.withdraw-funds', $cdfWallet)); ?>">
                                    <i class="fas fa-minus text-danger me-2"></i>Retirer des fonds
                                </a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('wallet.transactions', $cdfWallet)); ?>">
                                    <i class="fas fa-history text-info me-2"></i>Voir l'historique
                                </a></li>
                            </ul>
                        </div>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <a href="<?php echo e(route('wallet.add-funds', $cdfWallet)); ?>" class="btn btn-warning flex-fill">
                            <i class="fas fa-plus me-1"></i>Ajouter
                        </a>
                        <a href="<?php echo e(route('wallet.withdraw-funds', $cdfWallet)); ?>" class="btn btn-outline-danger flex-fill">
                            <i class="fas fa-minus me-1"></i>Retirer
                        </a>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold <?php echo e($transaction->type === 'credit' ? 'text-success' : 'text-danger'); ?>">
                                                    ...
                                                    <?php if($transaction->wallet->currency === 'CDF'): ?>
                                                        <?php echo e(number_format($transaction->amount, 2, ',', ' ')); ?> FC
                                                    <?php else: ?>
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e($transaction->wallet->currency === 'USD' ? 'success' : 'warning'); ?>">
                                            ...
                                            <td>
                                                <small class="text-muted">
                                                    <?php if($transaction->wallet->currency === 'CDF'): ?>
                                                        <?php echo e(number_format($transaction->balance_after, 2, ',', ' ')); ?> FC
                                                    <?php else: ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="<?php echo e(route('wallet.add-funds', $usdWallet)); ?>" class="btn btn-success">
                                    <i class="fas fa-plus me-1"></i>Ajouter des fonds USD
                                </a>
                                <a href="<?php echo e(route('wallet.add-funds', $cdfWallet)); ?>" class="btn btn-warning">
