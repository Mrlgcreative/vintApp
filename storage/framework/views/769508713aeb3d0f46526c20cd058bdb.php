        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <small class="text-gray-500"><?php echo e($recentTransactions->total()); ?> transaction(s)</small>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <?php if($transaction->reference): ?>
                                                <div class="text-xs text-gray-500 mt-1">Réf: <?php echo e($transaction->reference); ?></div>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-200 transaction-card">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h6 class="font-semibold text-gray-900 text-sm"><?php echo e($source); ?></h6>
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-700 mb-2"><?php echo e($transaction->description); ?></p>
                                        <?php if($transaction->reference): ?>
                                            <p class="text-xs text-gray-500">Réf: <?php echo e($transaction->reference); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
