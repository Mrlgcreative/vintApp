...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/dynamic-colors.css')); ?>?v=<?php echo e(filemtime(public_path('css/dynamic-colors.css'))); ?>">
                ...
                <nav class="flex-1 space-y-1 p-4 custom-scrollbar overflow-y-auto">
                    <?php if($isExpert): ?>
                        ...
                        <a href="<?php echo e(route('expert.dashboard')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.dashboard*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('expert.verifications.index')); ?>" 
                            class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.verifications*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('expert.verifications.index', ['status' => 'expert_review'])); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.verifications.index') && request('status') === 'expert_review'): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($pendingVerifications > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-red-500 rounded-full animate-pulse"><?php echo e($pendingVerifications); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('expert.items.pending')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.items.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($pendingItemsCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-purple-500 rounded-full animate-pulse"><?php echo e($pendingItemsCount); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('expert.profile')); ?>" 
                            class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.profile*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <div class="mt-5 rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
                            ...
                            <div class="space-y-2 text-xs">
                                <div class="flex items-center justify-between rounded-lg bg-white/[0.03] px-3 py-2">
                                    ...
                                    <span class="text-white font-semibold"><?php echo e($expertStats['total']); ?></span>
                                </div>
                                <div class="flex items-center justify-between rounded-lg bg-white/[0.03] px-3 py-2">
                                    <span class="text-white/50">Aujourd'hui</span>
                                    <span class="text-emerald-400 font-semibold"><?php echo e($expertStats['completed_today']); ?></span>
                                </div>
                                <div class="flex items-center justify-between rounded-lg bg-white/[0.03] px-3 py-2">
                                    <span class="text-white/50">Taux succès</span>
                                    <span class="text-blue-400 font-semibold"><?php echo e(number_format($expertStats['approval_rate'], 1)); ?>%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.dashboard')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.users.index') || request()->routeIs('admin.users.show') || request()->routeIs('admin.users.edit')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if(isset($pendingUsersCount) && $pendingUsersCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-red-500 rounded-full"><?php echo e($pendingUsersCount); ?></span>
                            <?php endif; ?>
                        </a>

                        <a href="<?php echo e(route('admin.users.online')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.users.online')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.experts.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.experts.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($totalExperts > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-primary-500 rounded-full"><?php echo e($activeExperts); ?>/<?php echo e($totalExperts); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.transactions.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.transactions.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.wallets.pending')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.wallets.pending')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            <svg class="w-5 h-5 mr-3 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="flex-1">Wallets en attente</span>
                            <?php if(isset($pendingWalletsCount) && $pendingWalletsCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-gray-900 bg-yellow-400 rounded-full"><?php echo e($pendingWalletsCount); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.items.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.items.index') || request()->routeIs('admin.items.show') || request()->routeIs('admin.items.edit')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            ?>
                            <?php if($blockedItems > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-red-500 rounded-full"><?php echo e($blockedItems); ?></span>
                            <?php else: ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-gray-500 rounded-full"><?php echo e($totalItems); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.refunds.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.refunds.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($pendingRefundsCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-orange-500 rounded-full animate-pulse"><?php echo e($pendingRefundsCount); ?></span>
                            <?php endif; ?>
                        </a>

                        <a href="<?php echo e(route('admin.orders.tracking.list')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.orders.tracking*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.product-boosts.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.product-boosts.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($activeBoostsCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-green-500 rounded-full"><?php echo e($activeBoostsCount); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.brands.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.brands.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.categories.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.categories.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.boost-types.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.boost-types.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            <svg class="w-5 h-5 mr-3 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                            <span>Types de boost</span>
                        </a>

                        <a href="<?php echo e(route('admin.support.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.support.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($unassignedSupport > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-white bg-orange-500 rounded-full"><?php echo e($unassignedSupport); ?></span>
                            <?php endif; ?>
                        </a>

                        <a href="<?php echo e(route('admin.affiliate.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.affiliate.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            ...
                            <?php if($topPerformersCount > 0): ?>
                                <span class="inline-flex items-center justify-center px-2 py-0.5 text-[11px] font-bold text-gray-900 bg-yellow-400 rounded-full"><?php echo e($topPerformersCount); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.reports')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.reports')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.monitoring.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.monitoring.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.logs')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.logs')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.locations.index')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.locations.*')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.broadcast.fcm')); ?>" 
                           class="sidebar-link group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.broadcast.fcm')): ?> active bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
            ...
            <header class="sticky top-0 z-30 border-b border-primary-700 bg-primary dark:bg-gray-800/95 p-4 shadow-sm backdrop-blur-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <h1 class="text-lg font-semibold text-white lg:text-xl"><?php echo $__env->yieldContent('page-title'); ?></h1>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button class="flex items-center rounded-lg p-2 text-white dark:text-gray-300 transition-colors hover:bg-primary-700 dark:hover:bg-gray-700" 
                                ...
                                <?php endif; ?>
                                <span class="hidden text-sm font-medium text-white lg:block"><?php echo e(auth()->user()->name); ?></span>
            ...
            <div class="p-4 space-y-3">
                ...
                <?php if(session('warning')): ?>
                    <div class="flex items-center gap-3 rounded-xl bg-amber-50 dark:bg-amber-900/20 px-4 py-3 text-amber-800 dark:text-amber-300 animate-fade-in" role="alert">
                        ...
                        <span class="flex-1 text-sm"><?php echo e(session('warning')); ?></span>
...
<?php /**PATH /home/aizen/Bureau/sky/vintApp/resources/views/layouts/admin.blade.php ENDPATH**/ ?>