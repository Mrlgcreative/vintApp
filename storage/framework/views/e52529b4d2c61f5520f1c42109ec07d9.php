                ...
                <nav class="flex-1 space-y-1 p-4 custom-scrollbar overflow-y-auto">
                    <?php if($isExpert): ?>
                        ...
                        <a href="<?php echo e(route('expert.dashboard')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.dashboard*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('expert.verifications.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.verifications*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('expert.items.pending')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.items.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('expert.profile')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('expert.profile*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <div class="mt-5 rounded-xl bg-white/5 p-4">
                            ...
                            <div class="space-y-2.5 text-xs">
                                ...
                                <div class="flex justify-between text-white/60">
                                    ...
                                    <span class="text-emerald-400 font-medium"><?php echo e($expertStats['completed_today']); ?></span>
                                </div>
                                <div class="flex justify-between text-white/60">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.dashboard')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.users.online')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.users.online')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.experts.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.experts.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.transactions.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.transactions.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.wallets.pending')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.wallets.pending')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                            <svg class="w-5 h-5 mr-3 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        ...
                        <a href="<?php echo e(route('admin.items.pending_verification')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.items.pending_verification')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.refunds.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.refunds.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.orders.tracking.list')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.orders.tracking*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.brands.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.brands.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.categories.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.categories.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.support.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.support.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.affiliate.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.affiliate.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.reports')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.reports')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.monitoring.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.monitoring.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.logs')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.logs')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.locations.index')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.locations.*')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('admin.broadcast.fcm')); ?>" 
                           class="group flex items-center rounded-xl px-4 py-3 text-white/70 transition-all duration-200 hover:translate-x-0.5 hover:bg-white/10 hover:text-white <?php if(request()->routeIs('admin.broadcast.fcm')): ?> bg-gradient-primary-link text-white font-semibold shadow-lg translate-x-0.5 <?php endif; ?>">
