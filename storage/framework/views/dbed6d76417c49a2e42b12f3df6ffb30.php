...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="address" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" rows="3"><?php echo e(old('address')); ?></textarea>
