                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="mb-1"><strong>Ville:</strong> <?php echo e($order->shipping_city); ?></p>
                                    <p class="mb-1"><strong>Téléphone:</strong> <?php echo e($order->shipping_phone); ?></p>
                                    <p class="mb-0"><strong>Adresse:</strong></p>
                                    <p class="text-muted"><?php echo e($order->shipping_address); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
