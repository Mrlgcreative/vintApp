...
<body class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-6">
            ⚠️ Non connecté - <a href="<?php echo e(route('login')); ?>" class="underline font-medium">Se connecter</a> pour tester les notifications
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\gloir\Desktop\vintApp\resources\views/test-push-simple.blade.php ENDPATH**/ ?>