...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Maintenance</title>
    ...
    <div class="maintenance-bg px-3">
        <div class="maintenance-card p-4 p-md-5 text-center" style="max-width: 600px; width: 100%;">
            ...
            <div class="text-muted mb-4">
                <p class="fs-5 mb-3">
                    <?php echo e($message ?? 'Nous effectuons actuellement des travaux de maintenance sur le site.'); ?>

                </p>
                
                <?php if(isset($estimated_time) && $estimated_time): ?>
                    <div class="time-badge rounded p-3 mb-3">
                        <p class="text-primary fw-medium mb-0">
                            <i class="far fa-clock me-2"></i>
                            Temps estimé : <?php echo e($estimated_time); ?>
            ...
            <div class="border-top pt-4">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                    <a href="mailto:<?php echo e($contact_email ?? 'support@vintapp.com'); ?>" 
            ...
            <div class="mt-4 pt-4 border-top">
                <p class="small text-muted mb-0">
                    © <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'VintApp')); ?>. Tous droits réservés.
                </p>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/maintenance.blade.php ENDPATH**/ ?>