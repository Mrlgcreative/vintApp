        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('items.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loop_index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-5 flex flex-col h-full">
                            <a href="<?php echo e(route('items.show', $item)); ?>" class="block hover:text-purple-600 transition-colors">
                                <h3 class="text-lg font-bold text-gray-900 mb-2 line-clamp-2 hover:text-purple-600"><?php echo e(Str::limit($item->name, 50)); ?></h3>
                            </a>
                            
                            <div class="flex flex-wrap gap-2 mb-3">
                                <span class="px-2 py-1 text-xs font-medium bg-purple-100 text-purple-700 rounded-lg"><?php echo e($item->category->name); ?></span>
                                <?php if($item->brand): ?>
                                    <span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-lg"><?php echo e($item->brand->name); ?></span>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-auto space-y-3">
                                <div class="flex justify-between items-center">
                                    <p class="text-xl font-bold text-purple-600"><?php echo e($item->formatted_price); ?></p>
