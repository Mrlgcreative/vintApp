    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <div class="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-r from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center">
                                <?php if($category->icon): ?>
                                    <i class="<?php echo e($category->icon); ?> text-purple-600 text-3xl lg:text-4xl"></i>
                                <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-2"><?php echo e($category->name); ?></h1>
                            <?php if($category->description): ?>
                                <p class="text-gray-600 mb-4 leading-relaxed"><?php echo e($category->description); ?></p>
                            <?php endif; ?>
                        ...
                        <div class="relative inline-block text-left" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                ...
                                <div class="py-2">
                                    ...
                                    <form action="<?php echo e(route('categories.destroy', $category)); ?>" method="POST" class="block">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 rounded-xl border border-gray-200 p-6 text-center hover:shadow-lg hover:bg-purple-50 transition-all duration-300">
                        ...
                        <div class="w-12 h-12 bg-gradient-to-r from-purple-100 to-purple-200 rounded-xl flex items-center justify-center mx-auto mb-4">
                            <?php if($subcategory->icon): ?>
                                <i class="<?php echo e($subcategory->icon); ?> text-purple-600 text-xl"></i>
                            <?php else: ?>
                        ...
                        <!-- Nom -->
                        <h4 class="font-semibold text-gray-900 mb-2"><?php echo e($subcategory->name); ?></h4>
                        
                        <!-- Description -->
                        <?php if($subcategory->description): ?>
                            <p class="text-gray-600 text-sm mb-3 leading-relaxed"><?php echo e(Str::limit($subcategory->description, 60)); ?></p>
                        <?php endif; ?>
                        
                        <!-- Badge articles -->
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 mb-4">
                            <?php echo e($subcategory->items_count ?? 0); ?> article<?php echo e(($subcategory->items_count ?? 0) > 1 ? 's' : ''); ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-purple-600/10 border border-gray-100/50 overflow-hidden mb-8">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 px-6 py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <a href="<?php echo e(route('items.create', ['category' => $category->id])); ?>" 
                   class="inline-flex items-center px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors duration-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-gray-600 text-sm"><?php echo e(Str::limit($item->description, 40)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-bold text-gray-900"><?php echo e($item->formatted_price ?? $item->price . ' FC'); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold 
                                        <?php if(isset($item->condition_color)): ?>
                                            <?php if($item->condition_color == 'success'): ?> bg-emerald-100 text-emerald-800
                                            <?php elseif($item->condition_color == 'warning'): ?> bg-amber-100 text-amber-800
                                            <?php elseif($item->condition_color == 'danger'): ?> bg-red-100 text-red-800
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold 
                                        <?php if(isset($item->status_color)): ?>
                                            <?php if($item->status_color == 'success'): ?> bg-emerald-100 text-emerald-800
                                            <?php elseif($item->status_color == 'warning'): ?> bg-amber-100 text-amber-800
                                            <?php elseif($item->status_color == 'danger'): ?> bg-red-100 text-red-800
                                            <?php elseif($item->status_color == 'info'): ?> bg-blue-100 text-blue-800
                                            <?php else: ?> bg-gray-100 text-gray-800
                                            <?php endif; ?>
                                        <?php else: ?> bg-gray-100 text-gray-800
                                        <?php endif; ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-gray-900"><?php echo e($item->user->name ?? 'Inconnu'); ?></div>
                                </td>
                ...
                <div class="lg:hidden">
                    ...
                    <div class="border-b border-gray-200 last:border-b-0 p-6 hover:bg-purple-50 transition-colors duration-200">
                        <div class="flex items-start space-x-4">
                            ...
                            <!-- Contenu -->
                            <div class="flex-1 min-w-0">
                                <h4 class="font-semibold text-gray-900 mb-1"><?php echo e($item->name); ?></h4>
                                <p class="text-gray-600 text-sm mb-2"><?php echo e(Str::limit($item->description, 60)); ?></p>
                                <div class="font-bold text-gray-900 mb-2"><?php echo e($item->formatted_price ?? $item->price . ' FC'); ?></div>
                                ...
                                <div class="text-gray-600 text-sm mb-3">Vendeur : <?php echo e($item->user->name ?? 'Inconnu'); ?></div>
