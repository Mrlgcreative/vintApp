        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('categories.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-amber-600 transition-colors duration-200">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-amber-600">Modifier <?php echo e($category->name); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm mt-1">Modifiez les informations de "<?php echo e($category->name); ?>"</p>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-amber-600/10 border border-gray-100/50 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <form action="<?php echo e(route('categories.update', $category)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="name" 
                                       id="name" 
                                       class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="description" 
                                          ...
                                          rows="3" 
                                          maxlength="500"
                                          class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 resize-none <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                          placeholder="Description détaillée de la catégorie..."><?php echo e(old('description', $category->description)); ?></textarea>
                                ...
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <div class="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center">
                                            <i id="icon-preview" class="<?php echo e(old('icon', $category->icon ?: 'fas fa-folder')); ?> text-amber-600"></i>
                                        </div>
                                    </div>
                                    <input type="text" 
                                           name="icon" 
                                           id="icon" 
                                           class="block w-full pl-16 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 <?php $__errorArgs = ['icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="file" 
                                           ...
                                           id="image" 
                                           accept="image/*"
                                           class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-3 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-amber-50 file:text-amber-700 hover:file:bg-amber-100 transition-colors duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="parent_id" 
                                        id="parent_id" 
                                        class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 <?php $__errorArgs = ['parent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="sort_order" 
                                       id="sort_order" 
                                       class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 <?php $__errorArgs = ['sort_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-blue-50 rounded-xl">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-blue-100 text-blue-800">
                                <?php echo e($category->items_count ?? 0); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-emerald-50 rounded-xl">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($category->created_at?->format('d/m/Y H:i') ?? 'Inconnue'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-amber-50 rounded-xl">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($category->updated_at->format('d/m/Y H:i')); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-primary-50 rounded-xl">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($category->parent->name); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
