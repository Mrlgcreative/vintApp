                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-50">
                                    ...
                                    <a href="<?php echo e(route('profile.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                                        <i class="fas fa-user mr-2"></i> Mon Profil
                                    </a>
                                    <a href="<?php echo e(route('settings.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                                        <i class="fas fa-cog mr-2"></i> Paramètres
                                    </a>
                                    <a href="<?php echo e(route('messages.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                                        <i class="fas fa-comments mr-2"></i> Messages
                                    </a>
                                    <a href="<?php echo e(route('admin.refunds.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800">
                        ...
                        <?php else: ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="bg-white dark:bg-gray-800 text-primary-600 hover:bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-full text-sm font-medium transition-colors">
                ...
                <div class="flex items-center space-x-2 text-sm">
                    ...
                    <?php elseif(request()->routeIs('categories.*')): ?>
                        ...
                        <?php if(request()->routeIs('categories.show')): ?>
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-600 dark:text-gray-300"><?php echo e($category->name ?? 'Détails'); ?></span>
                        <?php endif; ?>
                    <?php elseif(request()->routeIs('brands.*')): ?>
                        ...
                        <?php if(request()->routeIs('brands.show')): ?>
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-600 dark:text-gray-300"><?php echo e($brand->name ?? 'Détails'); ?></span>
                        <?php endif; ?>
                    <?php elseif(request()->routeIs('items.*')): ?>
                        ...
                        <?php if(request()->routeIs('items.show')): ?>
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-600 dark:text-gray-300"><?php echo e($item->name ?? 'Détails'); ?></span>
