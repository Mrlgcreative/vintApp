    ...
    <div class="p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors" id="date_from" name="date_from" value="<?php echo e(request('date_from')); ?>">
            </div>
            
            <div>
                <label for="date_to" class="block text-sm font-medium text-gray-700 mb-2">Date fin</label>
                <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors" id="date_to" name="date_to" value="<?php echo e(request('date_to')); ?>">
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-bold text-gray-900">#<?php echo e($order->id); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($order->buyer): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($order->item): ?>
                                    <div class="flex items-center">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo e(Str::limit($order->item->title, 30)); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($order->item->brand->name ?? 'Sans marque'); ?></div>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($order->total_amount ?? 0, 2)); ?> <?php echo e($order->currency ?? 'USD'); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php
                                    $statusClasses = [
                                ...
                                ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statusClasses[$order->status] ?? 'bg-gray-100 text-gray-800'); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gloir\Desktop\projet\vintapp\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>