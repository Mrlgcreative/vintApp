                        ...
                        <div class="flex flex-wrap justify-center gap-4">
                            <div class="bg-white/20 backdrop-blur-md rounded-2xl px-6 py-3 border border-white/30 hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left">
                                        <p class="text-2xl font-bold text-white"><?php echo e(\App\Models\UserWaiting::count()); ?>+</p>
                            ...
                            <div class="bg-white/20 backdrop-blur-md rounded-2xl px-6 py-3 border border-white/30 hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left">
                                        <p class="text-2xl font-bold text-white"><?php echo e(\App\Models\UserWaiting::approved()->count()); ?></p>
                ...
                <div class="px-8 lg:px-12 py-12">
                    ...
                    <?php if(session('success')): ?>
                        <div class="mb-8 bg-emerald-50 dark:bg-emerald-900/20 border-l-4 border-emerald-500 rounded-xl p-5 flex items-start gap-4 animate-pulse">
                            ...
                            <div class="flex-1">
                                <p class="text-emerald-900 dark:text-emerald-100 font-semibold"><?php echo e(session('success')); ?></p>
                            </div>
                    ...
                    <?php if(session('error')): ?>
                        <div class="mb-8 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-xl p-5 flex items-start gap-4 animate-pulse">
                            ...
                            <div class="flex-1">
                                <p class="text-red-900 dark:text-red-100 font-semibold"><?php echo e(session('error')); ?></p>
                            </div>
                    ...
                    <!-- Registration Form -->
                    <form method="POST" action="<?php echo e(route('preregistration.store')); ?>" id="preregistrationForm" class="space-y-8">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" 
                                       class="w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-200 dark:border-gray-700 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:border-violet-500 focus:ring-4 focus:ring-violet-100 dark:focus:ring-violet-900/30 transition-all duration-300 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500" 
                                       id="name" 
                                       name="name" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="email" 
                                       class="w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-200 dark:border-gray-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="tel" 
                                       class="w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-200 dark:border-gray-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select class="w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-200 dark:border-gray-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-2xl focus:border-violet-500 focus:ring-4 focus:ring-violet-100 dark:focus:ring-violet-900/30 transition-all duration-300 text-gray-900 dark:text-white" 
                                        id="country" 
                                        name="country" 
                                        required>
                                    <option value="Congo (RDC)" <?php echo e(old('country', 'Congo (RDC)') == 'Congo (RDC)' ? 'selected' : ''); ?>>🇨🇩 Congo (RDC)</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select class="w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 <?php $__errorArgs = ['reasons'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-200 dark:border-gray-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-2xl focus:border-violet-500 focus:ring-4 focus:ring-violet-100 dark:focus:ring-violet-900/30 transition-all duration-300 text-gray-900 dark:text-white" 
                                ...
                                <option value="Acheter des produits vintage de qualité" <?php echo e(is_array(old('reasons')) && in_array('Acheter des produits vintage de qualité', old('reasons')) ? 'selected' : ''); ?>>
                                    🛍️ Acheter des produits vintage
                                </option>
                                <option value="Vendre mes articles vintage" <?php echo e(is_array(old('reasons')) && in_array('Vendre mes articles vintage', old('reasons')) ? 'selected' : ''); ?>>
                                    💼 Vendre mes articles vintage
                                </option>
                                <option value="Développer mon business vintage" <?php echo e(is_array(old('reasons')) && in_array('Développer mon business vintage', old('reasons')) ? 'selected' : ''); ?>>
                                    🚀 Développer mon business
                                </option>
                                <option value="Rejoindre une communauté de passionnés" <?php echo e(is_array(old('reasons')) && in_array('Rejoindre une communauté de passionnés', old('reasons')) ? 'selected' : ''); ?>>
                                    👥 Rejoindre la communauté
                                </option>
                                <option value="Enrichir ma collection personnelle" <?php echo e(is_array(old('reasons')) && in_array('Enrichir ma collection personnelle', old('reasons')) ? 'selected' : ''); ?>>
                                    ⭐ Enrichir ma collection
                                </option>
                                <option value="Consommer de manière responsable et durable" <?php echo e(is_array(old('reasons')) && in_array('Consommer de manière responsable et durable', old('reasons')) ? 'selected' : ''); ?>>
                                    ♻️ Consommation responsable
                                </option>
                                <option value="Découvrir une nouvelle plateforme innovante" <?php echo e(is_array(old('reasons')) && in_array('Découvrir une nouvelle plateforme innovante', old('reasons')) ? 'selected' : ''); ?>>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    setTimeout(() => {
                        window.location.href = "<?php echo e(route('preregistration.stats')); ?>";
                    }, 3000);
