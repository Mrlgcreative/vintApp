        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl transform transition-all sm:my-8 sm:max-w-md w-full mx-4">
            <form id="assignForm">
                ...
                <div class="px-6 py-4 space-y-3">
                    ...
                    <?php if(isset($agents) && $agents->where('is_active', true)->count() > 0): ?>
...
<?php echo $__env->make('layouts.support', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Mes projets\vintApp\resources\views/admin/support/index.blade.php ENDPATH**/ ?>