                        ...
                        <div class="mb-3 lg:mb-4 overflow-hidden rounded-xl aspect-square group-hover:scale-110 transition-all duration-300">
                            ...
                            <?php else: ?>
                                <div class="w-full h-full bg-gradient-to-br from-purple-50 to-pink-50 flex items-center justify-center">
                                    <i class="<?php echo e($icons[$index % count($icons)]); ?> text-3xl <?php echo e($iconColors[$index % count($iconColors)]); ?>"></i>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH D:\Mes projets\vintApp\resources\views/components/home/category-grid.blade.php ENDPATH**/ ?>