...
class ProfileController extends Controller
{
    ...
    private function getUserStats($user)
    {
        return [
            ...
            'total_revenue' => $user->ordersAsSeller()->where('status', 'completed')->where('currency', 'USD')->sum('total_amount'),
            'total_revenue_cdf' => $user->ordersAsSeller()->where('status', 'completed')->where('currency', 'CDF')->sum('total_amount'),
